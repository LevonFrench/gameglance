  ...
  return (
    <div style={{
      ...
      <div style={{ 
        ...
        <div style={{ width: '1px', height: '12px', background: 'var(--border-subtle)' }} />
        <a href="https://discord.gg/u9htMX39" target="_blank" rel="noreferrer" style={{ color: 'var(--text-secondary)', textDecoration: 'none', transition: 'color 0.2s', display: 'flex', alignItems: 'center', gap: '0.3rem' }}
