...
rosterCount: 32,
    ...
    systemMechanics: [
        ...
        characters: [
      { id: 'alien', name: 'Alien', moveCount: 6 },
      { id: 'cassie-cage', name: 'Cassie Cage', moveCount: 6 },
      { id: 'ermac', name: 'Ermac', moveCount: 6 },
      { id: 'erron-black', name: 'Erron Black', moveCount: 6 },
      { id: 'ferratorr', name: 'Ferra Torr', moveCount: 6 },
      { id: 'goro', name: 'Goro', moveCount: 6 },
      { id: 'jacqui-briggs', name: 'Jacqui Briggs', moveCount: 6 },
      { id: 'jason-voorhees', name: 'Jason Voorhees', moveCount: 6 },
      { id: 'jax', name: 'Jax', moveCount: 6 },
      { id: 'johnny-cage', name: 'Johnny Cage', moveCount: 6 },
      { id: 'kano', name: 'Kano', moveCount: 6 },
      { id: 'kenshi', name: 'Kenshi', moveCount: 6 },
      { id: 'kitana', name: 'Kitana', moveCount: 6 },
      { id: 'kotal-kahn', name: 'Kotal Kahn', moveCount: 6 },
      { id: 'kung-jin', name: 'Kung Jin', moveCount: 6 },
      { id: 'kung-lao', name: 'Kung Lao', moveCount: 6 },
      { id: 'leatherface', name: 'Leatherface', moveCount: 1 },
      { id: 'liu-kang', name: 'Liu Kang', moveCount: 6 },
      { id: 'mileena', name: 'Mileena', moveCount: 6 },
      { id: 'predator', name: 'Predator', moveCount: 1 },
      { id: 'quan-chi', name: 'Quan Chi', moveCount: 6 },
      { id: 'raiden', name: 'Raiden', moveCount: 6 },
      { id: 'reptile', name: 'Reptile', moveCount: 6 },
      { id: 'scorpion', name: 'Scorpion', moveCount: 9 },
      { id: 'shinnok', name: 'Shinnok', moveCount: 6 },
      { id: 'sonya-blade', name: 'Sonya Blade', moveCount: 6 },
      { id: 'sub-zero', name: 'Sub-Zero', moveCount: 9 },
      { id: 'takeda-takahashi', name: 'Takeda Takahashi', moveCount: 6 },
      { id: 'tanya', name: 'Tanya', moveCount: 6 },
      { id: 'tremor', name: 'Tremor', moveCount: 6 }
    ],
