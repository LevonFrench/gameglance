...
rosterCount: 8,
  ...
  },
  {
    ...
    characters: [
      { id: 'aquaman', name: 'Aquaman', moveCount: 10 },
      { id: 'atrocitus', name: 'Atrocitus', moveCount: 10 },
      { id: 'bane', name: 'Bane', moveCount: 9 },
      { id: 'batman', name: 'Batman', moveCount: 12 },
      { id: 'black-adam', name: 'Black Adam', moveCount: 10 },
      { id: 'black-canary', name: 'Black Canary', moveCount: 10 },
      { id: 'black-manta', name: 'Black Manta', moveCount: 10 },
      { id: 'blue-beetle', name: 'Blue Beetle', moveCount: 10 },
      { id: 'brainiac', name: 'Brainiac', moveCount: 9 },
      { id: 'captain-cold', name: 'Captain Cold', moveCount: 9 },
      { id: 'catwoman', name: 'Catwoman', moveCount: 10 },
      { id: 'cheetah', name: 'Cheetah', moveCount: 9 },
      { id: 'cyborg', name: 'Cyborg', moveCount: 10 },
      { id: 'darkseid', name: 'Darkseid', moveCount: 9 },
      { id: 'deadshot', name: 'Deadshot', moveCount: 9 },
      { id: 'doctor-fate', name: 'Doctor Fate', moveCount: 9 },
      { id: 'donatello', name: 'Donatello', moveCount: 9 },
      { id: 'enchantress', name: 'Enchantress', moveCount: 9 },
      { id: 'firestorm', name: 'Firestorm', moveCount: 9 },
      { id: 'flash', name: 'Flash', moveCount: 10 },
      { id: 'gorilla-grodd', name: 'Gorilla Grodd', moveCount: 9 },
      { id: 'green-arrow', name: 'Green Arrow', moveCount: 10 },
      { id: 'green-lantern', name: 'Green Lantern', moveCount: 10 },
      { id: 'harley-quinn', name: 'Harley Quinn', moveCount: 10 },
      { id: 'hellboy', name: 'Hellboy', moveCount: 9 },
      { id: 'joker', name: 'Joker', moveCount: 9 },
      { id: 'leonardo', name: 'Leonardo', moveCount: 9 },
      { id: 'michelangelo', name: 'Michelangelo', moveCount: 9 },
      { id: 'poison-ivy', name: 'Poison Ivy', moveCount: 9 },
      { id: 'raiden', name: 'Raiden', moveCount: 8 },
      { id: 'raphael', name: 'Raphael', moveCount: 9 },
      { id: 'red-hood', name: 'Red Hood', moveCount: 9 },
      { id: 'robin', name: 'Robin', moveCount: 10 },
      { id: 'scarecrow', name: 'Scarecrow', moveCount: 9 },
      { id: 'starfire', name: 'Starfire', moveCount: 8 },
      { id: 'sub-zero', name: 'Sub-Zero', moveCount: 9 },
      { id: 'supergirl', name: 'Supergirl', moveCount: 10 },
      { id: 'superman', name: 'Superman', moveCount: 11 },
      { id: 'swamp-thing', name: 'Swamp Thing', moveCount: 9 },
      { id: 'wonder-woman', name: 'Wonder Woman', moveCount: 10 }
    ],
    tabs: ['Special Moves', 'Super Combos', 'Finishers', 'Unique Attacks', 'Normal Moves', 'Command Throws', 'Normal Throws', 'Common Moves']
  },
  {
