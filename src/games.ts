...
export const SUPPORTED_GAMES: ReadonlyArray<Readonly<GameDefinition>> = [
  {
    ...
    characters: [
      { id: 'android-16', name: 'Android 16', moveCount: 47 },
      { id: 'android-17', name: 'Android 17', moveCount: 72 },
      { id: 'android-18', name: 'Android 18', moveCount: 51 },
      { id: 'android-21-lab-coat', name: 'Android 21 (Lab Coat)', moveCount: 59 },
      { id: 'android-21-majin', name: 'Android 21 (Majin)', moveCount: 0 },
      { id: 'bardock', name: 'Bardock', moveCount: 48 },
      { id: 'beerus', name: 'Beerus', moveCount: 55 },
      { id: 'broly-dbs', name: 'Broly (DBS)', moveCount: 48 },
      { id: 'broly-z', name: 'Broly (Z)', moveCount: 0 },
      { id: 'cell', name: 'Cell', moveCount: 51 },
      { id: 'cooler', name: 'Cooler', moveCount: 55 },
      { id: 'freeza', name: 'Freeza', moveCount: 0 },
      { id: 'ginyu', name: 'Ginyu', moveCount: 0 },
      { id: 'gogeta-ss4', name: 'Gogeta (SS4)', moveCount: 54 },
      { id: 'gogeta-ssgss', name: 'Gogeta (SSGSS)', moveCount: 58 },
      { id: 'gohan-adult', name: 'Gohan (Adult)', moveCount: 66 },
      { id: 'gohan-teen', name: 'Gohan (Teen)', moveCount: 47 },
      { id: 'goku-blue', name: 'Goku (Blue)', moveCount: 0 },
      { id: 'goku-gt', name: 'Goku (GT)', moveCount: 51 },
      { id: 'goku-ss', name: 'Goku (SS)', moveCount: 0 },
      { id: 'goku-ultra-instinct', name: 'Goku (Ultra Instinct)', moveCount: 63 },
      { id: 'goku-black', name: 'Goku Black', moveCount: 50 },
      { id: 'gotenks', name: 'Gotenks', moveCount: 51 },
      { id: 'hit', name: 'Hit', moveCount: 48 },
      { id: 'janemba', name: 'Janemba', moveCount: 56 },
      { id: 'jiren', name: 'Jiren', moveCount: 47 },
      { id: 'kefla', name: 'Kefla', moveCount: 46 },
      { id: 'kid-buu', name: 'Kid Buu', moveCount: 47 },
      { id: 'krillin', name: 'Krillin', moveCount: 64 },
      { id: 'majin-buu', name: 'Majin Buu', moveCount: 46 },
      { id: 'master-roshi', name: 'Master Roshi', moveCount: 61 },
      { id: 'nappa', name: 'Nappa', moveCount: 48 },
      { id: 'piccolo', name: 'Piccolo', moveCount: 53 },
      { id: 'super-baby-2', name: 'Super Baby 2', moveCount: 56 },
      { id: 'tenshinhan', name: 'Tenshinhan', moveCount: 0 },
      { id: 'trunks', name: 'Trunks', moveCount: 48 },
      ...
      { id: 'vegito-ssgss', name: 'Vegito (SSGSS)', moveCount: 52 },
      { id: 'videl', name: 'Videl', moveCount: 62 },
      { id: 'yamcha', name: 'Yamcha', moveCount: 48 },
      { id: 'zamasu-fused', name: 'Zamasu (Fused)', moveCount: 64 }
    ]
  },
...
rosterCount: 10,
    ...
    tags: ["2D"],
    characters: [
      { id: 'jack-turner', name: 'Jack Turner', moveCount: 4 },
      { id: 'john-crawley', name: 'John Crawley', moveCount: 7 },
      { id: 'king', name: 'King', moveCount: 8 },
      { id: 'lee-pai-long', name: 'Lee Pai Long', moveCount: 8 },
      { id: 'micky-rogers', name: 'Micky Rogers', moveCount: 7 },
      { id: 'mr-big', name: 'Mr. Big', moveCount: 9 },
      { id: 'mr-karate', name: 'Mr. Karate', moveCount: 5 },
      { id: 'robert-garcia', name: 'Robert Garcia', moveCount: 11 },
      { id: 'ryo-sakazaki', name: 'Ryo Sakazaki', moveCount: 12 },
      { id: 'ryuhaku-todoh', name: 'Ryuhaku Todoh', moveCount: 9 }
    ],
...
rosterCount: 13,
    ...
    systemMechanics: [
        ...
        characters: [
      { id: 'eiji-kisaragi', name: 'Eiji Kisaragi', moveCount: 9 },
      { id: 'geese-howard', name: 'Geese Howard', moveCount: 13 },
      { id: 'jack-turner', name: 'Jack Turner', moveCount: 9 },
      { id: 'john-crawley', name: 'John Crawley', moveCount: 7 },
      { id: 'king', name: 'King', moveCount: 8 },
      { id: 'lee-pai-long', name: 'Lee Pai Long', moveCount: 8 },
      { id: 'micky-rogers', name: 'Micky Rogers', moveCount: 7 },
      { id: 'mr-big', name: 'Mr. Big', moveCount: 6 },
      { id: 'robert-garcia', name: 'Robert Garcia', moveCount: 11 },
      { id: 'ryo-sakazaki', name: 'Ryo Sakazaki', moveCount: 12 },
      { id: 'takuma-sakazaki', name: 'Takuma Sakazaki', moveCount: 8 },
      { id: 'temjin', name: 'Temjin', moveCount: 6 },
      { id: 'yuri-sakazaki', name: 'Yuri Sakazaki', moveCount: 8 }
    ],
...
rosterCount: 9,
    ...
    tags: ["2D"],
    characters: [
      { id: 'jin-fu-ha', name: 'Jin Fu-Ha', moveCount: 14 },
      { id: 'karman-cole', name: 'Karman Cole', moveCount: 11 },
      { id: 'kasumi-todoh', name: 'Kasumi Todoh', moveCount: 14 },
      { id: 'lenny-creston', name: 'Lenny Creston', moveCount: 13 },
      { id: 'robert-garcia', name: 'Robert Garcia', moveCount: 4 },
      { id: 'ryo-sakazaki', name: 'Ryo Sakazaki', moveCount: 0 },
      { id: 'sinclair', name: 'Sinclair', moveCount: 12 },
      { id: 'wang-koh-san', name: 'Wang Koh-San', moveCount: 16 },
      { id: 'wyler', name: 'Wyler', moveCount: 9 }
    ],
...
rosterCount: 8,
    ...
    systemMechanics: [
        ...
        characters: [
      { id: 'coco', name: 'Coco', moveCount: 10 },
      { id: 'cupe', name: 'Cupe', moveCount: 10 },
      { id: 'ike-du', name: 'Ike-Du', moveCount: 12 },
      { id: 'lettas', name: 'Lettas', moveCount: 11 },
      { id: 'marron', name: 'Marron', moveCount: 10 },
      { id: 'rouge', name: 'Rouge', moveCount: 10 },
      { id: 'stella', name: 'Stella', moveCount: 11 },
      { id: 'test-kun', name: 'Test-Kun', moveCount: 11 }
    ],
...

  {
    ...
    systemMechanics: [
        ...
        characters: [
      { id: 'asuka-karashima', name: 'Asuka Karashima', moveCount: 14 },
      { id: 'genichirou-shindo', name: 'Genichirou Shindo', moveCount: 12 },
      { id: 'kiyoko-mitarai', name: 'Kiyoko Mitarai', moveCount: 13 },
      { id: 'kumi-kubota', name: 'Kumi Kubota', moveCount: 12 },
      { id: 'megumi-suzuki', name: 'Megumi Suzuki', moveCount: 12 },
      { id: 'nana-hidaka', name: 'Nana Hidaka', moveCount: 12 },
      { id: 'ryoko-owada', name: 'Ryoko Owada', moveCount: 12 },
      { id: 'shinobu-kawasaki', name: 'Shinobu Kawasaki', moveCount: 12 },
      { id: 'tamaki-shindo', name: 'Tamaki Shindo', moveCount: 12 },
      { id: 'tetsuko-yoshioka', name: 'Tetsuko Yoshioka', moveCount: 12 },
      { id: 'torami-hojo', name: 'Torami Hojo', moveCount: 12 }
    ],
...
rosterCount: 30,
    ...
    systemMechanics: [
        ...
        characters: [
      { id: 'abel', name: 'Abel', moveCount: 3 },
      { id: 'atwiki', name: 'Atwiki', moveCount: 14 },
      { id: 'balido', name: 'Balido', moveCount: 14 },
      { id: 'bayhou', name: 'Bayhou', moveCount: 14 },
      { id: 'chaos', name: 'Chaos', moveCount: 15 },
      { id: 'cuila', name: 'Cuila', moveCount: 14 },
      { id: 'david', name: 'David', moveCount: 14 },
      { id: 'duke', name: 'Duke', moveCount: 15 },
      { id: 'eiji', name: 'Eiji', moveCount: 15 },
      { id: 'ellis', name: 'Ellis', moveCount: 14 },
      { id: 'fo', name: 'Fo', moveCount: 14 },
      { id: 'gaia', name: 'Gaia', moveCount: 14 },
      { id: 'judgement', name: 'Judgement', moveCount: 13 },
      { id: 'kayin', name: 'Kayin', moveCount: 14 },
      { id: 'leon', name: 'Leon', moveCount: 11 },
      { id: 'miss-til', name: 'Miss Til', moveCount: 10 },
      { id: 'mondo', name: 'Mondo', moveCount: 12 },
      { id: 'nagisa', name: 'Nagisa', moveCount: 13 },
      { id: 'naru', name: 'Naru', moveCount: 11 },
      { id: 'rachael', name: 'Rachael', moveCount: 13 },
      { id: 'rungo', name: 'Rungo', moveCount: 14 },
      { id: 'schultz', name: 'Schultz', moveCount: 13 },
      { id: 'shizuku', name: 'Shizuku', moveCount: 13 },
      { id: 'sho', name: 'Sho', moveCount: 15 },
      { id: 'sofia', name: 'Sofia', moveCount: 14 },
      { id: 'ten-count', name: 'Ten Count', moveCount: 11 },
      { id: 'toujin', name: 'Toujin', moveCount: 3 },
      { id: 'uranus', name: 'Uranus', moveCount: 14 },
      { id: 'veil', name: 'Veil', moveCount: 14 },
      { id: 'vermilion', name: 'Vermilion', moveCount: 14 }
    ],
...
rosterCount: 7,
    ...
    systemMechanics: [
        ...
        characters: [
      { id: 'chilli-pepper', name: 'Chilli & Pepper', moveCount: 12 },
      { id: 'death-mask', name: 'Death Mask', moveCount: 12 },
      { id: 'kapila', name: 'Kapila', moveCount: 17 },
      { id: 'mushira', name: 'Mushira', moveCount: 12 },
      { id: 'naga', name: 'Naga', moveCount: 12 },
      { id: 'orochimaru', name: 'Orochimaru', moveCount: 12 },
      { id: 'sky-high', name: 'Sky High', moveCount: 12 }
    ],
...
rosterCount: 35,
    ...
    characters: [
      { id: 'amane-nishiki', name: 'Amane Nishiki', moveCount: 2 },
      { id: 'arakune', name: 'Arakune', moveCount: 2 },
      { id: 'azrael', name: 'Azrael', moveCount: 2 },
      { id: 'bang-shishigami', name: 'Bang Shishigami', moveCount: 2 },
      { id: 'bullet', name: 'Bullet', moveCount: 2 },
      { id: 'carl-clover', name: 'Carl Clover', moveCount: 2 },
      { id: 'celica-a-mercury', name: 'Celica A. Mercury', moveCount: 2 },
      { id: 'es', name: 'Es', moveCount: 2 },
      { id: 'hakumen', name: 'Hakumen', moveCount: 4 },
      { id: 'hazama', name: 'Hazama', moveCount: 2 },
      { id: 'hibiki-kohaku', name: 'Hibiki Kohaku', moveCount: 2 },
      { id: 'iron-tager', name: 'Iron Tager', moveCount: 4 },
      { id: 'izayoi', name: 'Izayoi', moveCount: 12 },
      { id: 'jin-kisaragi', name: 'Jin Kisaragi', moveCount: 6 },
      { id: 'jubei', name: 'Jubei', moveCount: 2 },
      { id: 'kagura-mutsuki', name: 'Kagura Mutsuki', moveCount: 2 },
      { id: 'kokonoe', name: 'Kokonoe', moveCount: 2 },
      { id: 'litchi-faye-ling', name: 'Litchi Faye-Ling', moveCount: 2 },
      { id: 'mai-natsume', name: 'Mai Natsume', moveCount: 2 },
      { id: 'makoto-nanaya', name: 'Makoto Nanaya', moveCount: 2 },
      { id: 'mu-12', name: 'Mu-12', moveCount: 2 },
      { id: 'naoto-kurogane', name: 'Naoto Kurogane', moveCount: 2 },
      { id: 'nine-the-phantom', name: 'Nine the Phantom', moveCount: 2 },
      { id: 'noel-vermillion', name: 'Noel Vermillion', moveCount: 4 },
      { id: 'nu-13', name: 'Nu-13', moveCount: 2 },
      { id: 'platinum-the-trinity', name: 'Platinum the Trinity', moveCount: 2 },
      { id: 'rachel-alucard', name: 'Rachel Alucard', moveCount: 4 },
      { id: 'ragna-the-bloodedge', name: 'Ragna the Bloodedge', moveCount: 8 },
      { id: 'rakshasa', name: 'Rakshasa', moveCount: 2 },
      { id: 'relius-clover', name: 'Relius Clover', moveCount: 2 },
      { id: 'susanoo', name: 'Susano\'o', moveCount: 2 },
      { id: 'taokaka', name: 'Taokaka', moveCount: 3 },
      { id: 'tsubaki-yayoi', name: 'Tsubaki Yayoi', moveCount: 2 },
      { id: 'valkenhayn-r-hellsing', name: 'Valkenhayn R. Hellsing', moveCount: 2 },
      { id: 'yuuki-terumi', name: 'Yuuki Terumi', moveCount: 2 }
    ],
...
rosterCount: 40,
    ...
    characters: [
      { id: 'adachi', name: 'Adachi', moveCount: 12 },
      { id: 'akatsuki', name: 'Akatsuki', moveCount: 12 },
      { id: 'akihiko', name: 'Akihiko', moveCount: 12 },
      { id: 'blake', name: 'Blake', moveCount: 12 },
      { id: 'carmine', name: 'Carmine', moveCount: 12 },
      { id: 'chie', name: 'Chie', moveCount: 12 },
      { id: 'elizabeth', name: 'Elizabeth', moveCount: 12 },
      { id: 'gordeau', name: 'Gordeau', moveCount: 12 },
      { id: 'hakumen', name: 'Hakumen', moveCount: 12 },
      { id: 'hazama', name: 'Hazama', moveCount: 12 },
      { id: 'heart', name: 'Heart', moveCount: 13 },
      { id: 'hilda', name: 'Hilda', moveCount: 13 },
      { id: 'hyde', name: 'Hyde', moveCount: 13 },
      { id: 'iron-tager', name: 'Iron Tager', moveCount: 13 },
      { id: 'izayoi', name: 'Izayoi', moveCount: 13 },
      { id: 'jubei', name: 'Jubei', moveCount: 13 },
      { id: 'kanji', name: 'Kanji', moveCount: 13 },
      { id: 'labrys', name: 'Labrys', moveCount: 12 },
      { id: 'linne', name: 'Linne', moveCount: 13 },
      { id: 'mai', name: 'Mai', moveCount: 13 },
      { id: 'makoto', name: 'Makoto', moveCount: 13 },
      { id: 'merkava', name: 'Merkava', moveCount: 12 },
      { id: 'mitsuru', name: 'Mitsuru', moveCount: 12 },
      { id: 'naoto-shirogane', name: 'Naoto Shirogane', moveCount: 12 },
      { id: 'nine', name: 'Nine', moveCount: 12 },
      { id: 'noel', name: 'Noel', moveCount: 12 },
      { id: 'nu-13', name: 'Nu-13', moveCount: 12 },
      { id: 'orie', name: 'Orie', moveCount: 12 },
      { id: 'platinum', name: 'Platinum', moveCount: 13 },
      { id: 'rachel', name: 'Rachel', moveCount: 13 },
      { id: 'ragna', name: 'Ragna', moveCount: 14 },
      { id: 'ruby', name: 'Ruby', moveCount: 14 },
      { id: 'seth', name: 'Seth', moveCount: 13 },
      { id: 'vatista', name: 'Vatista', moveCount: 13 },
      { id: 'waldstein', name: 'Waldstein', moveCount: 13 },
      { id: 'weiss', name: 'Weiss', moveCount: 14 },
      { id: 'yang', name: 'Yang', moveCount: 14 },
      { id: 'yosuke', name: 'Yosuke', moveCount: 13 },
      { id: 'yu', name: 'Yu', moveCount: 13 },
      { id: 'yumi', name: 'Yumi', moveCount: 13 }
    ],
...
rosterCount: 8,
    ...
    systemMechanics: [
        ...
        characters: [
      { id: 'alice', name: 'Alice', moveCount: 14 },
      { id: 'bakuryu', name: 'Bakuryu', moveCount: 14 },
      { id: 'fox', name: 'Fox', moveCount: 12 },
      { id: 'gado', name: 'Gado', moveCount: 14 },
      { id: 'greg', name: 'Greg', moveCount: 12 },
      { id: 'long', name: 'Long', moveCount: 14 },
      { id: 'mitsuko', name: 'Mitsuko', moveCount: 12 },
      { id: 'yugo', name: 'Yugo', moveCount: 17 }
    ],
...
rosterCount: 10,
    ...
    systemMechanics: [
        ...
        characters: [
      { id: 'alice', name: 'Alice', moveCount: 6 },
      { id: 'bakuryu', name: 'Bakuryu', moveCount: 11 },
      { id: 'busuzima', name: 'Busuzima', moveCount: 12 },
      { id: 'gado', name: 'Gado', moveCount: 6 },
      { id: 'jenny', name: 'Jenny', moveCount: 12 },
      { id: 'long', name: 'Long', moveCount: 6 },
      { id: 'shina', name: 'Shina', moveCount: 4 },
      { id: 'stun', name: 'Stun', moveCount: 13 },
      { id: 'uriko', name: 'Uriko', moveCount: 3 },
      { id: 'yugo', name: 'Yugo', moveCount: 9 }
    ],
...
rosterCount: 13,
    ...
    systemMechanics: [
        ...
        characters: [
      { id: 'alice', name: 'Alice', moveCount: 6 },
      { id: 'bakuryu', name: 'Bakuryu', moveCount: 6 },
      { id: 'busuzima', name: 'Busuzima', moveCount: 12 },
      { id: 'gado', name: 'Gado', moveCount: 6 },
      { id: 'jenny', name: 'Jenny', moveCount: 12 },
      { id: 'kohryu', name: 'Kohryu', moveCount: 10 },
      { id: 'long', name: 'Long', moveCount: 6 },
      { id: 'shina', name: 'Shina', moveCount: 4 },
      { id: 'stun', name: 'Stun', moveCount: 13 },
      { id: 'uriko', name: 'Uriko', moveCount: 3 },
      { id: 'uranus', name: 'Uranus', moveCount: 10 },
      { id: 'xion', name: 'Xion', moveCount: 12 },
      { id: 'yugo', name: 'Yugo', moveCount: 9 }
    ],
...
rosterCount: 17,
    ...
    systemMechanics: [
      ...
      { id: 'kohryu', name: 'Kohryu', moveCount: 10 },
      { id: 'long', name: 'Long', moveCount: 6 },
      { id: 'mana', name: 'Mana', moveCount: 10 },
      { id: 'nagi', name: 'Nagi', moveCount: 11 },
      { id: 'reiji', name: 'Reiji', moveCount: 11 },
      { id: 'ryoho', name: 'Ryoho', moveCount: 11 },
      { id: 'shina', name: 'Shina', moveCount: 4 },
      { id: 'stun', name: 'Stun', moveCount: 13 },
      { id: 'uranus', name: 'Uranus', moveCount: 10 },
      { id: 'uriko', name: 'Uriko', moveCount: 3 },
...
rosterCount: 8,
    ...
    systemMechanics: [
      ...
      { id: 'alice', name: 'Alice', moveCount: 6 },
      { id: 'bakuryu', name: 'Bakuryu', moveCount: 6 },
      { id: 'busuzima', name: 'Busuzima', moveCount: 11 },
      { id: 'cronos', name: 'Cronos', moveCount: 11 },
      { id: 'fang', name: 'Fang', moveCount: 11 },
      { id: 'gado', name: 'Gado', moveCount: 6 },
      { id: 'ganesha', name: 'Ganesha', moveCount: 11 },
      { id: 'jenny', name: 'Jenny', moveCount: 11 },
      { id: 'kohryu', name: 'Kohryu', moveCount: 11 },
      { id: 'long', name: 'Long', moveCount: 6 },
      { id: 'shina', name: 'Shina', moveCount: 11 },
      { id: 'stun', name: 'Stun', moveCount: 11 },
      { id: 'uriko', name: 'Uriko', moveCount: 11 },
      { id: 'uranus', name: 'Uranus', moveCount: 11 },
      { id: 'xion', name: 'Xion', moveCount: 11 },
      { id: 'yugo', name: 'Yugo', moveCount: 9 }
    ],
...
rosterCount: 10,
    ...
    systemMechanics: [
        ...
        characters: [
      { id: 'alsion-iii', name: 'Alsion III', moveCount: 15 },
      { id: 'condor', name: 'Condor', moveCount: 16 },
      { id: 'dao-long', name: 'Dao-Long', moveCount: 13 },
      { id: 'maherl', name: 'Maherl', moveCount: 15 },
      { id: 'piela', name: 'Piela', moveCount: 13 },
      { id: 'rila', name: 'Rila', moveCount: 14 },
      { id: 'saizo', name: 'Saizo', moveCount: 14 },
      { id: 'sheik-maherl', name: 'Sheik Maherl', moveCount: 15 },
      { id: 'sho', name: 'Sho', moveCount: 13 },
      { id: 'tia', name: 'Tia', moveCount: 15 }
    ],
...
rosterCount: 19,
    ...
    tags: ["2D"],
    characters: [
        { id: 'ryu', name: 'Ryu', moveCount: 11 },
        { id: 'guile', name: 'Guile', moveCount: 7 },
        { id: 'chun-li', name: 'Chun Li', moveCount: 7 },
        { id: 'mbison', name: 'Mbison', moveCount: 7 },
        { id: 'zangief', name: 'Zangief', moveCount: 16 },
        { id: 'alex', name: 'Alex', moveCount: 7 },
        { id: 'urien', name: 'Urien', moveCount: 17 },
        { id: 'yun', name: 'Yun', moveCount: 12 },
        { id: 'chun-li-3s', name: 'Chun Li 3s', moveCount: 7 },
        { id: 'felicia', name: 'Felicia', moveCount: 17 },
        { id: 'demitri', name: 'Demitri', moveCount: 17 },
        { id: 'jedah', name: 'Jedah', moveCount: 17 },
        { id: 'anakaris', name: 'Anakaris', moveCount: 16 },
        { id: 'leo', name: 'Leo', moveCount: 13 },
        { id: 'hauzer', name: 'Hauzer', moveCount: 15 },
        { id: 'mukuro', name: 'Mukuro', moveCount: 7 },
        { id: 'nool', name: 'Nool', moveCount: 7 },
        { id: 'guy', name: 'Guy', moveCount: 12 },
        { id: 'karin', name: 'Karin', moveCount: 17 },
        { id: 'sakura', name: 'Sakura', moveCount: 12 },
        { id: 'rose', name: 'Rose', moveCount: 12 },
        { id: 'ingrid', name: 'Ingrid', moveCount: 11 },
        { id: 'shin-akuma', name: 'Shin Akuma', moveCount: 12 }
      ],
...
rosterCount: 44,
    ...
    characters: [
        { id: 'ryu', name: 'Ryu', moveCount: 117 },
        { id: 'ken', name: 'Ken', moveCount: 131 },
        { id: 'chun-li', name: 'Chun Li', moveCount: 106 },
        { id: 'guile', name: 'Guile', moveCount: 97 },
        { id: 'zangief', name: 'Zangief', moveCount: 94 },
        { id: 'dhalsim', name: 'Dhalsim', moveCount: 116 },
        { id: 'ehonda', name: 'Ehonda', moveCount: 7 },
        { id: 'blanka', name: 'Blanka', moveCount: 95 },
        { id: 'balrog', name: 'Balrog', moveCount: 103 },
        { id: 'vega', name: 'Vega', moveCount: 102 },
        { id: 'sagat', name: 'Sagat', moveCount: 105 },
        { id: 'mbison', name: 'Mbison', moveCount: 7 },
        { id: 'sakura', name: 'Sakura', moveCount: 89 },
        { id: 'cammy', name: 'Cammy', moveCount: 100 },
        { id: 'akuma', name: 'Akuma', moveCount: 126 },
        { id: 'dan', name: 'Dan', moveCount: 85 },
        { id: 'morrigan', name: 'Morrigan', moveCount: 97 },
        { id: 'maki', name: 'Maki', moveCount: 122 },
        { id: 'eagle', name: 'Eagle', moveCount: 94 },
        { id: 'yun', name: 'Yun', moveCount: 101 },
        { id: 'kyosuke', name: 'Kyosuke', moveCount: 102 },
        { id: 'rolento', name: 'Rolento', moveCount: 98 },
        { id: 'evil-ryu', name: 'Evil Ryu', moveCount: 118 },
        { id: 'shin-akuma', name: 'Shin Akuma', moveCount: 114 },
        { id: 'kyo', name: 'Kyo', moveCount: 139 },
        { id: 'iori', name: 'Iori', moveCount: 100 },
        { id: 'terry', name: 'Terry', moveCount: 104 },
        { id: 'ryo', name: 'Ryo', moveCount: 102 },
        { id: 'mai', name: 'Mai', moveCount: 104 },
        { id: 'kim', name: 'Kim', moveCount: 121 },
        { id: 'geese', name: 'Geese', moveCount: 102 },
        { id: 'yamazaki', name: 'Yamazaki', moveCount: 106 },
        { id: 'raiden', name: 'Raiden', moveCount: 105 },
        { id: 'rugal', name: 'Rugal', moveCount: 7 },
        { id: 'vice', name: 'Vice', moveCount: 112 },
        { id: 'benimaru', name: 'Benimaru', moveCount: 103 },
        { id: 'yuri', name: 'Yuri', moveCount: 99 },
        { id: 'king', name: 'King', moveCount: 106 },
        { id: 'joe', name: 'Joe', moveCount: 88 },
        { id: 'athena', name: 'Athena', moveCount: 113 },
        { id: 'nakoruru', name: 'Nakoruru', moveCount: 115 },
        { id: 'hibiki', name: 'Hibiki', moveCount: 90 },
        { id: 'haohmaru', name: 'Haohmaru', moveCount: 80 },
        { id: 'rock', name: 'Rock', moveCount: 14 },
        { id: 'chang', name: 'Chang', moveCount: 100 },
        { id: 'blood-iori', name: 'Blood Iori', moveCount: 7 },
        { id: 'god-rugal', name: 'God Rugal', moveCount: 110 }
      ],
...
rosterCount: 29,
    ...
    characters: [
        ...
        { id: 'chun-li', name: 'Chun Li', moveCount: 12 },
        { id: 'guile', name: 'Guile', moveCount: 11 },
        { id: 'zangief', name: 'Zangief', moveCount: 12 },
        { id: 'dhalsim', name: 'Dhalsim', moveCount: 11 },
        { id: 'ehonda', name: 'Ehonda', moveCount: 7 },
        { id: 'blanka', name: 'Blanka', moveCount: 11 },
        { id: 'balrog', name: 'Balrog', moveCount: 11 },
        { id: 'vega', name: 'Vega', moveCount: 7 },
        { id: 'sagat', name: 'Sagat', moveCount: 11 },
        { id: 'mbison', name: 'Mbison', moveCount: 7 },
        { id: 'sakura', name: 'Sakura', moveCount: 11 },
        { id: 'cammy', name: 'Cammy', moveCount: 11 },
        { id: 'akuma', name: 'Akuma', moveCount: 12 },
        { id: 'dan', name: 'Dan', moveCount: 12 },
        { id: 'morrigan', name: 'Morrigan', moveCount: 11 },
        { id: 'kyo', name: 'Kyo', moveCount: 11 },
        { id: 'iori', name: 'Iori', moveCount: 11 },
        { id: 'terry', name: 'Terry', moveCount: 12 },
        { id: 'ryo', name: 'Ryo', moveCount: 7 },
        { id: 'mai', name: 'Mai', moveCount: 11 },
        { id: 'kim', name: 'Kim', moveCount: 7 },
        { id: 'geese', name: 'Geese', moveCount: 11 },
        { id: 'yamazaki', name: 'Yamazaki', moveCount: 7 },
        { id: 'raiden', name: 'Raiden', moveCount: 11 },
        { id: 'rugal', name: 'Rugal', moveCount: 7 },
        { id: 'vice', name: 'Vice', moveCount: 10 },
        { id: 'benimaru', name: 'Benimaru', moveCount: 11 },
        { id: 'yuri', name: 'Yuri', moveCount: 14 },
        { id: 'king', name: 'King', moveCount: 12 },
        { id: 'joe', name: 'Joe', moveCount: 11 },
        { id: 'nakoruru', name: 'Nakoruru', moveCount: 12 },
        { id: 'blood-iori', name: 'Blood Iori', moveCount: 7 }
      ],
...
rosterCount: 11,
    ...
    characters: [
      ...
      { id: 'jon-talbain', name: 'Jon Talbain', moveCount: 12 },
      { id: 'lord-raptor', name: 'Lord Raptor', moveCount: 13 },
      { id: 'victor', name: 'Victor', moveCount: 23 },
      { id: 'rikuo', name: 'Rikuo', moveCount: 21 },
      { id: 'sasquatch', name: 'Sasquatch', moveCount: 43 },
      { id: 'anakaris', name: 'Anakaris', moveCount: 22 },
      { id: 'bishamon', name: 'Bishamon', moveCount: 27 },
      { id: 'felicia', name: 'Felicia', moveCount: 13 },
...
rosterCount: 10,
    ...
    systemMechanics: [
        ...
        characters: [
      { id: 'ayane', name: 'Ayane', moveCount: 26 },
      { id: 'bayman', name: 'Bayman', moveCount: 17 },
      { id: 'gen-fu', name: 'Gen Fu', moveCount: 19 },
      { id: 'jann-lee', name: 'Jann Lee', moveCount: 25 },
      { id: 'kasumi', name: 'Kasumi', moveCount: 12 },
      { id: 'lei-fang', name: 'Lei Fang', moveCount: 11 },
      { id: 'leon', name: 'Leon', moveCount: 22 },
      { id: 'ryu-hayabusa', name: 'Ryu Hayabusa', moveCount: 28 },
      { id: 'tina-armstrong', name: 'Tina Armstrong', moveCount: 22 },
      { id: 'zack', name: 'Zack', moveCount: 9 }
    ],
...
rosterCount: 14,
    ...
    systemMechanics: [
        ...
        characters: [
      { id: 'ayane', name: 'Ayane', moveCount: 36 },
      { id: 'bass', name: 'Bass', moveCount: 40 },
      { id: 'bayman', name: 'Bayman', moveCount: 11 },
      { id: 'ein', name: 'Ein', moveCount: 10 },
      { id: 'gen-fu', name: 'Gen Fu', moveCount: 6 },
      { id: 'helena', name: 'Helena', moveCount: 8 },
      { id: 'jann-lee', name: 'Jann Lee', moveCount: 18 },
      { id: 'kasumi', name: 'Kasumi', moveCount: 11 },
      { id: 'leon', name: 'Leon', moveCount: 45 },
      { id: 'lei-fang', name: 'Lei Fang', moveCount: 11 },
      { id: 'ryu-hayabusa', name: 'Ryu Hayabusa', moveCount: 41 },
      { id: 'tengu', name: 'Tengu', moveCount: 39 },
      { id: 'tina', name: 'Tina', moveCount: 31 },
      { id: 'zack', name: 'Zack', moveCount: 31 }
    ],
...
rosterCount: 17,
    ...
    systemMechanics: [
        ...
        characters: [
      { id: 'ayane', name: 'Ayane', moveCount: 11 },
      { id: 'bass', name: 'Bass', moveCount: 17 },
      { id: 'bayman', name: 'Bayman', moveCount: 11 },
      { id: 'brad-wong', name: 'Brad Wong', moveCount: 10 },
      { id: 'christie', name: 'Christie', moveCount: 11 },
      { id: 'ein', name: 'Ein', moveCount: 10 },
      { id: 'gen-fu', name: 'Gen Fu', moveCount: 8 },
      { id: 'hayate', name: 'Hayate', moveCount: 29 },
      { id: 'helena', name: 'Helena', moveCount: 10 },
      { id: 'hitomi', name: 'Hitomi', moveCount: 10 },
      { id: 'jann-lee', name: 'Jann Lee', moveCount: 4 },
      { id: 'kasumi', name: 'Kasumi', moveCount: 11 },
      { id: 'lei-fang', name: 'Lei Fang', moveCount: 11 },
      { id: 'leon', name: 'Leon', moveCount: 29 },
      { id: 'ryu-hayabusa', name: 'Ryu Hayabusa', moveCount: 11 },
      { id: 'tina', name: 'Tina', moveCount: 2 },
      { id: 'zack', name: 'Zack', moveCount: 11 }
    ],
...
rosterCount: 25,
    ...
    systemMechanics: [
      ...
      { id: 'brad-wong', name: 'Brad Wong', moveCount: 10 },
      { id: 'christie', name: 'Christie', moveCount: 11 },
      { id: 'ein', name: 'Ein', moveCount: 11 },
      { id: 'eliot', name: 'Eliot', moveCount: 10 },
      { id: 'gen-fu', name: 'Gen Fu', moveCount: 8 },
      { id: 'hayate', name: 'Hayate', moveCount: 29 },
      { id: 'helena', name: 'Helena', moveCount: 10 },
      { id: 'hitomi', name: 'Hitomi', moveCount: 10 },
      { id: 'jann-lee', name: 'Jann Lee', moveCount: 4 },
      { id: 'kasumi', name: 'Kasumi', moveCount: 11 },
      { id: 'kokoro', name: 'Kokoro', moveCount: 11 },
      { id: 'la-mariposa', name: 'La Mariposa', moveCount: 11 },
      { id: 'leon', name: 'Leon', moveCount: 29 },
      { id: 'lei-fang', name: 'Lei Fang', moveCount: 11 },
      { id: 'nicole-458', name: 'Nicole-458', moveCount: 10 },
      { id: 'ryu-hayabusa', name: 'Ryu Hayabusa', moveCount: 11 },
      { id: 'spartan-458', name: 'Spartan-458', moveCount: 4 },
      { id: 'tina', name: 'Tina', moveCount: 2 },
      { id: 'zack', name: 'Zack', moveCount: 11 }
    ],
...
rosterCount: 29,
    ...
    systemMechanics: [
        ...
        characters: [
      { id: 'akira-yuki', name: 'Akira Yuki', moveCount: 15 },
      { id: 'ayane', name: 'Ayane', moveCount: 27 },
      { id: 'bass', name: 'Bass', moveCount: 12 },
      { id: 'bayman', name: 'Bayman', moveCount: 17 },
      { id: 'brad-wong', name: 'Brad Wong', moveCount: 27 },
      { id: 'christie', name: 'Christie', moveCount: 11 },
      { id: 'eliot', name: 'Eliot', moveCount: 11 },
      { id: 'gen-fu', name: 'Gen Fu', moveCount: 11 },
      { id: 'hayate', name: 'Hayate', moveCount: 11 },
      { id: 'helena', name: 'Helena', moveCount: 8 },
      { id: 'hitomi', name: 'Hitomi', moveCount: 10 },
      { id: 'jacky-bryant', name: 'Jacky Bryant', moveCount: 11 },
      { id: 'jann-lee', name: 'Jann Lee', moveCount: 28 },
      { id: 'kasumi', name: 'Kasumi', moveCount: 11 },
      { id: 'kokoro', name: 'Kokoro', moveCount: 10 },
      { id: 'la-mariposa', name: 'La Mariposa', moveCount: 11 },
      { id: 'leifang', name: 'Lei Fang', moveCount: 11 },
      { id: 'marie-rose', name: 'Marie Rose', moveCount: 12 },
      { id: 'mila', name: 'Mila', moveCount: 10 },
      { id: 'momiji', name: 'Momiji', moveCount: 11 },
      { id: 'nyotengu', name: 'Nyotengu', moveCount: 11 },
      { id: 'pai-chan', name: 'Pai Chan', moveCount: 11 },
      { id: 'phase-4', name: 'Phase 4', moveCount: 11 },
      { id: 'rachel', name: 'Rachel', moveCount: 11 },
      { id: 'rig', name: 'Rig', moveCount: 11 },
      { id: 'ryu-hayabusa', name: 'Ryu Hayabusa', moveCount: 11 },
      { id: 'sarah-bryant', name: 'Sarah Bryant', moveCount: 13 },
      { id: 'tina', name: 'Tina', moveCount: 11 },
      { id: 'zack', name: 'Zack', moveCount: 11 }
    ],
...
rosterCount: 29,
    ...
    systemMechanics: [
        ...
        characters: [
      { id: 'ayane', name: 'Ayane', moveCount: 11 },
      { id: 'bass', name: 'Bass', moveCount: 11 },
      { id: 'bayman', name: 'Bayman', moveCount: 11 },
      { id: 'brad-wong', name: 'Brad Wong', moveCount: 17 },
      { id: 'christie', name: 'Christie', moveCount: 11 },
      { id: 'diego', name: 'Diego', moveCount: 11 },
      { id: 'eliot', name: 'Eliot', moveCount: 11 },
      { id: 'hayate', name: 'Hayate', moveCount: 11 },
      { id: 'helena', name: 'Helena', moveCount: 11 },
      { id: 'hitomi', name: 'Hitomi', moveCount: 13 },
      { id: 'honoka', name: 'Honoka', moveCount: 10 },
      { id: 'jann-lee', name: 'Jann Lee', moveCount: 8 },
      { id: 'kasumi', name: 'Kasumi', moveCount: 11 },
      { id: 'kokoro', name: 'Kokoro', moveCount: 10 },
      { id: 'kula-diamond', name: 'Kula Diamond', moveCount: 11 },
      { id: 'la-mariposa', name: 'La Mariposa', moveCount: 19 },
      { id: 'leifang', name: 'Lei Fang', moveCount: 11 },
      { id: 'mai-shiranui', name: 'Mai Shiranui', moveCount: 11 },
      { id: 'marie-rose', name: 'Marie Rose', moveCount: 11 },
      { id: 'mila', name: 'Mila', moveCount: 13 },
      { id: 'nico', name: 'NiCO', moveCount: 10 },
      { id: 'nyotengu', name: 'Nyotengu', moveCount: 11 },
      { id: 'phase-4', name: 'Phase 4', moveCount: 11 },
      { id: 'rachel', name: 'Rachel', moveCount: 9 },
      { id: 'rig', name: 'Rig', moveCount: 10 },
      { id: 'ryu-hayabusa', name: 'Ryu Hayabusa', moveCount: 11 },
      { id: 'tamaki', name: 'Tamaki', moveCount: 10 },
      { id: 'tina', name: 'Tina', moveCount: 2 },
      { id: 'zack', name: 'Zack', moveCount: 11 }
    ],
...
rosterCount: 16,
    ...
    characters: [
      { id: 'berserker', name: 'Berserker', moveCount: 12 },
      { id: 'crusader', name: 'Crusader', moveCount: 23 },
      { id: 'dragon-knight', name: 'Dragon Knight', moveCount: 40 },
      { id: 'enchantress', name: 'Enchantress', moveCount: 15 },
      { id: 'grappler', name: 'Grappler', moveCount: 12 },
      { id: 'hitman', name: 'Hitman', moveCount: 17 },
      { id: 'inquisitor', name: 'Inquisitor', moveCount: 12 },
      { id: 'kunoichi', name: 'Kunoichi', moveCount: 17 },
      { id: 'launcher', name: 'Launcher', moveCount: 18 },
      { id: 'lost-warrior', name: 'Lost Warrior', moveCount: 17 },
      { id: 'ranger', name: 'Ranger', moveCount: 17 },
      { id: 'striker', name: 'Striker', moveCount: 12 },
      { id: 'swift-master', name: 'Swift Master', moveCount: 45 },
      { id: 'troubleshooter', name: 'Troubleshooter', moveCount: 17 },
      { id: 'vanguard', name: 'Vanguard', moveCount: 17 },
      { id: 'wind-walker', name: 'Wind Walker', moveCount: 17 }
    ],
...
rosterCount: 11,
    ...
    characters: [
      { id: 'andy-bogard', name: 'Andy Bogard', moveCount: 9 },
      { id: 'axel-hawk', name: 'Axel Hawk', moveCount: 6 },
      { id: 'big-bear', name: 'Big Bear', moveCount: 9 },
      { id: 'cheng-sinzan', name: 'Cheng Sinzan', moveCount: 5 },
      { id: 'joe-higashi', name: 'Joe Higashi', moveCount: 9 },
      { id: 'jubei-yamada', name: 'Jubei Yamada', moveCount: 9 },
      { id: 'kim-kaphwan', name: 'Kim Kaphwan', moveCount: 4 },
      { id: 'laurence-blood', name: 'Laurence Blood', moveCount: 7 },
      { id: 'mai-shiranui', name: 'Mai Shiranui', moveCount: 4 },
      { id: 'terry-bogard', name: 'Terry Bogard', moveCount: 9 },
      { id: 'wolfgang-krauser', name: 'Wolfgang Krauser', moveCount: 8 }
    ],
...
rosterCount: 12,
    ...
    characters: [
      { id: 'andy-bogard', name: 'Andy Bogard', moveCount: 8 },
      { id: 'blue-mary', name: 'Blue Mary', moveCount: 4 },
      { id: 'bob-wilson', name: 'Bob Wilson', moveCount: 12 },
      { id: 'franco-bash', name: 'Franco Bash', moveCount: 7 },
      { id: 'hon-fu', name: 'Hon-Fu', moveCount: 8 },
      { id: 'jin-chonrei', name: 'Jin Chonrei', moveCount: 7 },
      { id: 'jin-chonshu', name: 'Jin Chonshu', moveCount: 5 },
      { id: 'joe-higashi', name: 'Joe Higashi', moveCount: 9 },
      { id: 'mai-shiranui', name: 'Mai Shiranui', moveCount: 8 },
      { id: 'ryuji-yamazaki', name: 'Ryuji Yamazaki', moveCount: 5 },
      { id: 'sokaku-mochizuki', name: 'Sokaku Mochizuki', moveCount: 13 },
      { id: 'terry-bogard', name: 'Terry Bogard', moveCount: 7 }
    ],
...
rosterCount: 16,
    ...
    characters: [
      { id: 'andy-bogard', name: 'Andy Bogard', moveCount: 9 },
      { id: 'axel-hawk', name: 'Axel Hawk', moveCount: 6 },
      { id: 'big-bear', name: 'Big Bear', moveCount: 10 },
      { id: 'billy-kane', name: 'Billy Kane', moveCount: 7 },
      { id: 'cheng-sinzan', name: 'Cheng Sinzan', moveCount: 5 },
      { id: 'duck-king', name: 'Duck King', moveCount: 7 },
      { id: 'geese-howard', name: 'Geese Howard', moveCount: 5 },
      { id: 'joe-higashi', name: 'Joe Higashi', moveCount: 9 },
      { id: 'jubei-yamada', name: 'Jubei Yamada', moveCount: 10 },
      { id: 'kim-kaphwan', name: 'Kim Kaphwan', moveCount: 4 },
      { id: 'laurence-blood', name: 'Laurence Blood', moveCount: 6 },
      { id: 'mai-shiranui', name: 'Mai Shiranui', moveCount: 6 },
      { id: 'ryo-sakazaki', name: 'Ryo Sakazaki', moveCount: 4 },
      { id: 'terry-bogard', name: 'Terry Bogard', moveCount: 9 },
      { id: 'tung-fu-rue', name: 'Tung Fu Rue', moveCount: 5 },
      { id: 'wolfgang-krauser', name: 'Wolfgang Krauser', moveCount: 8 }
    ],
...

  {
    ...
    characters: [
      { id: 'andy-bogard', name: 'Andy Bogard', moveCount: 19 },
      { id: 'b-jenet', name: 'B. Jenet', moveCount: 15 },
      { id: 'billy-kane', name: 'Billy Kane', moveCount: 17 },
      { id: 'chun-li', name: 'Chun-Li', moveCount: 8 },
      { id: 'cristiano-ronaldo', name: 'Cristiano Ronaldo', moveCount: 18 },
      { id: 'gato', name: 'Gato', moveCount: 24 },
      { id: 'hotaru-futaba', name: 'Hotaru Futaba', moveCount: 16 },
      { id: 'joe-higashi', name: 'Joe Higashi', moveCount: 24 },
      { id: 'ken-masters', name: 'Ken Masters', moveCount: 8 },
      { id: 'kenshiro', name: 'Kenshiro', moveCount: 31 },
      { id: 'mai-shiranui', name: 'Mai Shiranui', moveCount: 18 },
      { id: 'marco-rodrigues', name: 'Marco Rodrigues', moveCount: 14 },
      { id: 'preecha', name: 'Preecha', moveCount: 16 },
      { id: 'rock-howard', name: 'Rock Howard', moveCount: 18 },
      { id: 'salvatore-ganacci', name: 'Salvatore Ganacci', moveCount: 27 },
      { id: 'terry-bogard', name: 'Terry Bogard', moveCount: 13 },
      { id: 'tizoc', name: 'Tizoc', moveCount: 16 },
      { id: 'vox-reaper', name: 'Vox Reaper', moveCount: 10 },
      { id: 'wolfgang-krauser', name: 'Wolfgang Krauser', moveCount: 8 }
    ],
...
rosterCount: 11,
    ...
    characters: [
      { id: 'andy-bogard', name: 'Andy Bogard', moveCount: 4 },
      { id: 'billy-kane', name: 'Billy Kane', moveCount: 6 },
      { id: 'duck-king', name: 'Duck King', moveCount: 8 },
      { id: 'geese-howard', name: 'Geese Howard', moveCount: 5 },
      { id: 'hwa-jai', name: 'Hwa Jai', moveCount: 8 },
      { id: 'joe-higashi', name: 'Joe Higashi', moveCount: 6 },
      { id: 'michael-max', name: 'Michael Max', moveCount: 2 },
      { id: 'raiden', name: 'Raiden', moveCount: 5 },
      { id: 'richard-meyer', name: 'Richard Meyer', moveCount: 2 },
      { id: 'terry-bogard', name: 'Terry Bogard', moveCount: 4 },
      { id: 'tung-fu-rue', name: 'Tung Fu Rue', moveCount: 2 }
    ],
...
rosterCount: 14,
    ...
    systemMechanics: [
        ...
        characters: [
      { id: 'akira', name: 'Akira', moveCount: 5 },
      { id: 'bean', name: 'Bean', moveCount: 3 },
      { id: 'candy', name: 'Candy', moveCount: 5 },
      { id: 'deku', name: 'Deku', moveCount: 4 },
      { id: 'honey', name: 'Honey', moveCount: 4 },
      { id: 'janet', name: 'Janet', moveCount: 4 },
      { id: 'kids-akira', name: 'Kids Akira', moveCount: 4 },
      { id: 'kids-sarah', name: 'Kids Sarah', moveCount: 4 },
      { id: 'kumachan', name: 'Kumachan', moveCount: 4 },
      { id: 'pai', name: 'Pai', moveCount: 4 },
      { id: 'rent-a-hero', name: 'Rent-A-Hero', moveCount: 4 },
      { id: 'satoru', name: 'Satoru', moveCount: 3 },
      { id: 'shiba', name: 'Shiba', moveCount: 4 },
      { id: 'wolf', name: 'Wolf', moveCount: 4 }
    ],
...
rosterCount: 14,
    ...
    characters: [
      { id: 'allen-snider', name: 'Allen Snider', moveCount: 13 },
      { id: 'blair-dame', name: 'Blair Dame', moveCount: 13 },
      { id: 'darun-mister', name: 'Darun Mister', moveCount: 19 },
      { id: 'doctrine-dark', name: 'Doctrine Dark', moveCount: 8 },
      { id: 'garuda', name: 'Garuda', moveCount: 13 },
      { id: 'hokuto', name: 'Hokuto', moveCount: 13 },
      { id: 'jack', name: 'Jack', moveCount: 21 },
      { id: 'kairi', name: 'Kairi', moveCount: 12 },
      { id: 'pullum-purna', name: 'Pullum Purna', moveCount: 13 },
      { id: 'sanane', name: 'Sanane', moveCount: 11 },
      { id: 'shadowgeist', name: 'Shadowgeist', moveCount: 13 },
      { id: 'shirase', name: 'Shirase', moveCount: 13 },
      { id: 'skullomania', name: 'Skullomania', moveCount: 13 },
      { id: 'terry-bogard', name: 'Terry Bogard', moveCount: 12 }
    ],
...
rosterCount: 7,
    ...
    systemMechanics: [
        ...
        characters: [
      { id: 'bahn', name: 'Bahn', moveCount: 12 },
      { id: 'candy', name: 'Candy', moveCount: 17 },
      { id: 'honey', name: 'Honey', moveCount: 6 },
      { id: 'jane', name: 'Jane', moveCount: 6 },
      { id: 'picky', name: 'Picky', moveCount: 12 },
      { id: 'sanman', name: 'Sanman', moveCount: 14 },
      { id: 'tokio', name: 'Tokio', moveCount: 10 }
    ],
...
rosterCount: 9,
    ...
    systemMechanics: [
        ...
        characters: [
      { id: 'bahn', name: 'Bahn', moveCount: 20 },
      { id: 'charlie', name: 'Charlie', moveCount: 3 },
      { id: 'emi', name: 'Emi', moveCount: 10 },
      { id: 'honey', name: 'Honey', moveCount: 6 },
      { id: 'jane', name: 'Jane', moveCount: 6 },
      { id: 'kuhn', name: 'Kuhn', moveCount: 3 },
      { id: 'picky', name: 'Picky', moveCount: 6 },
      { id: 'sanman', name: 'Sanman', moveCount: 3 },
      { id: 'tokio', name: 'Tokio', moveCount: 3 }
    ],
...
rosterCount: 10,
    ...
    systemMechanics: [
        ...
        characters: [
      { id: 'heart', name: 'Heart', moveCount: 13 },
      { id: 'jagi', name: 'Jagi', moveCount: 22 },
      { id: 'judas', name: 'Judas', moveCount: 13 },
      { id: 'kenshiro', name: 'Kenshiro', moveCount: 17 },
      { id: 'mamiya', name: 'Mamiya', moveCount: 13 },
      { id: 'raoh', name: 'Raoh', moveCount: 16 },
      { id: 'rei', name: 'Rei', moveCount: 14 },
      { id: 'shin', name: 'Shin', moveCount: 15 },
      { id: 'souther', name: 'Souther', moveCount: 13 },
      { id: 'toki', name: 'Toki', moveCount: 15 }
    ],
...
rosterCount: 9,
    ...
    systemMechanics: [
        ...
        characters: [
      { id: 'alvan', name: 'Alvan', moveCount: 9 },
      { id: 'bonus-kun', name: 'Bonus-Kun', moveCount: 11 },
      { id: 'felden', name: 'Felden', moveCount: 15 },
      { id: 'gunter', name: 'Gunter', moveCount: 6 },
      { id: 'jaba', name: 'Jaba', moveCount: 9 },
      { id: 'kazuma', name: 'Kazuma', moveCount: 11 },
      { id: 'musashi', name: 'Musashi', moveCount: 11 },
      { id: 'rolf', name: 'Rolf', moveCount: 11 },
      { id: 'roomi', name: 'Roomi', moveCount: 6 }
    ],
...
rosterCount: 14,
    ...
    characters: [
      { id: 'b-jenet', name: 'B. Jenet', moveCount: 15 },
      { id: 'dong-hwan', name: 'Dong Hwan', moveCount: 16 },
      { id: 'freeman', name: 'Freeman', moveCount: 14 },
      { id: 'gato', name: 'Gato', moveCount: 15 },
      { id: 'grant', name: 'Grant', moveCount: 32 },
      { id: 'hokutomaru', name: 'Hokutomaru', moveCount: 14 },
      { id: 'hotaru', name: 'Hotaru', moveCount: 28 },
      { id: 'jae-hoon', name: 'Jae Hoon', moveCount: 14 },
      { id: 'kain', name: 'Kain', moveCount: 20 },
      { id: 'kevin', name: 'Kevin', moveCount: 13 },
      { id: 'marco', name: 'Marco', moveCount: 14 },
      { id: 'rock-howard', name: 'Rock Howard', moveCount: 17 },
      { id: 'terry-bogard', name: 'Terry Bogard', moveCount: 14 },
      { id: 'tizoc', name: 'Tizoc', moveCount: 6 }
    ],
...
rosterCount: 8,
    ...
    systemMechanics: [
        ...
        characters: [
      { id: 'death-adder', name: 'Death Adder', moveCount: 5 },
      { id: 'doc', name: 'Doc', moveCount: 9 },
      { id: 'gillius', name: 'Gillius', moveCount: 11 },
      { id: 'jamm', name: 'Jamm', moveCount: 7 },
      { id: 'kain', name: 'Kain', moveCount: 4 },
      { id: 'milan', name: 'Milan', moveCount: 11 },
      { id: 'panchos', name: 'Panchos', moveCount: 11 },
      { id: 'zoma', name: 'Zoma', moveCount: 12 }
    ],
...
rosterCount: 35,
    ...
    characters: [
        { id: '2b', name: '2B', moveCount: 56 },
        { id: 'anila', name: 'Anila', moveCount: 57 },
        { id: 'anre', name: 'Anre', moveCount: 74 },
        { id: 'avatar-belial', name: 'Avatar Belial', moveCount: 66 },
        { id: 'beatrix', name: 'Beatrix', moveCount: 54 },
        { id: 'beelzebub', name: 'Beelzebub', moveCount: 64 },
        { id: 'belial', name: 'Belial', moveCount: 59 },
        { id: 'cagliostro', name: 'Cagliostro', moveCount: 73 },
        { id: 'charlotta', name: 'Charlotta', moveCount: 55 },
        { id: 'djeeta', name: 'Djeeta', moveCount: 61 },
        { id: 'eustace', name: 'Eustace', moveCount: 77 },
        { id: 'ferry', name: 'Ferry', moveCount: 59 },
        { id: 'gran', name: 'Gran', moveCount: 57 },
        { id: 'grimnir', name: 'Grimnir', moveCount: 66 },
        { id: 'katalina', name: 'Katalina', moveCount: 53 },
        { id: 'ladiva', name: 'Ladiva', moveCount: 62 },
        { id: 'lancelot', name: 'Lancelot', moveCount: 59 },
        { id: 'lowain', name: 'Lowain', moveCount: 63 },
        { id: 'lucilius', name: 'Lucilius', moveCount: 58 },
        { id: 'metera', name: 'Metera', moveCount: 57 },
        { id: 'narmaya', name: 'Narmaya', moveCount: 78 },
        { id: 'nier', name: 'Nier', moveCount: 70 },
        { id: 'percival', name: 'Percival', moveCount: 62 },
        { id: 'sandalphon', name: 'Sandalphon', moveCount: 75 },
        { id: 'seox', name: 'Seox', moveCount: 76 },
        { id: 'siegfried', name: 'Siegfried', moveCount: 59 },
        { id: 'soriz', name: 'Soriz', moveCount: 57 },
        { id: 'vane', name: 'Vane', moveCount: 57 },
        { id: 'vaseraga', name: 'Vaseraga', moveCount: 57 },
        { id: 'versusia', name: 'Versusia', moveCount: 58 },
        { id: 'vikala', name: 'Vikala', moveCount: 62 },
        { id: 'vira', name: 'Vira', moveCount: 73 },
        { id: 'yuel', name: 'Yuel', moveCount: 66 },
        { id: 'zeta', name: 'Zeta', moveCount: 64 },
        { id: 'zooey', name: 'Zooey', moveCount: 62 }
      ],
...
rosterCount: 14,
    ...
    systemMechanics: [
        ...
        characters: [
      { id: 'bristol-weller', name: 'Bristol Weller', moveCount: 12 },
      { id: 'chris-wayne', name: 'Chris Wayne', moveCount: 13 },
      { id: 'damian-shade', name: 'Damian Shade', moveCount: 13 },
      { id: 'falco', name: 'Falco', moveCount: 13 },
      { id: 'hizumi-yukinoue', name: 'Hizumi Yukinoue', moveCount: 13 },
      { id: 'larry-light', name: 'Larry Light', moveCount: 15 },
      { id: 'mad', name: 'M.A.D', moveCount: 13 },
      { id: 'oume-otane', name: 'Oume & Otane', moveCount: 11 },
      { id: 'popura-hananokoji', name: 'Popura Hananokoji', moveCount: 13 },
      { id: 'remi-otogiri', name: 'Remi Otogiri', moveCount: 13 },
      { id: 'solis-r8000', name: 'Solis R8000', moveCount: 13 },
      { id: 'tenjinbashi-sujiroku', name: 'Tenjinbashi Sujiroku', moveCount: 14 }
    ],
...
rosterCount: 12,
    ...
    tags: ["2D", "Anime"],
    characters: [
      { id: 'axl-low', name: 'Axl Low', moveCount: 13 },
      { id: 'baiken', name: 'Baiken', moveCount: 16 },
      { id: 'chipp-zanuff', name: 'Chipp Zanuff', moveCount: 16 },
      { id: 'dr-baldhead', name: 'Dr. Baldhead', moveCount: 4 },
      { id: 'kliff-undersn', name: 'Kliff Undersn', moveCount: 12 },
      { id: 'ky-kiske', name: 'Ky Kiske', moveCount: 10 },
      { id: 'may', name: 'May', moveCount: 11 },
      { id: 'millia-rage', name: 'Millia Rage', moveCount: 7 },
      { id: 'potemkin', name: 'Potemkin', moveCount: 10 },
      { id: 'sol-badguy', name: 'Sol Badguy', moveCount: 9 },
      { id: 'testament', name: 'Testament', moveCount: 8 },
      { id: 'zato-1', name: 'Zato-1', moveCount: 7 }
    ],
...
rosterCount: 15,
    ...
    systemMechanics: [
        ...
        characters: [
      { id: 'alessy', name: 'Alessy', moveCount: 12 },
      { id: 'chaka', name: 'Chaka', moveCount: 12 },
      { id: 'dio-brando', name: 'Dio Brando', moveCount: 17 },
      { id: 'hol-horse', name: 'Hol Horse', moveCount: 13 },
      { id: 'iggy', name: 'Iggy', moveCount: 13 },
      { id: 'jean-pierre-polnareff', name: 'Jean Pierre Polnareff', moveCount: 16 },
      { id: 'joseph-joestar', name: 'Joseph Joestar', moveCount: 13 },
      { id: 'jotaro-kujo', name: 'Jotaro Kujo', moveCount: 15 },
      { id: 'mariah', name: 'Mariah', moveCount: 13 },
      { id: 'midler', name: 'Midler', moveCount: 14 },
      { id: 'muhammad-avdol', name: 'Muhammad Avdol', moveCount: 16 },
      { id: 'noriaki-kakyoin', name: 'Noriaki Kakyoin', moveCount: 14 },
      { id: 'petshop', name: 'Petshop', moveCount: 12 },
      { id: 'shadow-dio', name: 'Shadow Dio', moveCount: 14 },
      { id: 'vanilla-ice', name: 'Vanilla Ice', moveCount: 14 }
    ],
...
rosterCount: 8,
    ...
    systemMechanics: [
        ...
        characters: [
      { id: 'asuka', name: 'Asuka', moveCount: 17 },
      { id: 'crusher', name: 'Crusher', moveCount: 10 },
      { id: 'jd-stone', name: 'J.D. Stone', moveCount: 12 },
      { id: 'khan', name: 'Khan', moveCount: 10 },
      { id: 'malice', name: 'Malice', moveCount: 10 },
      { id: 'rena', name: 'Rena', moveCount: 10 },
      { id: 'shadow', name: 'Shadow', moveCount: 10 },
      { id: 'vittoria', name: 'Vittoria', moveCount: 10 }
    ],
...
rosterCount: 9,
    ...
    systemMechanics: [
        ...
        characters: [
      { id: 'alaric', name: 'Alaric', moveCount: 13 },
      { id: 'angus', name: 'Angus', moveCount: 13 },
      { id: 'chagi', name: 'Chagi', moveCount: 14 },
      { id: 'habaki', name: 'Habaki', moveCount: 12 },
      { id: 'kaumi', name: 'Kaumi', moveCount: 12 },
      { id: 'kendo', name: 'Kendo', moveCount: 10 },
      { id: 'pakawa', name: 'Pakawa', moveCount: 11 },
      { id: 'senzo', name: 'Senzo', moveCount: 14 },
      { id: 'thoth', name: 'Thoth', moveCount: 14 }
    ],
...

  {
    ...
    systemMechanics: [
        ...
        characters: [
      { id: 'b-orchid', name: 'B. Orchid', moveCount: 15 },
      { id: 'chief-thunder', name: 'Chief Thunder', moveCount: 21 },
      { id: 'cinder', name: 'Cinder', moveCount: 21 },
      { id: 'fulgore', name: 'Fulgore', moveCount: 22 },
      { id: 'glacius', name: 'Glacius', moveCount: 18 },
      { id: 'jago', name: 'Jago', moveCount: 19 },
      { id: 'riptor', name: 'Riptor', moveCount: 20 },
      { id: 'sabrewulf', name: 'Sabrewulf', moveCount: 19 },
      { id: 'spinal', name: 'Spinal', moveCount: 19 },
      { id: 'tj-combo', name: 'T.J. Combo', moveCount: 22 }
    ],
...

  {
    ...
    systemMechanics: [
        ...
        characters: [
      { id: 'aganos', name: 'Aganos', moveCount: 10 },
      { id: 'aria', name: 'ARIA', moveCount: 10 },
      { id: 'b-orchid', name: 'B. Orchid', moveCount: 15 },
      { id: 'cinder', name: 'Cinder', moveCount: 10 },
      { id: 'eagle', name: 'Eagle', moveCount: 10 },
      { id: 'eyedol', name: 'Eyedol', moveCount: 10 },
      { id: 'fulgore', name: 'Fulgore', moveCount: 10 },
      { id: 'gargos', name: 'Gargos', moveCount: 10 },
      { id: 'general-raam', name: 'General RAAM', moveCount: 10 },
      { id: 'glacius', name: 'Glacius', moveCount: 15 },
      { id: 'hisako', name: 'Hisako', moveCount: 10 },
      { id: 'jago', name: 'Jago', moveCount: 10 },
      { id: 'kan-ra', name: 'Kan-Ra', moveCount: 10 },
      { id: 'kilgore', name: 'Kilgore', moveCount: 10 },
      { id: 'kim-wu', name: 'Kim Wu', moveCount: 24 },
      { id: 'maya', name: 'Maya', moveCount: 14 },
      { id: 'mira', name: 'Mira', moveCount: 10 },
      { id: 'omen', name: 'Omen', moveCount: 10 },
      { id: 'rash', name: 'Rash', moveCount: 10 },
      { id: 'riptor', name: 'Riptor', moveCount: 10 },
      { id: 'sabrewulf', name: 'Sabrewulf', moveCount: 14 },
      { id: 'sadira', name: 'Sadira', moveCount: 10 },
      { id: 'shadow-jago', name: 'Shadow Jago', moveCount: 10 },
      { id: 'shin-hisako', name: 'Shin Hisako', moveCount: 10 },
      { id: 'spinal', name: 'Spinal', moveCount: 15 },
      { id: 'tj-combo', name: 'T.J. Combo', moveCount: 28 },
      { id: 'thunder', name: 'Thunder', moveCount: 10 },
      { id: 'tusk', name: 'Tusk', moveCount: 15 }
    ],
...

  {
    ...
    systemMechanics: [
        ...
        characters: [
      { id: 'b-orchid', name: 'B. Orchid', moveCount: 11 },
      { id: 'fulgore', name: 'Fulgore', moveCount: 8 },
      { id: 'gargos', name: 'Gargos', moveCount: 12 },
      { id: 'glacius', name: 'Glacius', moveCount: 16 },
      { id: 'jago', name: 'Jago', moveCount: 20 },
      { id: 'kim-wu', name: 'Kim Wu', moveCount: 16 },
      { id: 'maya', name: 'Maya', moveCount: 15 },
      { id: 'sabrewulf', name: 'Sabrewulf', moveCount: 17 },
      { id: 'spinal', name: 'Spinal', moveCount: 15 },
      { id: 'tj-combo', name: 'T.J. Combo', moveCount: 14 },
      { id: 'tusk', name: 'Tusk', moveCount: 16 }
    ],
...
rosterCount: 8,
    ...
    tags: ["2D", "Tag"],
    characters: [
      { id: 'chung-paifu', name: 'Chung Paifu', moveCount: 11 },
      { id: 'gozu', name: 'Gozu', moveCount: 11 },
      { id: 'kim-sue-il', name: 'Kim Sue Il', moveCount: 13 },
      { id: 'king-lion', name: 'King Lion', moveCount: 3 },
      { id: 'max-eagle', name: 'Max Eagle', moveCount: 10 },
      { id: 'mezu', name: 'Mezu', moveCount: 11 },
      { id: 'rosa', name: 'Rosa', moveCount: 19 },
      { id: 'sho-hayate', name: 'Sho Hayate', moveCount: 11 }
    ],
...
rosterCount: 8,
    ...
    systemMechanics: [
        ...
        characters: [
      { id: 'joe', name: 'Joe', moveCount: 12 },
      { id: 'kurosawa', name: 'Kurosawa', moveCount: 12 },
      { id: 'lisa', name: 'Lisa', moveCount: 12 },
      { id: 'nagi', name: 'Nagi', moveCount: 14 },
      { id: 'redeye', name: 'Redeye', moveCount: 3 },
      { id: 'tommy', name: 'Tommy', moveCount: 12 },
      { id: 'yusaku', name: 'Yusaku', moveCount: 4 },
      { id: 'zaimoku', name: 'Zaimoku', moveCount: 4 }
    ],
...
rosterCount: 12,
    ...
    characters: [
      { id: 'spider-man', name: 'Spider Man', moveCount: 17 },
      { id: 'captain-america', name: 'Captain America', moveCount: 10 },
      { id: 'iron-man', name: 'Iron Man', moveCount: 12 },
      { id: 'hulk', name: 'Hulk', moveCount: 8 },
      { id: 'wolverine', name: 'Wolverine', moveCount: 12 },
      { id: 'psylocke', name: 'Psylocke', moveCount: 14 },
      { id: 'magneto', name: 'Magneto', moveCount: 13 },
      { id: 'juggernaut', name: 'Juggernaut', moveCount: 12 },
      { id: 'blackheart', name: 'Blackheart', moveCount: 0 },
      { id: 'shuma-gorath', name: 'Shuma Gorath', moveCount: 17 },
      { id: 'dr-doom', name: 'Dr Doom', moveCount: 0 },
      { id: 'thanos', name: 'Thanos', moveCount: 14 },
...

  {
    ...
    tags: ["2D", "3v3", "Vs."],
    characters: [
      { id: 'cyclops', name: 'Cyclops', moveCount: 13 },
      { id: 'wolverine', name: 'Wolverine', moveCount: 13 },
      { id: 'spider-man', name: 'Spider Man', moveCount: 13 },
      { id: 'captain-america', name: 'Captain America', moveCount: 13 },
      { id: 'hulk', name: 'Hulk', moveCount: 5 },
      { id: 'blackheart', name: 'Blackheart', moveCount: 0 },
      { id: 'shuma-gorath', name: 'Shuma Gorath', moveCount: 12 },
      { id: 'omega-red', name: 'Omega Red', moveCount: 12 },
      { id: 'ryu', name: 'Ryu', moveCount: 15 },
      { id: 'ken', name: 'Ken', moveCount: 14 },
      { id: 'chun-li', name: 'Chun Li', moveCount: 15 },
      { id: 'dhalsim', name: 'Dhalsim', moveCount: 14 },
      { id: 'zangief', name: 'Zangief', moveCount: 6 },
      { id: 'mbison', name: 'Mbison', moveCount: 0 },
      { id: 'sakura', name: 'Sakura', moveCount: 14 },
      { id: 'dan', name: 'Dan', moveCount: 16 },
      { id: 'akuma', name: 'Akuma', moveCount: 17 },
...
rosterCount: 39,
    ...
    characters: [
      ...
      { id: 'ryu', name: 'Ryu', moveCount: 14 },
      { id: 'ken', name: 'Ken', moveCount: 13 },
      { id: 'chun-li', name: 'Chun Li', moveCount: 45 },
      { id: 'guile', name: 'Guile', moveCount: 23 },
      { id: 'zangief', name: 'Zangief', moveCount: 25 },
      { id: 'dhalsim', name: 'Dhalsim', moveCount: 23 },
      { id: 'mbison', name: 'Mbison', moveCount: 0 },
      { id: 'akuma', name: 'Akuma', moveCount: 19 },
      { id: 'charlie', name: 'Charlie', moveCount: 0 },
      { id: 'sakura', name: 'Sakura', moveCount: 19 },
      { id: 'dan', name: 'Dan', moveCount: 15 },
      { id: 'cammy', name: 'Cammy', moveCount: 0 },
      { id: 'morrigan', name: 'Morrigan', moveCount: 16 },
      { id: 'anakaris', name: 'Anakaris', moveCount: 0 },
      { id: 'b-b-hood', name: 'B B Hood', moveCount: 0 },
      { id: 'felicia', name: 'Felicia', moveCount: 33 },
      { id: 'megaman', name: 'Megaman', moveCount: 0 },
      { id: 'roll', name: 'Roll', moveCount: 0 },
      { id: 'tron-bonne', name: 'Tron Bonne', moveCount: 17 },
      { id: 'servbot', name: 'Servbot', moveCount: 15 },
      ...
      { id: 'cyclops', name: 'Cyclops', moveCount: 14 },
      { id: 'wolverine', name: 'Wolverine', moveCount: 15 },
      { id: 'wolverine-bone', name: 'Wolverine Bone', moveCount: 0 },
      { id: 'storm', name: 'Storm', moveCount: 10 },
      { id: 'rogue', name: 'Rogue', moveCount: 0 },
      { id: 'gambit', name: 'Gambit', moveCount: 17 },
      { id: 'cable', name: 'Cable', moveCount: 15 },
      { id: 'marrow', name: 'Marrow', moveCount: 0 },
      { id: 'psylocke', name: 'Psylocke', moveCount: 14 },
      { id: 'colossus', name: 'Colossus', moveCount: 0 },
      { id: 'iceman', name: 'Iceman', moveCount: 0 },
      { id: 'silver-samurai', name: 'Silver Samurai', moveCount: 16 },
      { id: 'omega-red', name: 'Omega Red', moveCount: 0 },
      { id: 'spiral', name: 'Spiral', moveCount: 0 },
      { id: 'sentinel', name: 'Sentinel', moveCount: 15 },
      { id: 'magneto', name: 'Magneto', moveCount: 15 },
      { id: 'juggernaut', name: 'Juggernaut', moveCount: 22 },
      { id: 'sabretooth', name: 'Sabretooth', moveCount: 0 },
      { id: 'spider-man', name: 'Spider Man', moveCount: 19 },
      { id: 'venom', name: 'Venom', moveCount: 12 },
      { id: 'captain-america', name: 'Captain America', moveCount: 13 },
      { id: 'iron-man', name: 'Iron Man', moveCount: 15 },
      { id: 'war-machine', name: 'War Machine', moveCount: 21 },
      { id: 'hulk', name: 'Hulk', moveCount: 14 },
      { id: 'dr-doom', name: 'Dr Doom', moveCount: 0 },
      { id: 'thanos', name: 'Thanos', moveCount: 12 },
      { id: 'shuma-gorath', name: 'Shuma Gorath', moveCount: 18 },
      { id: 'blackheart', name: 'Blackheart', moveCount: 0 }
    ],
...
rosterCount: 14,
    ...
    characters: [
      { id: 'ryu', name: 'Ryu', moveCount: 33 },
      { id: 'chun-li', name: 'Chun Li', moveCount: 21 },
      { id: 'zangief', name: 'Zangief', moveCount: 44 },
      { id: 'morrigan', name: 'Morrigan', moveCount: 11 },
      { id: 'captain-commando', name: 'Captain Commando', moveCount: 0 },
      { id: 'megaman', name: 'Megaman', moveCount: 0 },
      { id: 'strider', name: 'Strider', moveCount: 0 },
      { id: 'spider-man', name: 'Spider Man', moveCount: 18 },
      { id: 'captain-america', name: 'Captain America', moveCount: 11 },
      { id: 'hulk', name: 'Hulk', moveCount: 5 },
      { id: 'wolverine', name: 'Wolverine', moveCount: 15 },
      { id: 'venom', name: 'Venom', moveCount: 14 },
      { id: 'gambit', name: 'Gambit', moveCount: 14 },
      { id: 'war-machine', name: 'War Machine', moveCount: 11 },
      { id: 'roll', name: 'Roll', moveCount: 0 },
...
rosterCount: 24,
    ...
    characters: [
      { id: 'black-panther', name: 'Black Panther', moveCount: 12 },
      { id: 'captain-america', name: 'Captain America', moveCount: 10 },
      { id: 'captain-marvel', name: 'Captain Marvel', moveCount: 12 },
      { id: 'chun-li', name: 'Chun-Li', moveCount: 10 },
      { id: 'dante', name: 'Dante', moveCount: 13 },
      { id: 'doctor-strange', name: 'Doctor Strange', moveCount: 10 },
      { id: 'gamora', name: 'Gamora', moveCount: 10 },
      { id: 'ghost-rider', name: 'Ghost Rider', moveCount: 10 },
      { id: 'hulk', name: 'Hulk', moveCount: 10 },
      { id: 'iron-man', name: 'Iron Man', moveCount: 13 },
      { id: 'jedah', name: 'Jedah', moveCount: 10 },
      { id: 'mega-man-x', name: 'Mega Man X', moveCount: 11 },
      { id: 'morrigan', name: 'Morrigan', moveCount: 10 },
      { id: 'nemesis', name: 'Nemesis', moveCount: 10 },
      { id: 'nova', name: 'Nova', moveCount: 10 },
      { id: 'rocket-raccoon', name: 'Rocket Raccoon', moveCount: 10 },
      { id: 'ryu', name: 'Ryu', moveCount: 13 },
      { id: 'spider-man', name: 'Spider-Man', moveCount: 12 },
      { id: 'strider-hiryu', name: 'Strider Hiryu', moveCount: 10 },
      { id: 'thanos', name: 'Thanos', moveCount: 12 },
      { id: 'thor', name: 'Thor', moveCount: 10 },
      { id: 'ultron', name: 'Ultron', moveCount: 10 },
      { id: 'zero', name: 'Zero', moveCount: 10 }
    ],
...

  {
    ...
    systemMechanics: [
        ...
        characters: [
      { id: 'keith-wayne', name: 'Keith Wayne', moveCount: 13 },
      { id: 'annie-hamilton', name: 'Annie Hamilton', moveCount: 6 },
      { id: 'otane-goketsuji', name: 'Otane Goketsuji', moveCount: 11 },
      { id: 'oume-goketsuji', name: 'Oume Goketsuji', moveCount: 14 },
      { id: 'kanji-kokuin', name: 'Kanji Kokuin', moveCount: 14 },
      { id: 'chok', name: 'Chok', moveCount: 2 },
      { id: 'saizo-hattori', name: 'Saizo Hattori', moveCount: 14 },
      { id: 'white-buffalo', name: 'White Buffalo', moveCount: 14 },
      { id: 'buntaro-kudo', name: 'Buntaro Kudo', moveCount: 21 },
      { id: 'shintaro-kudo', name: 'Shintaro Kudo', moveCount: 47 },
      { id: 'hikaru-jomon', name: 'Hikaru Jomon', moveCount: 14 },
      { id: 'reiji-oyama', name: 'Reiji Oyama', moveCount: 6 },
      { id: 'poochy', name: 'Poochy', moveCount: 17 },
      { id: 'clara-hananokoji', name: 'Clara Hananokoji', moveCount: 6 },
      { id: 'kinta-kokuin', name: 'Kinta Kokuin', moveCount: 17 },
      { id: 'elias-patrick', name: 'Elias Patrick', moveCount: 15 },
      { id: 'princess-sissy', name: 'Princess Sissy', moveCount: 13 }
    ],
...

  {
    ...
    systemMechanics: [
        ...
        characters: [
      { id: 'baraka', name: 'Baraka', moveCount: 11 },
      { id: 'cyrax', name: 'Cyrax', moveCount: 13 },
      { id: 'ermac', name: 'Ermac', moveCount: 11 },
      { id: 'freddy-krueger', name: 'Freddy Krueger', moveCount: 9 },
      { id: 'jade', name: 'Jade', moveCount: 9 },
      { id: 'jax', name: 'Jax', moveCount: 11 },
      { id: 'johnny-cage', name: 'Johnny Cage', moveCount: 11 },
      { id: 'kabal', name: 'Kabal', moveCount: 9 },
      { id: 'kano', name: 'Kano', moveCount: 11 },
      { id: 'kitana', name: 'Kitana', moveCount: 11 },
      { id: 'kratos', name: 'Kratos', moveCount: 11 },
      { id: 'kung-lao', name: 'Kung Lao', moveCount: 11 },
      { id: 'liu-kang', name: 'Liu Kang', moveCount: 11 },
      { id: 'mileena', name: 'Mileena', moveCount: 10 },
      { id: 'nightwolf', name: 'Nightwolf', moveCount: 11 },
      { id: 'noob-saibot', name: 'Noob Saibot', moveCount: 12 },
      { id: 'quan-chi', name: 'Quan Chi', moveCount: 10 },
      { id: 'raiden', name: 'Raiden', moveCount: 10 },
      { id: 'rain', name: 'Rain', moveCount: 11 },
      { id: 'reptile', name: 'Reptile', moveCount: 12 },
      { id: 'scorpion', name: 'Scorpion', moveCount: 14 },
      { id: 'sektor', name: 'Sektor', moveCount: 10 },
      { id: 'shang-tsung', name: 'Shang Tsung', moveCount: 10 },
      { id: 'sheeva', name: 'Sheeva', moveCount: 10 },
      { id: 'sindel', name: 'Sindel', moveCount: 12 },
      { id: 'skarlet', name: 'Skarlet', moveCount: 11 },
      { id: 'smoke', name: 'Smoke', moveCount: 11 },
      { id: 'sonya-blade', name: 'Sonya Blade', moveCount: 11 },
      { id: 'stryker', name: 'Stryker', moveCount: 11 },
      { id: 'sub-zero', name: 'Sub-Zero', moveCount: 13 }
    ],
...

  {
    ...
    characters: [
      { id: 'ashrah', name: 'Ashrah', moveCount: 40 },
      { id: 'baraka', name: 'Baraka', moveCount: 40 },
      { id: 'geras', name: 'Geras', moveCount: 37 },
      { id: 'havik', name: 'Havik', moveCount: 39 },
      { id: 'johnny-cage', name: 'Johnny Cage', moveCount: 40 },
      { id: 'kenshi', name: 'Kenshi', moveCount: 36 },
      { id: 'kitana', name: 'Kitana', moveCount: 39 },
      { id: 'kung-lao', name: 'Kung Lao', moveCount: 38 },
      { id: 'li-mei', name: 'Li Mei', moveCount: 37 },
      { id: 'liu-kang', name: 'Liu Kang', moveCount: 38 },
      { id: 'mileena', name: 'Mileena', moveCount: 38 },
      { id: 'nitara', name: 'Nitara', moveCount: 37 },
      { id: 'omni-man', name: 'Omni-Man', moveCount: 32 },
      { id: 'peacemaker', name: 'Peacemaker', moveCount: 34 },
      { id: 'quan-chi', name: 'Quan Chi', moveCount: 33 },
      { id: 'raiden', name: 'Raiden', moveCount: 38 },
      { id: 'rain', name: 'Rain', moveCount: 34 },
      { id: 'reiko', name: 'Reiko', moveCount: 35 },
      { id: 'reptile', name: 'Reptile', moveCount: 36 },
      { id: 'scorpion', name: 'Scorpion', moveCount: 44 },
      { id: 'shang-tsung', name: 'Shang Tsung', moveCount: 45 },
      { id: 'sindel', name: 'Sindel', moveCount: 37 },
      { id: 'smoke', name: 'Smoke', moveCount: 35 },
      { id: 'sub-zero', name: 'Sub-Zero', moveCount: 39 },
      { id: 'tanya', name: 'Tanya', moveCount: 38 },
      { id: 'general-shao', name: 'General Shao', moveCount: 34 },
      { id: 'ermac', name: 'Ermac', moveCount: 33 },
      { id: 'homelander', name: 'Homelander', moveCount: 32 },
      { id: 'takeda', name: 'Takeda', moveCount: 32 },
      { id: 'cyrax', name: 'Cyrax', moveCount: 33 },
      { id: 'sektor', name: 'Sektor', moveCount: 33 },
      { id: 'noob-saibot', name: 'Noob Saibot', moveCount: 33 },
      { id: 'ghostface', name: 'Ghostface', moveCount: 36 },
      { id: 'conan', name: 'Conan', moveCount: 34 },
      { id: 't-1000', name: 'T-1000', moveCount: 31 }
    ],
...

  {
    ...
    systemMechanics: [
        ...
        characters: [
      { id: 'goro', name: 'Goro', moveCount: 5 },
      { id: 'johnny-cage', name: 'Johnny Cage', moveCount: 8 },
      { id: 'kano', name: 'Kano', moveCount: 7 },
      { id: 'liu-kang', name: 'Liu Kang', moveCount: 7 },
      { id: 'raiden', name: 'Raiden', moveCount: 8 },
      { id: 'reptile', name: 'Reptile', moveCount: 7 },
      { id: 'scorpion', name: 'Scorpion', moveCount: 7 },
      { id: 'shang-tsung', name: 'Shang Tsung', moveCount: 9 },
      { id: 'sonya-blade', name: 'Sonya Blade', moveCount: 8 },
      { id: 'sub-zero', name: 'Sub-Zero', moveCount: 7 }
    ],
...
rosterCount: 14,
    ...
    systemMechanics: [
        ...
        characters: [
      { id: 'baraka', name: 'Baraka', moveCount: 10 },
      { id: 'jax', name: 'Jax', moveCount: 11 },
      { id: 'johnny-cage', name: 'Johnny Cage', moveCount: 11 },
      { id: 'kitana', name: 'Kitana', moveCount: 10 },
      { id: 'kung-lao', name: 'Kung Lao', moveCount: 11 },
      { id: 'liu-kang', name: 'Liu Kang', moveCount: 10 },
      { id: 'mileena', name: 'Mileena', moveCount: 9 },
      { id: 'noob-saibot', name: 'Noob Saibot', moveCount: 9 },
      { id: 'raiden', name: 'Raiden', moveCount: 10 },
      { id: 'reptile', name: 'Reptile', moveCount: 10 },
      { id: 'scorpion', name: 'Scorpion', moveCount: 14 },
      { id: 'shang-tsung', name: 'Shang Tsung', moveCount: 9 },
      { id: 'smoke', name: 'Smoke', moveCount: 4 },
      { id: 'sub-zero', name: 'Sub-Zero', moveCount: 13 }
    ],
...
rosterCount: 32,
    ...
    systemMechanics: [
        ...
        characters: [
      { id: 'alien', name: 'Alien', moveCount: 114 },
      { id: 'cassie-cage', name: 'Cassie Cage', moveCount: 81 },
      { id: 'ermac', name: 'Ermac', moveCount: 134 },
      { id: 'erron-black', name: 'Erron Black', moveCount: 103 },
      { id: 'ferratorr', name: 'Ferra Torr', moveCount: 6 },
      { id: 'goro', name: 'Goro', moveCount: 84 },
      { id: 'jacqui-briggs', name: 'Jacqui Briggs', moveCount: 95 },
      { id: 'jason-voorhees', name: 'Jason Voorhees', moveCount: 95 },
      { id: 'jax', name: 'Jax', moveCount: 6 },
      { id: 'johnny-cage', name: 'Johnny Cage', moveCount: 95 },
      { id: 'kano', name: 'Kano', moveCount: 95 },
      { id: 'kenshi', name: 'Kenshi', moveCount: 104 },
      { id: 'kitana', name: 'Kitana', moveCount: 96 },
      { id: 'kotal-kahn', name: 'Kotal Kahn', moveCount: 82 },
      { id: 'kung-jin', name: 'Kung Jin', moveCount: 106 },
      { id: 'kung-lao', name: 'Kung Lao', moveCount: 98 },
      { id: 'leatherface', name: 'Leatherface', moveCount: 94 },
      { id: 'liu-kang', name: 'Liu Kang', moveCount: 112 },
      { id: 'mileena', name: 'Mileena', moveCount: 106 },
      { id: 'predator', name: 'Predator', moveCount: 109 },
      { id: 'quan-chi', name: 'Quan Chi', moveCount: 79 },
      { id: 'raiden', name: 'Raiden', moveCount: 105 },
      { id: 'reptile', name: 'Reptile', moveCount: 88 },
      { id: 'scorpion', name: 'Scorpion', moveCount: 86 },
      { id: 'shinnok', name: 'Shinnok', moveCount: 89 },
      { id: 'sonya-blade', name: 'Sonya Blade', moveCount: 102 },
      { id: 'sub-zero', name: 'Sub-Zero', moveCount: 76 },
      { id: 'takeda-takahashi', name: 'Takeda Takahashi', moveCount: 123 },
      { id: 'tanya', name: 'Tanya', moveCount: 111 },
      { id: 'tremor', name: 'Tremor', moveCount: 187 }
    ],
...
rosterCount: 21,
    ...
    systemMechanics: [
        ...
        characters: [
      { id: 'ashrah', name: 'Ashrah', moveCount: 10 },
      { id: 'baraka', name: 'Baraka', moveCount: 6 },
      { id: 'bo-rai-cho', name: 'Bo\' Rai Cho', moveCount: 9 },
      { id: 'ermac', name: 'Ermac', moveCount: 11 },
      { id: 'havik', name: 'Havik', moveCount: 10 },
      { id: 'hotaru', name: 'Hotaru', moveCount: 8 },
      { id: 'jade', name: 'Jade', moveCount: 12 },
      { id: 'kabal', name: 'Kabal', moveCount: 11 },
      { id: 'kira', name: 'Kira', moveCount: 8 },
      { id: 'kobra', name: 'Kobra', moveCount: 9 },
      { id: 'li-mei', name: 'Li Mei', moveCount: 9 },
      { id: 'liu-kang', name: 'Liu Kang', moveCount: 9 },
      { id: 'mileena', name: 'Mileena', moveCount: 9 },
      { id: 'nightwolf', name: 'Nightwolf', moveCount: 8 },
      { id: 'noob-smoke', name: 'Noob-Smoke', moveCount: 13 },
      { id: 'raiden', name: 'Raiden', moveCount: 12 },
      { id: 'scorpion', name: 'Scorpion', moveCount: 14 },
      { id: 'shujinko', name: 'Shujinko', moveCount: 11 },
      { id: 'sindel', name: 'Sindel', moveCount: 8 },
      { id: 'sub-zero', name: 'Sub-Zero', moveCount: 13 },
      { id: 'tanya', name: 'Tanya', moveCount: 12 }
    ],
...
rosterCount: 14,
    ...
    characters: [
      { id: 'demitri', name: 'Demitri', moveCount: 18 },
      { id: 'morrigan', name: 'Morrigan', moveCount: 40 },
      { id: 'jon-talbain', name: 'Jon Talbain', moveCount: 7 },
      { id: 'lord-raptor', name: 'Lord Raptor', moveCount: 7 },
      { id: 'victor', name: 'Victor', moveCount: 8 },
      { id: 'rikuo', name: 'Rikuo', moveCount: 8 },
      { id: 'sasquatch', name: 'Sasquatch', moveCount: 29 },
      { id: 'anakaris', name: 'Anakaris', moveCount: 23 },
      { id: 'bishamon', name: 'Bishamon', moveCount: 8 },
      { id: 'felicia', name: 'Felicia', moveCount: 8 },
      { id: 'hutzil', name: 'Hutzil', moveCount: 0 },
      { id: 'pyron', name: 'Pyron', moveCount: 22 },
      { id: 'donovan', name: 'Donovan', moveCount: 227 },
      { id: 'hsien-ko', name: 'Hsien Ko', moveCount: 55 }
    ],
...

  {
    ...
    tags: ["2D"],
    characters: [
      { id: 'goemon', name: 'Goemon', moveCount: 27 },
      { id: 'houoh', name: 'Houoh', moveCount: 25 },
      { id: 'kamui', name: 'Kamui', moveCount: 30 },
      { id: 'karasu', name: 'Karasu', moveCount: 28 },
      { id: 'kasumi', name: 'Kasumi', moveCount: 27 },
      { id: 'natsume', name: 'Natsume', moveCount: 27 },
      { id: 'nobunaga', name: 'Nobunaga', moveCount: 25 },
      { id: 'raiga', name: 'Raiga', moveCount: 26 },
      { id: 'ranmaru', name: 'Ranmaru', moveCount: 20 },
      { id: 'tenho', name: 'Tenho', moveCount: 31 }
    ],
...
rosterCount: 20,
    ...
    characters: [
      { id: 'adachi', name: 'Adachi', moveCount: 6 },
      { id: 'akihiko', name: 'Akihiko', moveCount: 5 },
      { id: 'chie', name: 'Chie', moveCount: 5 },
      { id: 'elizabeth', name: 'Elizabeth', moveCount: 2 },
      { id: 'junpei', name: 'Junpei', moveCount: 5 },
      { id: 'kanji', name: 'Kanji', moveCount: 5 },
      { id: 'ken', name: 'Ken', moveCount: 4 },
      { id: 'koromaru', name: 'Koromaru', moveCount: 4 },
      { id: 'labrys', name: 'Labrys', moveCount: 2 },
      { id: 'margaret', name: 'Margaret', moveCount: 2 },
      { id: 'marie', name: 'Marie', moveCount: 5 },
      { id: 'mitsuru', name: 'Mitsuru', moveCount: 5 },
      { id: 'naoto', name: 'Naoto', moveCount: 5 },
      { id: 'rise', name: 'Rise', moveCount: 5 },
      { id: 'sho', name: 'Sho', moveCount: 5 },
      { id: 'teddie', name: 'Teddie', moveCount: 2 },
      { id: 'tohru', name: 'Tohru', moveCount: 6 },
      { id: 'yukari', name: 'Yukari', moveCount: 5 },
      { id: 'yukiko', name: 'Yukiko', moveCount: 5 },
      { id: 'yu', name: 'Yu', moveCount: 5 }
    ],
...
rosterCount: 13,
    ...
    tags: ["2D"],
    characters: [
        { id: 'hayato', name: 'Hayato', moveCount: 5 },
        { id: 'june', name: 'June', moveCount: 8 },
        { id: 'saturn', name: 'Saturn', moveCount: 9 },
        { id: 'gamof', name: 'Gamof', moveCount: 7 },
        { id: 'vector', name: 'Vector', moveCount: 19 },
        { id: 'gore', name: 'Gore', moveCount: 5 },
        { id: 'blood', name: 'Blood', moveCount: 5 },
        { id: 'shaker', name: 'Shaker', moveCount: 5 },
        { id: 'zelkin', name: 'Zelkin', moveCount: 9 },
        { id: 'bilstein', name: 'Bilstein', moveCount: 22 },
        { id: 'rain', name: 'Rain', moveCount: 9 },
        { id: 'byakko', name: 'Byakko', moveCount: 5 },
        { id: 'gantetsu', name: 'Gantetsu', moveCount: 5 },
        { id: 'claire', name: 'Claire', moveCount: 5 },
        { id: 'ele', name: 'Ele', moveCount: 9 },
        { id: 'raiga', name: 'Raiga', moveCount: 5 },
        { id: 'omega', name: 'Omega', moveCount: 5 },
        { id: 'gori', name: 'Gori', moveCount: 5 },
        { id: 'luka', name: 'Luka', moveCount: 5 },
        { id: 'luca', name: 'Luca', moveCount: 34 }
      ],
...

  {
    ...
    tags: ["2D"],
    characters: [
      { id: 'ryu', name: 'Ryu', moveCount: 21 },
      { id: 'ken', name: 'Ken', moveCount: 13 },
      { id: 'chun-li', name: 'Chun Li', moveCount: 18 },
      { id: 'zangief', name: 'Zangief', moveCount: 18 },
      { id: 'sakura', name: 'Sakura', moveCount: 13 },
      { id: 'ibuki', name: 'Ibuki', moveCount: 18 },
      { id: 'morrigan', name: 'Morrigan', moveCount: 18 },
      { id: 'felicia', name: 'Felicia', moveCount: 21 },
      { id: 'hsien-ko', name: 'Hsien Ko', moveCount: 18 },
      { id: 'tessa', name: 'Tessa', moveCount: 18 },
      { id: 'akuma', name: 'Akuma', moveCount: 18 },
      { id: 'dan', name: 'Dan', moveCount: 21 }
    ],
...
rosterCount: 7,
    ...
    systemMechanics: [
        ...
        characters: [
      { id: 'armadon', name: 'Armadon', moveCount: 8 },
      { id: 'blizzard', name: 'Blizzard', moveCount: 8 },
      { id: 'chaos', name: 'Chaos', moveCount: 8 },
      { id: 'diablo', name: 'Diablo', moveCount: 8 },
      { id: 'sauron', name: 'Sauron', moveCount: 8 },
      { id: 'talon', name: 'Talon', moveCount: 8 },
      { id: 'vertigo', name: 'Vertigo', moveCount: 8 }
    ],
...
rosterCount: 7,
    ...
    systemMechanics: [
        ...
        characters: [
      { id: 'arik', name: 'Arik', moveCount: 7 },
      { id: 'malys', name: 'Malys', moveCount: 10 },
      { id: 'shank', name: 'Shank', moveCount: 10 },
      { id: 'sinjin', name: 'Sinjin', moveCount: 10 },
      { id: 'xiao', name: 'Xiao', moveCount: 8 }
    ],
...

  {
    ...
    tags: ["2D"],
    characters: [
        { id: 'batsu', name: 'Batsu', moveCount: 32 },
        { id: 'hinata', name: 'Hinata', moveCount: 30 },
        { id: 'kyosuke', name: 'Kyosuke', moveCount: 10 },
        { id: 'hayato', name: 'Hayato', moveCount: 5 },
        { id: 'shoma', name: 'Shoma', moveCount: 36 },
        { id: 'natsu', name: 'Natsu', moveCount: 30 },
        { id: 'roberto', name: 'Roberto', moveCount: 10 },
        { id: 'akira', name: 'Akira', moveCount: 36 },
        { id: 'edge', name: 'Edge', moveCount: 31 },
        { id: 'gan', name: 'Gan', moveCount: 34 },
        { id: 'zaki', name: 'Zaki', moveCount: 33 },
        { id: 'yurika', name: 'Yurika', moveCount: 33 },
        { id: 'kurow', name: 'Kurow', moveCount: 5 },
        { id: 'hideo', name: 'Hideo', moveCount: 5 },
        { id: 'kyoko', name: 'Kyoko', moveCount: 5 },
        { id: 'bowman', name: 'Bowman', moveCount: 5 },
        { id: 'ran', name: 'Ran', moveCount: 10 },
        { id: 'chairman', name: 'Chairman', moveCount: 5 },
        { id: 'roy', name: 'Roy', moveCount: 33 },
        { id: 'tiffany', name: 'Tiffany', moveCount: 30 },
        { id: 'momo', name: 'Momo', moveCount: 33 },
        { id: 'boman', name: 'Boman', moveCount: 5 },
        { id: 'natsu', name: 'Natsu', moveCount: 30 },
        { id: 'roberto', name: 'Roberto', moveCount: 10 }
      ],
...
rosterCount: 10,
    ...
    systemMechanics: [
        ...
        characters: [
      { id: 'brad', name: 'Brad', moveCount: 10 },
      { id: 'burn', name: 'Burn', moveCount: 11 },
      { id: 'emilio', name: 'Emilio', moveCount: 16 },
      { id: 'gates', name: 'Gates', moveCount: 13 },
      { id: 'genma', name: 'Genma', moveCount: 10 },
      { id: 'keith', name: 'Keith', moveCount: 14 },
      { id: 'richard', name: 'Richard', moveCount: 12 },
      { id: 'rokkan', name: 'Rokkan', moveCount: 13 },
      { id: 'sonia', name: 'Sonia', moveCount: 10 },
      { id: 'wendy', name: 'Wendy', moveCount: 15 }
    ],
...
rosterCount: 13,
    ...
    systemMechanics: [
        ...
        characters: [
      { id: 'burn', name: 'Burn', moveCount: 15 },
      { id: 'carlo', name: 'Carlo', moveCount: 14 },
      { id: 'emilio', name: 'Emilio', moveCount: 16 },
      { id: 'gantz', name: 'Gantz', moveCount: 10 },
      { id: 'genma', name: 'Genma', moveCount: 13 },
      { id: 'keith', name: 'Keith', moveCount: 14 },
      { id: 'might', name: 'Might', moveCount: 13 },
      { id: 'patricia', name: 'Patricia', moveCount: 15 },
      { id: 'regina', name: 'Regina', moveCount: 14 },
      { id: 'rokkan', name: 'Rokkan', moveCount: 13 },
      { id: 'setsuna', name: 'Setsuna', moveCount: 15 },
      { id: 'sonia', name: 'Sonia', moveCount: 15 },
      { id: 'wendy', name: 'Wendy', moveCount: 15 }
    ],
...
rosterCount: 13,
    ...
    systemMechanics: [
        ...
        characters: [
      { id: 'abubo', name: 'Abubo', moveCount: 11 },
      { id: 'alice', name: 'Alice', moveCount: 11 },
      { id: 'billy', name: 'Billy', moveCount: 11 },
      { id: 'cass', name: 'Cass', moveCount: 11 },
      { id: 'elias', name: 'Elias', moveCount: 11 },
      { id: 'kang', name: 'Kang', moveCount: 11 },
      { id: 'lynn', name: 'Lynn', moveCount: 11 },
      { id: 'mr-jones', name: 'Mr. Jones', moveCount: 8 },
      { id: 'oni', name: 'Oni', moveCount: 11 },
      { id: 'pepe', name: 'Pepe', moveCount: 2 },
      { id: 'pupa', name: 'Pupa', moveCount: 11 },
      { id: 'radel', name: 'Radel', moveCount: 7 },
      { id: 'sonia', name: 'Sonia', moveCount: 18 }
    ],
...
rosterCount: 8,
    ...
    systemMechanics: [
        ...
        characters: [
      { id: 'benten', name: 'Benten', moveCount: 12 },
      { id: 'chi-chi', name: 'Chi-Chi', moveCount: 12 },
      { id: 'ebi', name: 'Ebi', moveCount: 12 },
      { id: 'gozumaru', name: 'Gozumaru', moveCount: 12 },
      { id: 'igret', name: 'Igret', moveCount: 12 },
      { id: 'susano', name: 'Susano', moveCount: 12 },
      { id: 'syuten-dozi', name: 'Syuten-Dozi', moveCount: 12 },
      { id: 'zen', name: 'Zen', moveCount: 14 }
    ],
...
rosterCount: 16,
    ...
    characters: [
      { id: 'andy-bogard', name: 'Andy Bogard', moveCount: 11 },
      { id: 'billy-kane', name: 'Billy Kane', moveCount: 12 },
      { id: 'blue-mary', name: 'Blue Mary', moveCount: 19 },
      { id: 'bob-wilson', name: 'Bob Wilson', moveCount: 13 },
      { id: 'chonrei', name: 'Chonrei', moveCount: 14 },
      { id: 'chonshu', name: 'Chonshu', moveCount: 13 },
      { id: 'duck-king', name: 'Duck King', moveCount: 13 },
      { id: 'franco-bash', name: 'Franco Bash', moveCount: 13 },
      { id: 'geese-howard', name: 'Geese Howard', moveCount: 16 },
      { id: 'hon-fu', name: 'Hon-Fu', moveCount: 5 },
      { id: 'joe-higashi', name: 'Joe Higashi', moveCount: 5 },
      { id: 'kim-kaphwan', name: 'Kim Kaphwan', moveCount: 8 },
      { id: 'mai-shiranui', name: 'Mai Shiranui', moveCount: 12 },
      { id: 'ryuji-yamazaki', name: 'Ryuji Yamazaki', moveCount: 11 },
      { id: 'sokaku-mochizuki', name: 'Sokaku Mochizuki', moveCount: 20 },
      { id: 'terry-bogard', name: 'Terry Bogard', moveCount: 6 }
    ],
...
rosterCount: 19,
    ...
    characters: [
      { id: 'andy-bogard', name: 'Andy Bogard', moveCount: 12 },
      { id: 'billy-kane', name: 'Billy Kane', moveCount: 10 },
      { id: 'blue-mary', name: 'Blue Mary', moveCount: 16 },
      { id: 'bob-wilson', name: 'Bob Wilson', moveCount: 15 },
      { id: 'chonrei', name: 'Chonrei', moveCount: 13 },
      { id: 'chonshu', name: 'Chonshu', moveCount: 14 },
      { id: 'duck-king', name: 'Duck King', moveCount: 15 },
      { id: 'franco-bash', name: 'Franco Bash', moveCount: 9 },
      { id: 'geese-howard', name: 'Geese Howard', moveCount: 12 },
      { id: 'hon-fu', name: 'Hon-Fu', moveCount: 5 },
      { id: 'joe-higashi', name: 'Joe Higashi', moveCount: 11 },
      { id: 'kim-kaphwan', name: 'Kim Kaphwan', moveCount: 9 },
      { id: 'li-xiangfei', name: 'Li Xiangfei', moveCount: 5 },
      { id: 'mai-shiranui', name: 'Mai Shiranui', moveCount: 10 },
      { id: 'rick-strowd', name: 'Rick Strowd', moveCount: 4 },
      { id: 'ryuji-yamazaki', name: 'Ryuji Yamazaki', moveCount: 20 },
      { id: 'sokaku-mochizuki', name: 'Sokaku Mochizuki', moveCount: 19 },
      { id: 'terry-bogard', name: 'Terry Bogard', moveCount: 12 },
      { id: 'tung-fu-rue', name: 'Tung Fu Rue', moveCount: 9 }
    ],
...
rosterCount: 19,
    ...
    characters: [
      { id: 'andy-bogard', name: 'Andy Bogard', moveCount: 11 },
      { id: 'billy-kane', name: 'Billy Kane', moveCount: 10 },
      { id: 'blue-mary', name: 'Blue Mary', moveCount: 12 },
      { id: 'bob-wilson', name: 'Bob Wilson', moveCount: 15 },
      { id: 'chonrei', name: 'Chonrei', moveCount: 5 },
      { id: 'chonshu', name: 'Chonshu', moveCount: 13 },
      { id: 'duck-king', name: 'Duck King', moveCount: 14 },
      { id: 'franco-bash', name: 'Franco Bash', moveCount: 9 },
      { id: 'geese-howard', name: 'Geese Howard', moveCount: 12 },
      { id: 'hon-fu', name: 'Hon-Fu', moveCount: 5 },
      { id: 'joe-higashi', name: 'Joe Higashi', moveCount: 11 },
      { id: 'kim-kaphwan', name: 'Kim Kaphwan', moveCount: 9 },
      { id: 'laurence-blood', name: 'Laurence Blood', moveCount: 12 },
      { id: 'mai-shiranui', name: 'Mai Shiranui', moveCount: 11 },
      { id: 'ryuji-yamazaki', name: 'Ryuji Yamazaki', moveCount: 14 },
      { id: 'sokaku-mochizuki', name: 'Sokaku Mochizuki', moveCount: 19 },
      { id: 'terry-bogard', name: 'Terry Bogard', moveCount: 12 },
      { id: 'tung-fu-rue', name: 'Tung Fu Rue', moveCount: 7 },
      { id: 'wolfgang-krauser', name: 'Wolfgang Krauser', moveCount: 5 }
    ],
...
rosterCount: 25,
    ...
    characters: [
      { id: 'baiken', name: 'Baiken', moveCount: 5 },
      { id: 'basara', name: 'Basara', moveCount: 8 },
      { id: 'charlotte', name: 'Charlotte', moveCount: 119 },
      { id: 'darli-dagger', name: 'Darli Dagger', moveCount: 7 },
      { id: 'earthquake', name: 'Earthquake', moveCount: 5 },
      { id: 'galford', name: 'Galford', moveCount: 8 },
      { id: 'genjuro', name: 'Genjuro', moveCount: 4 },
      { id: 'gongsun-li', name: 'Gongsun Li', moveCount: 4 },
      { id: 'hanzo', name: 'Hanzo', moveCount: 2 },
      { id: 'haohmaru', name: 'Haohmaru', moveCount: 12 },
      { id: 'hibiki-takane', name: 'Hibiki Takane', moveCount: 4 },
      { id: 'iroha', name: 'Iroha', moveCount: 4 },
      { id: 'jubei', name: 'Jubei', moveCount: 6 },
      { id: 'kazuki', name: 'Kazuki', moveCount: 5 },
      { id: 'kurama-yashamaru', name: 'Kurama Yashamaru', moveCount: 4 },
      { id: 'kyoshiro', name: 'Kyoshiro', moveCount: 5 },
      { id: 'nakoruru', name: 'Nakoruru', moveCount: 3 },
      { id: 'rimururu', name: 'Rimururu', moveCount: 5 },
      { id: 'shizumaru', name: 'Shizumaru', moveCount: 5 },
      { id: 'sogetsu', name: 'Sogetsu', moveCount: 4 },
      { id: 'tam-tam', name: 'Tam Tam', moveCount: 4 },
      { id: 'ukyo', name: 'Ukyo', moveCount: 2 },
      { id: 'warden', name: 'Warden', moveCount: 4 },
      { id: 'wu-ruixiang', name: 'Wu-Ruixiang', moveCount: 4 },
      { id: 'yoshitora', name: 'Yoshitora', moveCount: 6 }
    ],
...
rosterCount: 15,
    ...
    characters: [
      { id: 'caffeine-nicotine', name: 'Caffeine Nicotine', moveCount: 12 },
      { id: 'cham-cham', name: 'Cham Cham', moveCount: 4 },
      { id: 'charlotte', name: 'Charlotte', moveCount: 6 },
      { id: 'earthquake', name: 'Earthquake', moveCount: 5 },
      { id: 'galford', name: 'Galford', moveCount: 12 },
      { id: 'genjuro', name: 'Genjuro', moveCount: 4 },
      { id: 'hanzo', name: 'Hanzo', moveCount: 11 },
      { id: 'haohmaru', name: 'Haohmaru', moveCount: 3 },
      { id: 'jubei', name: 'Jubei', moveCount: 6 },
      { id: 'kyoshiro', name: 'Kyoshiro', moveCount: 5 },
      { id: 'nakoruru', name: 'Nakoruru', moveCount: 3 },
      { id: 'neinhalt-sieger', name: 'Neinhalt Sieger', moveCount: 3 },
      { id: 'shiranui-genan', name: 'Shiranui Genan', moveCount: 8 },
      { id: 'tam-tam', name: 'Tam Tam', moveCount: 4 },
      { id: 'ukyo', name: 'Ukyo', moveCount: 10 }
    ],
...
rosterCount: 11,
    ...
    characters: [
      { id: 'amakusa', name: 'Amakusa', moveCount: 1 },
      { id: 'basara', name: 'Basara', moveCount: 3 },
      { id: 'galford', name: 'Galford', moveCount: 8 },
...

  {
    ...
    characters: [
      { id: 'amakusa', name: 'Amakusa', moveCount: 3 },
      { id: 'basara', name: 'Basara', moveCount: 2 },
      { id: 'charlotte', name: 'Charlotte', moveCount: 0 },
      { id: 'galford', name: 'Galford', moveCount: 8 },
      { id: 'gaira', name: 'Gaira', moveCount: 9 },
      { id: 'hanzo', name: 'Hanzo', moveCount: 9 },
      { id: 'haohmaru', name: 'Haohmaru', moveCount: 3 },
      { id: 'jubei', name: 'Jubei', moveCount: 6 },
      { id: 'kazuki', name: 'Kazuki', moveCount: 1 },
      { id: 'kyoshiro', name: 'Kyoshiro', moveCount: 5 },
      { id: 'nakoruru', name: 'Nakoruru', moveCount: 3 },
      { id: 'rimururu', name: 'Rimururu', moveCount: 1 },
      { id: 'shizumaru', name: 'Shizumaru', moveCount: 5 },
      { id: 'sogetsu', name: 'Sogetsu', moveCount: 4 },
      { id: 'tam-tam', name: 'Tam Tam', moveCount: 4 },
      { id: 'ukyo', name: 'Ukyo', moveCount: 3 }
    ],
    tabs: ['Special Moves', 'Super Combos', 'Finishers', 'Unique Attacks', 'Normal Moves', 'Command Throws', 'Normal Throws', 'Common Moves']
  },
  {
...
rosterCount: 19,
    ...
    characters: [
      { id: 'basara', name: 'Basara', moveCount: 10 },
      { id: 'charlotte', name: 'Charlotte', moveCount: 10 },
      { id: 'enja', name: 'Enja', moveCount: 3 },
      { id: 'gaira', name: 'Gaira', moveCount: 6 },
      { id: 'galford', name: 'Galford', moveCount: 8 },
      { id: 'hanzo', name: 'Hanzo', moveCount: 10 },
      { id: 'haohmaru', name: 'Haohmaru', moveCount: 3 },
      { id: 'jubei', name: 'Jubei', moveCount: 6 },
      { id: 'kazuki', name: 'Kazuki', moveCount: 5 },
      { id: 'kyoshiro', name: 'Kyoshiro', moveCount: 5 },
      { id: 'mina', name: 'Mina', moveCount: 7 },
      { id: 'nakoruru', name: 'Nakoruru', moveCount: 3 },
      { id: 'rimururu', name: 'Rimururu', moveCount: 9 },
      { id: 'shizumaru', name: 'Shizumaru', moveCount: 5 },
      { id: 'sogetsu', name: 'Sogetsu', moveCount: 4 },
      { id: 'suija', name: 'Suija', moveCount: 5 },
      { id: 'tam-tam', name: 'Tam Tam', moveCount: 7 },
      { id: 'ukyo', name: 'Ukyo', moveCount: 3 },
      { id: 'yoshitora', name: 'Yoshitora', moveCount: 3 }
    ],
...
rosterCount: 11,
    ...
    systemMechanics: [
        ...
        characters: [
      { id: 'carol', name: 'Carol', moveCount: 12 },
      { id: 'chung', name: 'Chung', moveCount: 12 },
      { id: 'gordon', name: 'Gordon', moveCount: 12 },
      { id: 'gozu', name: 'Gozu', moveCount: 13 },
      { id: 'joker', name: 'Joker', moveCount: 12 },
      { id: 'king-lion', name: 'King Lion', moveCount: 14 },
      { id: 'max-eagle', name: 'Max Eagle', moveCount: 13 },
      { id: 'mezu', name: 'Mezu', moveCount: 13 },
      { id: 'nicola', name: 'Nicola', moveCount: 12 },
      { id: 'sho-hayate', name: 'Sho Hayate', moveCount: 5 }
    ],
...
rosterCount: 16,
    ...
    tags: ["2D", "Tag"],
    characters: [
      { id: 'athena-asamiya', name: 'Athena Asamiya', moveCount: 4 },
      { id: 'jeanne-darc', name: 'Jeanne d\'', moveCount: 11 },
      { id: 'kula-diamond', name: 'Kula Diamond', moveCount: 6 },
      { id: 'leona-heidern', name: 'Leona Heidern', moveCount: 5 },
      { id: 'love-heart', name: 'Love Heart', moveCount: 4 },
      { id: 'luong', name: 'Luong', moveCount: 2 },
      { id: 'mai-shiranui', name: 'Mai Shiranui', moveCount: 14 },
      { id: 'mian', name: 'Mian', moveCount: 2 },
      { id: 'mui-mui', name: 'Mui Mui', moveCount: 2 },
      { id: 'nakoruru', name: 'Nakoruru', moveCount: 2 },
      { id: 'shermie', name: 'Shermie', moveCount: 2 },
      { id: 'silvie-paula-paula', name: 'Silvie Paula Paula', moveCount: 4 },
      { id: 'skullomania', name: 'Skullomania', moveCount: 5 },
      { id: 'terry-bogard', name: 'Terry Bogard', moveCount: 5 },
      { id: 'thief-arthur', name: 'Thief Arthur', moveCount: 19 },
      { id: 'yuri-sakazaki', name: 'Yuri Sakazaki', moveCount: 4 }
    ],
...
rosterCount: 37,
    ...
    tags: ["2D", "Vs."],
    characters: [
      { id: 'akuma', name: 'Akuma', moveCount: 7 },
      { id: 'athena', name: 'Athena', moveCount: 4 },
      { id: 'balrog', name: 'Balrog', moveCount: 21 },
      { id: 'chun-li', name: 'Chun-Li', moveCount: 16 },
      { id: 'dan', name: 'Dan', moveCount: 46 },
      { id: 'demitri', name: 'Demitri', moveCount: 7 },
      { id: 'dhalsim', name: 'Dhalsim', moveCount: 5 },
      { id: 'earthquake', name: 'Earthquake', moveCount: 11 },
      { id: 'evil-ryu', name: 'Evil Ryu', moveCount: 10 },
      { id: 'gaedel', name: 'Gaedel', moveCount: 9 },
      { id: 'geese-howard', name: 'Geese Howard', moveCount: 6 },
      { id: 'genjuro-kibagami', name: 'Genjuro Kibagami', moveCount: 12 },
      { id: 'goenitz', name: 'Goenitz', moveCount: 4 },
      { id: 'guile', name: 'Guile', moveCount: 4 },
      { id: 'haohmaru', name: 'Haohmaru', moveCount: 24 },
      { id: 'hugo', name: 'Hugo', moveCount: 15 },
      { id: 'iori-yagami', name: 'Iori Yagami', moveCount: 11 },
      { id: 'kasumi-todoh', name: 'Kasumi Todoh', moveCount: 10 },
      { id: 'ken', name: 'Ken', moveCount: 15 },
      { id: 'kim-kaphwan', name: 'Kim Kaphwan', moveCount: 9 },
      { id: 'kyo-kusanagi', name: 'Kyo Kusanagi', moveCount: 21 },
      { id: 'm-bison', name: 'M. Bison', moveCount: 11 },
      { id: 'mai-shiranui', name: 'Mai Shiranui', moveCount: 5 },
      { id: 'mars-people', name: 'Mars People', moveCount: 10 },
      { id: 'mr-karate', name: 'Mr. Karate', moveCount: 5 },
      { id: 'red-arremer', name: 'Red Arremer', moveCount: 10 },
      { id: 'rock-howard', name: 'Rock Howard', moveCount: 5 },
      { id: 'ryu', name: 'Ryu', moveCount: 5 },
      { id: 'sagat', name: 'Sagat', moveCount: 5 },
      { id: 'serious-mr-karate', name: 'Serious Mr. Karate', moveCount: 31 },
      { id: 'shiki', name: 'Shiki', moveCount: 3 },
      { id: 'shin-akuma', name: 'Shin Akuma', moveCount: 11 },
      { id: 'tabasa', name: 'Tabasa', moveCount: 46 },
      { id: 'terry-bogard', name: 'Terry Bogard', moveCount: 5 },
      { id: 'vega', name: 'Vega', moveCount: 9 },
      { id: 'violent-ken', name: 'Violent Ken', moveCount: 5 },
      { id: 'zero', name: 'Zero', moveCount: 2 }
    ],
...
rosterCount: 10,
    ...
    systemMechanics: [
        ...
        characters: [
      { id: 'astaroth', name: 'Astaroth', moveCount: 14 },
      { id: 'cervantes', name: 'Cervantes', moveCount: 14 },
      { id: 'edge-master', name: 'Edge Master', moveCount: 14 },
      { id: 'heihachi', name: 'Heihachi', moveCount: 14 },
      { id: 'ivy', name: 'Ivy', moveCount: 14 },
      { id: 'kilik', name: 'Kilik', moveCount: 16 },
      { id: 'lizardman', name: 'Lizardman', moveCount: 14 },
      { id: 'maxi', name: 'Maxi', moveCount: 13 },
      { id: 'mitsurugi', name: 'Mitsurugi', moveCount: 17 },
      { id: 'nightmare', name: 'Nightmare', moveCount: 14 },
      { id: 'seong-mi-na', name: 'Seong Mi-na', moveCount: 13 },
      { id: 'siegfried', name: 'Siegfried', moveCount: 14 },
      { id: 'sophitia', name: 'Sophitia', moveCount: 13 },
      { id: 'taki', name: 'Taki', moveCount: 14 },
      { id: 'voldo', name: 'Voldo', moveCount: 13 },
      { id: 'xianghua', name: 'Xianghua', moveCount: 14 },
      { id: 'yoshimitsu', name: 'Yoshimitsu', moveCount: 21 }
    ],
...
rosterCount: 10,
    ...
    systemMechanics: [
        ...
        characters: [
      { id: 'cervantes', name: 'Cervantes', moveCount: 13 },
      { id: 'hwang', name: 'Hwang', moveCount: 14 },
      { id: 'li-long', name: 'Li Long', moveCount: 13 },
      { id: 'mitsurugi', name: 'Mitsurugi', moveCount: 21 },
      { id: 'rock', name: 'Rock', moveCount: 15 },
      { id: 'seong-mi-na', name: 'Seong Mi-na', moveCount: 15 },
      { id: 'siegfried', name: 'Siegfried', moveCount: 17 },
      { id: 'sophitia', name: 'Sophitia', moveCount: 15 },
      { id: 'taki', name: 'Taki', moveCount: 18 },
      { id: 'voldo', name: 'Voldo', moveCount: 16 }
    ],
...
rosterCount: 25,
    ...
    notationSystem: 'traditional',
    characters: [
      { id: 'aki', name: 'A.K.I.', moveCount: 47 },
      { id: 'akuma', name: 'Akuma', moveCount: 61 },
      { id: 'blanka', name: 'Blanka', moveCount: 53 },
      { id: 'cammy', name: 'Cammy', moveCount: 46 },
      { id: 'chun-li', name: 'Chun-Li', moveCount: 55 },
      { id: 'dee-jay', name: 'Dee Jay', moveCount: 50 },
      { id: 'dhalsim', name: 'Dhalsim', moveCount: 48 },
      { id: 'e-honda', name: 'E. Honda', moveCount: 46 },
      { id: 'ed', name: 'Ed', moveCount: 44 },
      { id: 'guile', name: 'Guile', moveCount: 49 },
      { id: 'jamie', name: 'Jamie', moveCount: 59 },
      { id: 'jp', name: 'JP', moveCount: 47 },
      { id: 'juri', name: 'Juri', moveCount: 44 },
      { id: 'ken', name: 'Ken', moveCount: 50 },
      { id: 'kimberly', name: 'Kimberly', moveCount: 53 },
      { id: 'lily', name: 'Lily', moveCount: 46 },
      { id: 'luke', name: 'Luke', moveCount: 48 },
      { id: 'manon', name: 'Manon', moveCount: 43 },
      { id: 'marisa', name: 'Marisa', moveCount: 53 },
      { id: 'rashid', name: 'Rashid', moveCount: 51 },
      { id: 'ryu', name: 'Ryu', moveCount: 50 },
      { id: 'zangief', name: 'Zangief', moveCount: 51 },
      { id: 'm-bison', name: 'M. Bison', moveCount: 50 },
      { id: 'terry', name: 'Terry', moveCount: 42 },
      { id: 'mai', name: 'Mai', moveCount: 49 },
      { id: 'elena', name: 'Elena', moveCount: 53 },
      { id: 'sagat', name: 'Sagat', moveCount: 46 },
      { id: 'c-viper', name: 'C. Viper', moveCount: 45 },
      { id: 'alex', name: 'Alex', moveCount: 53 },
      { id: 'ingrid', name: 'Ingrid', moveCount: 8 }
    ],
...

  {
    ...
    characters: [
      { id: 'adon', name: 'Adon', moveCount: 13 },
      { id: 'akuma', name: 'Akuma', moveCount: 16 },
      { id: 'birdie', name: 'Birdie', moveCount: 11 },
      { id: 'charlie', name: 'Charlie', moveCount: 13 },
      { id: 'chun-li', name: 'Chun-Li', moveCount: 14 },
      { id: 'dan', name: 'Dan', moveCount: 14 },
      { id: 'guy', name: 'Guy', moveCount: 13 },
      { id: 'ken', name: 'Ken', moveCount: 13 },
      { id: 'rose', name: 'Rose', moveCount: 15 },
      { id: 'ryu', name: 'Ryu', moveCount: 13 },
      { id: 'sagat', name: 'Sagat', moveCount: 14 },
      { id: 'sodom', name: 'Sodom', moveCount: 8 }
    ],
...
rosterCount: 19,
    ...
    characters: [
      { id: 'adon', name: 'Adon', moveCount: 13 },
      { id: 'akuma', name: 'Akuma', moveCount: 16 },
      { id: 'birdie', name: 'Birdie', moveCount: 14 },
      { id: 'charlie', name: 'Charlie', moveCount: 13 },
      { id: 'chun-li', name: 'Chun-Li', moveCount: 17 },
      { id: 'dan', name: 'Dan', moveCount: 14 },
      { id: 'dhalsim', name: 'Dhalsim', moveCount: 14 },
      { id: 'evil-ryu', name: 'Evil Ryu', moveCount: 19 },
      { id: 'gen', name: 'Gen', moveCount: 12 },
      { id: 'guy', name: 'Guy', moveCount: 13 },
      { id: 'ken', name: 'Ken', moveCount: 13 },
      { id: 'm-bison', name: 'M. Bison', moveCount: 14 },
      { id: 'rolento', name: 'Rolento', moveCount: 13 },
      { id: 'rose', name: 'Rose', moveCount: 15 },
      { id: 'ryu', name: 'Ryu', moveCount: 13 },
      { id: 'sagat', name: 'Sagat', moveCount: 24 },
      { id: 'sakura', name: 'Sakura', moveCount: 14 },
      { id: 'sodom', name: 'Sodom', moveCount: 8 },
      { id: 'zangief', name: 'Zangief', moveCount: 23 }
    ],
...
rosterCount: 37,
    ...
    characters: [
        { id: 'ryu', name: 'Ryu', moveCount: 16 },
        { id: 'ken', name: 'Ken', moveCount: 10 },
        { id: 'chun-li', name: 'Chun Li', moveCount: 22 },
        { id: 'guile', name: 'Guile', moveCount: 11 },
        { id: 'zangief', name: 'Zangief', moveCount: 11 },
        { id: 'dhalsim', name: 'Dhalsim', moveCount: 11 },
        { id: 'ehonda', name: 'Ehonda', moveCount: 7 },
        { id: 'blanka', name: 'Blanka', moveCount: 11 },
        { id: 'balrog', name: 'Balrog', moveCount: 11 },
        { id: 'vega', name: 'Vega', moveCount: 10 },
        { id: 'sagat', name: 'Sagat', moveCount: 20 },
        { id: 'mbison', name: 'Mbison', moveCount: 7 },
        { id: 'sakura', name: 'Sakura', moveCount: 12 },
        { id: 'cammy', name: 'Cammy', moveCount: 11 },
        { id: 'akuma', name: 'Akuma', moveCount: 12 },
        { id: 'dan', name: 'Dan', moveCount: 26 },
        { id: 'rose', name: 'Rose', moveCount: 11 },
        { id: 'birdie', name: 'Birdie', moveCount: 11 },
        { id: 'charlie', name: 'Charlie', moveCount: 15 },
        { id: 'sodom', name: 'Sodom', moveCount: 12 },
        { id: 'guy', name: 'Guy', moveCount: 15 },
        { id: 'adon', name: 'Adon', moveCount: 31 },
        { id: 'gen', name: 'Gen', moveCount: 13 },
        { id: 'rollo', name: 'Rollo', moveCount: 7 },
        { id: 'cody', name: 'Cody', moveCount: 12 },
        { id: 'karin', name: 'Karin', moveCount: 12 },
        { id: 'r-mika', name: 'R Mika', moveCount: 7 },
        { id: 'juli', name: 'Juli', moveCount: 17 },
        { id: 'juni', name: 'Juni', moveCount: 13 },
        { id: 'evil-ryu', name: 'Evil Ryu', moveCount: 22 },
        { id: 'shin-akuma', name: 'Shin Akuma', moveCount: 27 },
        { id: 't-hawk', name: 'T Hawk', moveCount: 11 },
        { id: 'fei-long', name: 'Fei Long', moveCount: 11 },
        { id: 'deejay', name: 'Deejay', moveCount: 7 },
        { id: 'maki', name: 'Maki', moveCount: 11 },
        { id: 'eagle', name: 'Eagle', moveCount: 12 },
        { id: 'yun', name: 'Yun', moveCount: 29 },
        { id: 'ingrid', name: 'Ingrid', moveCount: 7 }
      ],
...
rosterCount: 21,
    ...
    characters: [
      { id: 'ace', name: 'Ace', moveCount: 12 },
      { id: 'area', name: 'Area', moveCount: 10 },
      { id: 'blanka', name: 'Blanka', moveCount: 13 },
      { id: 'chun-li', name: 'Chun-Li', moveCount: 15 },
      { id: 'cracker-jack', name: 'Cracker Jack', moveCount: 15 },
      { id: 'darun-mister', name: 'Darun Mister', moveCount: 13 },
      { id: 'dhalsim', name: 'Dhalsim', moveCount: 21 },
      { id: 'doctrine-dark', name: 'Doctrine Dark', moveCount: 17 },
      { id: 'guile', name: 'Guile', moveCount: 12 },
      { id: 'hokuto', name: 'Hokuto', moveCount: 20 },
      { id: 'ken', name: 'Ken', moveCount: 8 },
      { id: 'nanase', name: 'Nanase', moveCount: 9 },
      { id: 'pullum-purna', name: 'Pullum Purna', moveCount: 17 },
      { id: 'ryu', name: 'Ryu', moveCount: 12 },
      { id: 'sagat', name: 'Sagat', moveCount: 13 },
      { id: 'sakura', name: 'Sakura', moveCount: 9 },
      { id: 'sharon', name: 'Sharon', moveCount: 13 },
      { id: 'skullomania', name: 'Skullomania', moveCount: 13 },
      { id: 'vega', name: 'Vega', moveCount: 9 },
      { id: 'vulcano-rosso', name: 'Vulcano Rosso', moveCount: 29 },
      { id: 'zangief', name: 'Zangief', moveCount: 28 }
    ],
...

  {
    ...
    characters: [
      { id: 'alex', name: 'Alex', moveCount: 15 },
      { id: 'dudley', name: 'Dudley', moveCount: 12 },
      { id: 'elena', name: 'Elena', moveCount: 8 },
      { id: 'hugo', name: 'Hugo', moveCount: 9 },
      { id: 'ibuki', name: 'Ibuki', moveCount: 17 },
      { id: 'ken', name: 'Ken', moveCount: 14 },
      { id: 'necro', name: 'Necro', moveCount: 17 },
      { id: 'oro', name: 'Oro', moveCount: 28 },
      { id: 'ryu', name: 'Ryu', moveCount: 7 },
      { id: 'sean', name: 'Sean', moveCount: 25 },
      { id: 'urien', name: 'Urien', moveCount: 8 },
      { id: 'yang', name: 'Yang', moveCount: 16 },
      { id: 'yun', name: 'Yun', moveCount: 22 }
    ],
...
rosterCount: 11,
    ...
    characters: [
      { id: 'alex', name: 'Alex', moveCount: 10 },
      { id: 'dudley', name: 'Dudley', moveCount: 21 },
      { id: 'elena', name: 'Elena', moveCount: 15 },
      { id: 'ibuki', name: 'Ibuki', moveCount: 15 },
      { id: 'ken', name: 'Ken', moveCount: 14 },
      { id: 'necro', name: 'Necro', moveCount: 21 },
      { id: 'oro', name: 'Oro', moveCount: 16 },
      { id: 'ryu', name: 'Ryu', moveCount: 17 },
      { id: 'sean', name: 'Sean', moveCount: 15 },
      { id: 'yang', name: 'Yang', moveCount: 16 },
      { id: 'yun', name: 'Yun', moveCount: 30 }
    ],
...

  {
    ...
    characters: [
      { id: 'abigail', name: 'Abigail', moveCount: 27 },
      { id: 'akuma', name: 'Akuma', moveCount: 13 },
      { id: 'alex', name: 'Alex', moveCount: 28 },
      { id: 'balrog', name: 'Balrog', moveCount: 23 },
      { id: 'birdie', name: 'Birdie', moveCount: 11 },
      { id: 'blanka', name: 'Blanka', moveCount: 13 },
      { id: 'cammy', name: 'Cammy', moveCount: 13 },
      { id: 'chun-li', name: 'Chun-Li', moveCount: 12 },
      { id: 'cody', name: 'Cody', moveCount: 22 },
      { id: 'dan', name: 'Dan', moveCount: 25 },
      { id: 'dhalsim', name: 'Dhalsim', moveCount: 12 },
      { id: 'e-honda', name: 'E. Honda', moveCount: 13 },
      { id: 'ed', name: 'Ed', moveCount: 12 },
      { id: 'fang', name: 'F.A.N.G', moveCount: 13 },
      { id: 'falke', name: 'Falke', moveCount: 0 },
      { id: 'g', name: 'G', moveCount: 12 },
      { id: 'gill', name: 'Gill', moveCount: 12 },
      { id: 'guile', name: 'Guile', moveCount: 12 },
      { id: 'ibuki', name: 'Ibuki', moveCount: 13 },
      { id: 'juri', name: 'Juri', moveCount: 25 },
      { id: 'kage', name: 'Kage', moveCount: 13 },
      { id: 'karin', name: 'Karin', moveCount: 13 },
      { id: 'ken', name: 'Ken', moveCount: 14 },
      { id: 'kolin', name: 'Kolin', moveCount: 4 },
      { id: 'laura', name: 'Laura', moveCount: 24 },
      { id: 'lucia', name: 'Lucia', moveCount: 13 },
      { id: 'luke', name: 'Luke', moveCount: 15 },
      { id: 'm-bison', name: 'M. Bison', moveCount: 15 },
      { id: 'menat', name: 'Menat', moveCount: 15 },
      { id: 'nash', name: 'Nash', moveCount: 12 },
      { id: 'necalli', name: 'Necalli', moveCount: 13 },
      { id: 'oro', name: 'Oro', moveCount: 13 },
      { id: 'poison', name: 'Poison', moveCount: 13 },
      { id: 'r-mika', name: 'R. Mika', moveCount: 13 },
      { id: 'rashid', name: 'Rashid', moveCount: 12 },
      { id: 'rose', name: 'Rose', moveCount: 13 },
      { id: 'ryu', name: 'Ryu', moveCount: 12 },
      { id: 'sagat', name: 'Sagat', moveCount: 13 },
      { id: 'sakura', name: 'Sakura', moveCount: 13 },
      { id: 'seth', name: 'Seth', moveCount: 13 },
      { id: 'urien', name: 'Urien', moveCount: 14 },
      { id: 'vega', name: 'Vega', moveCount: 13 },
      { id: 'zeku', name: 'Zeku', moveCount: 13 }
    ],
...
rosterCount: 17,
    ...
    characters: [
      { id: 'akuma', name: 'Akuma', moveCount: 14 },
      { id: 'balrog', name: 'Balrog', moveCount: 12 },
      { id: 'blanka', name: 'Blanka', moveCount: 12 },
      { id: 'cammy', name: 'Cammy', moveCount: 12 },
      { id: 'chun-li', name: 'Chun-Li', moveCount: 21 },
      { id: 'dee-jay', name: 'Dee Jay', moveCount: 12 },
      { id: 'dhalsim', name: 'Dhalsim', moveCount: 12 },
      { id: 'e-honda', name: 'E. Honda', moveCount: 4 },
      { id: 'fei-long', name: 'Fei Long', moveCount: 10 },
      { id: 'guile', name: 'Guile', moveCount: 12 },
      { id: 'ken', name: 'Ken', moveCount: 11 },
      { id: 'm-bison', name: 'M. Bison', moveCount: 12 },
      { id: 'ryu', name: 'Ryu', moveCount: 8 },
      { id: 'sagat', name: 'Sagat', moveCount: 12 },
      { id: 't-hawk', name: 'T. Hawk', moveCount: 11 },
      { id: 'vega', name: 'Vega', moveCount: 11 },
      { id: 'zangief', name: 'Zangief', moveCount: 5 }
    ],
...

  {
    ...
    characters: [
      { id: 'balrog', name: 'Balrog', moveCount: 11 },
      { id: 'blanka', name: 'Blanka', moveCount: 13 },
      { id: 'cammy', name: 'Cammy', moveCount: 8 },
      { id: 'chun-li', name: 'Chun-Li', moveCount: 9 },
      { id: 'dee-jay', name: 'Dee Jay', moveCount: 6 },
      { id: 'dhalsim', name: 'Dhalsim', moveCount: 12 },
      { id: 'e-honda', name: 'E. Honda', moveCount: 6 },
      { id: 'fei-long', name: 'Fei Long', moveCount: 11 },
      { id: 'guile', name: 'Guile', moveCount: 8 },
      { id: 'ken', name: 'Ken', moveCount: 14 },
      { id: 'm-bison', name: 'M. Bison', moveCount: 15 },
      { id: 'ryu', name: 'Ryu', moveCount: 6 },
      { id: 'sagat', name: 'Sagat', moveCount: 13 },
      { id: 't-hawk', name: 'T. Hawk', moveCount: 6 },
      { id: 'vega', name: 'Vega', moveCount: 8 },
      { id: 'zangief', name: 'Zangief', moveCount: 17 }
    ],
...
rosterCount: 8,
    ...
    systemMechanics: [
        ...
        characters: [
      { id: 'divine-fist', name: 'Divine Fist', moveCount: 13 },
      { id: 'exile', name: 'Exile', moveCount: 13 },
      { id: 'fiery-phoenix', name: 'Fiery Phoenix', moveCount: 13 },
      { id: 'iron-monk', name: 'Iron Monk', moveCount: 13 },
      { id: 'jade-dragon', name: 'Jade Dragon', moveCount: 15 },
      { id: 'master-sage', name: 'Master Sage', moveCount: 13 },
      { id: 'vapor', name: 'Vapor', moveCount: 13 },
      { id: 'wuji', name: 'Wuji', moveCount: 12 }
    ],
...
rosterCount: 23,
    ...
    tags: ["2D", "3v3", "Vs."],
    characters: [
      { id: 'alex', name: 'Alex', moveCount: 2 },
      { id: 'casshan', name: 'Casshan', moveCount: 15 },
      { id: 'chun-li', name: 'Chun-Li', moveCount: 10 },
      { id: 'doronjo', name: 'Doronjo', moveCount: 2 },
      { id: 'frank-west', name: 'Frank West', moveCount: 13 },
      { id: 'gold-lightan', name: 'Gold Lightan', moveCount: 2 },
      { id: 'hakushon-daimao', name: 'Hakushon Daimao', moveCount: 14 },
      { id: 'ippatsuman', name: 'Ippatsuman', moveCount: 2 },
      { id: 'joe-the-condor', name: 'Joe the Condor', moveCount: 11 },
      { id: 'jun-the-swan', name: 'Jun the Swan', moveCount: 2 },
      { id: 'karas', name: 'Karas', moveCount: 2 },
      { id: 'ken-the-eagle', name: 'Ken the Eagle', moveCount: 13 },
      { id: 'mega-man-volnutt', name: 'Mega Man Volnutt', moveCount: 11 },
      { id: 'morrigan', name: 'Morrigan', moveCount: 10 },
      { id: 'polimar', name: 'Polimar', moveCount: 12 },
      { id: 'ryu', name: 'Ryu', moveCount: 14 },
      { id: 'saki', name: 'Saki', moveCount: 11 },
      { id: 'tekkaman', name: 'Tekkaman', moveCount: 11 },
      { id: 'tekkaman-blade', name: 'Tekkaman Blade', moveCount: 11 },
      { id: 'viewtiful-joe', name: 'Viewtiful Joe', moveCount: 11 },
      { id: 'yatterman-1', name: 'Yatterman-1', moveCount: 11 },
      { id: 'yatterman-2', name: 'Yatterman-2', moveCount: 11 },
      { id: 'zero', name: 'Zero', moveCount: 10 }
    ],
...
rosterCount: 17,
    ...
    systemMechanics: [
        ...
        characters: [
      { id: 'anna', name: 'Anna', moveCount: 9 },
      { id: 'armor-king', name: 'Armor King', moveCount: 2 },
      { id: 'ganryu', name: 'Ganryu', moveCount: 9 },
      { id: 'heihachi', name: 'Heihachi', moveCount: 10 },
      { id: 'jack', name: 'Jack', moveCount: 12 },
      { id: 'kazuya', name: 'Kazuya', moveCount: 19 },
      { id: 'king', name: 'King', moveCount: 14 },
      { id: 'kuma', name: 'Kuma', moveCount: 9 },
      { id: 'kunimitsu', name: 'Kunimitsu', moveCount: 13 },
      { id: 'lee', name: 'Lee', moveCount: 8 },
      { id: 'michelle', name: 'Michelle', moveCount: 13 },
      { id: 'nina', name: 'Nina', moveCount: 13 },
      { id: 'paul', name: 'Paul', moveCount: 15 },
      { id: 'wang', name: 'Wang', moveCount: 2 },
      { id: 'yoshimitsu', name: 'Yoshimitsu', moveCount: 13 }
    ],
...
rosterCount: 21,
    ...
    systemMechanics: [
        ...
        characters: [
      { id: 'alex', name: 'Alex', moveCount: 8 },
      { id: 'anna', name: 'Anna', moveCount: 9 },
      { id: 'armor-king', name: 'Armor King', moveCount: 2 },
      { id: 'baek', name: 'Baek', moveCount: 8 },
      { id: 'bruce', name: 'Bruce', moveCount: 8 },
      { id: 'ganryu', name: 'Ganryu', moveCount: 9 },
      { id: 'heihachi', name: 'Heihachi', moveCount: 10 },
      { id: 'jack-2', name: 'Jack-2', moveCount: 9 },
      { id: 'jun-kazama', name: 'Jun Kazama', moveCount: 10 },
      { id: 'kazuya', name: 'Kazuya', moveCount: 12 },
      { id: 'king', name: 'King', moveCount: 8 },
      { id: 'kuma', name: 'Kuma', moveCount: 3 },
      { id: 'kunimitsu', name: 'Kunimitsu', moveCount: 7 },
      { id: 'lee', name: 'Lee', moveCount: 8 },
      { id: 'lei', name: 'Lei', moveCount: 10 },
      { id: 'michelle', name: 'Michelle', moveCount: 9 },
      { id: 'nina', name: 'Nina', moveCount: 7 },
      { id: 'paul', name: 'Paul', moveCount: 9 },
      { id: 'roger', name: 'Roger', moveCount: 8 },
      { id: 'wang', name: 'Wang', moveCount: 2 },
      { id: 'yoshimitsu', name: 'Yoshimitsu', moveCount: 7 }
    ],
...
rosterCount: 33,
...

  {
    ...
    characters: [
      { id: 'anna-williams', name: 'Anna Williams', moveCount: 12 },
      { id: 'armor-king', name: 'Armor King', moveCount: 10 },
      { id: 'baek-doo-san', name: 'Baek Doo San', moveCount: 9 },
      { id: 'bruce-irvin', name: 'Bruce Irvin', moveCount: 9 },
      { id: 'bryan-fury', name: 'Bryan Fury', moveCount: 9 },
      { id: 'devil', name: 'Devil', moveCount: 9 },
      { id: 'eddy-gordo', name: 'Eddy Gordo', moveCount: 8 },
      { id: 'ganryu', name: 'Ganryu', moveCount: 8 },
      { id: 'gun-jack', name: 'Gun Jack', moveCount: 8 },
      { id: 'heihachi-mishima', name: 'Heihachi Mishima', moveCount: 8 },
      { id: 'hwoarang', name: 'Hwoarang', moveCount: 8 },
      { id: 'jack-2', name: 'Jack-2', moveCount: 10 },
      { id: 'jin-kazama', name: 'Jin Kazama', moveCount: 9 },
      { id: 'julia-chang', name: 'Julia Chang', moveCount: 8 },
      { id: 'jun-kazama', name: 'Jun Kazama', moveCount: 8 },
      { id: 'kazuya-mishima', name: 'Kazuya Mishima', moveCount: 8 },
      { id: 'king', name: 'King', moveCount: 8 },
      { id: 'kuma', name: 'Kuma', moveCount: 8 },
      { id: 'kunimitsu', name: 'Kunimitsu', moveCount: 8 },
      { id: 'lee-chaolan', name: 'Lee Chaolan', moveCount: 8 },
      { id: 'lei-wulong', name: 'Lei Wulong', moveCount: 8 },
      { id: 'michelle-chang', name: 'Michelle Chang', moveCount: 8 },
      { id: 'mokujin', name: 'Mokujin', moveCount: 7 },
      { id: 'nina-williams', name: 'Nina Williams', moveCount: 8 },
      { id: 'ogre', name: 'Ogre', moveCount: 8 },
      { id: 'panda', name: 'Panda', moveCount: 7 },
      { id: 'paul-phoenix', name: 'Paul Phoenix', moveCount: 8 },
      { id: 'prototype-jack', name: 'Prototype Jack', moveCount: 7 },
      { id: 'roger', name: 'Roger', moveCount: 8 },
      { id: 'true-ogre', name: 'True Ogre', moveCount: 8 },
      { id: 'unknown', name: 'Unknown', moveCount: 7 },
      { id: 'wang-jinrei', name: 'Wang Jinrei', moveCount: 8 },
      { id: 'ling-xiaoyu', name: 'Ling Xiaoyu', moveCount: 8 },
      { id: 'yoshimitsu', name: 'Yoshimitsu', moveCount: 8 }
    ]
  },

  {
    ...
    links: [
      { title: 'Wavu Wiki', url: 'https://wavu.wiki/t/Main_Page' },
        ...
        systemMechanics: [
        { name: "Tag Assault", description: "During a combo, tag in your partner for a simultaneous attack. Both characters deal damage together.", input: "2+5 (during combo)" },
        { name: "Tag Crash", description: "Emergency tag-out while being comboed. Costs Rage and brings in your partner with an attack.", input: "2+5 (while being hit)" },
        { name: "Rage", description: "At low health, damage output increases. Activates automatically." },
        { name: "Bound", description: "Certain moves slam grounded opponents, bouncing them for combo extensions." },
        { name: "Wall Carry / Wall Splat", description: "Drive opponents into walls for additional combo damage and mixup opportunities." },
    ],
    characters: [
      { id: 'alisa-bosconovitch', name: 'Alisa Bosconovitch', moveCount: 11 },
      { id: 'angel', name: 'Angel', moveCount: 9 },
      { id: 'anna-williams', name: 'Anna Williams', moveCount: 8 },
      { id: 'armor-king', name: 'Armor King', moveCount: 8 },
      { id: 'asuka-kazama', name: 'Asuka Kazama', moveCount: 8 },
      { id: 'baek-doo-san', name: 'Baek Doo San', moveCount: 8 },
      { id: 'bob-richards', name: 'Bob Richards', moveCount: 8 },
      { id: 'bruce-irvin', name: 'Bruce Irvin', moveCount: 7 },
      { id: 'bryan-fury', name: 'Bryan Fury', moveCount: 8 },
      { id: 'christie-monteiro', name: 'Christie Monteiro', moveCount: 7 },
      { id: 'craig-marduk', name: 'Craig Marduk', moveCount: 8 },
      { id: 'devil-jin', name: 'Devil Jin', moveCount: 7 },
      { id: 'eddy-gordo', name: 'Eddy Gordo', moveCount: 7 },
      { id: 'feng-wei', name: 'Feng Wei', moveCount: 7 },
      { id: 'forest-law', name: 'Forest Law', moveCount: 7 },
      { id: 'ganryu', name: 'Ganryu', moveCount: 7 },
      { id: 'heihachi-mishima', name: 'Heihachi Mishima', moveCount: 7 },
      { id: 'hwoarang', name: 'Hwoarang', moveCount: 7 },
      { id: 'jack-6', name: 'Jack 6', moveCount: 10 },
      { id: 'jaycee', name: 'Jaycee', moveCount: 7 },
      { id: 'jin-kazama', name: 'Jin Kazama', moveCount: 7 },
      { id: 'jinpachi-mishima', name: 'Jinpachi Mishima', moveCount: 7 },
      { id: 'julia-chang-jaycee', name: 'Julia Chang (Jaycee)', moveCount: 18 },
      { id: 'jun-kazama', name: 'Jun Kazama', moveCount: 7 },
      { id: 'kazuya-mishima', name: 'Kazuya Mishima', moveCount: 7 },
      { id: 'king', name: 'King', moveCount: 7 },
      { id: 'kuma', name: 'Kuma', moveCount: 7 },
      { id: 'kunimitsu', name: 'Kunimitsu', moveCount: 7 },
      { id: 'lars-alexandersson', name: 'Lars Alexandersson', moveCount: 7 },
      { id: 'lee-chaolan', name: 'Lee Chaolan', moveCount: 7 },
      { id: 'lei-wulong', name: 'Lei Wulong', moveCount: 7 },
      { id: 'leo-kliesen', name: 'Leo Kliesen', moveCount: 7 },
      { id: 'lili-rochefort', name: 'Lili Rochefort', moveCount: 7 },
      { id: 'ling-xiaoyu', name: 'Ling Xiaoyu', moveCount: 7 },
      { id: 'marshall-law', name: 'Marshall Law', moveCount: 7 },
      { id: 'miguel-caballero-rojo', name: 'Miguel Caballero Rojo', moveCount: 7 },
      { id: 'mokujin', name: 'Mokujin', moveCount: 7 },
      { id: 'nina-williams', name: 'Nina Williams', moveCount: 7 },
      { id: 'ogre', name: 'Ogre', moveCount: 7 },
      { id: 'panda', name: 'Panda', moveCount: 7 },
      { id: 'paul-phoenix', name: 'Paul Phoenix', moveCount: 7 },
      { id: 'raven', name: 'Raven', moveCount: 7 },
      { id: 'roger-jr', name: 'Roger Jr.', moveCount: 7 },
      { id: 'sebastian', name: 'Sebastian', moveCount: 7 },
      { id: 'sergei-dragunov', name: 'Sergei Dragunov', moveCount: 7 },
      { id: 'steve-fox', name: 'Steve Fox', moveCount: 7 },
      { id: 'tiger-jackson', name: 'Tiger Jackson', moveCount: 7 },
      { id: 'true-ogre', name: 'True Ogre', moveCount: 7 },
      { id: 'unknown', name: 'Unknown', moveCount: 7 },
      { id: 'violet', name: 'Violet', moveCount: 7 },
      { id: 'wang-jinrei', name: 'Wang Jinrei', moveCount: 7 },
      { id: 'yoshimitsu', name: 'Yoshimitsu', moveCount: 7 },
      { id: 'zafina', name: 'Zafina', moveCount: 7 }
    ],
    tabs: ['Special Moves', 'Super Combos', 'Finishers', 'Unique Attacks', 'Normal Moves', 'Command Throws', 'Normal Throws', 'Common Moves']
  },
  {
...
rosterCount: 24,
    ...
    characters: [
      { id: 'andy-bogard', name: 'Andy Bogard', moveCount: 8 },
      { id: 'athena-asamiya', name: 'Athena Asamiya', moveCount: 6 },
      { id: 'benimaru-nikaido', name: 'Benimaru Nikaido', moveCount: 3 },
      { id: 'chang-koehan', name: 'Chang Koehan', moveCount: 35 },
      { id: 'chin-gentsai', name: 'Chin Gentsai', moveCount: 4 },
      { id: 'choi-bounge', name: 'Choi Bounge', moveCount: 9 },
      { id: 'clark-still', name: 'Clark Still', moveCount: 3 },
      { id: 'goro-daimon', name: 'Goro Daimon', moveCount: 3 },
      { id: 'heidern', name: 'Heidern', moveCount: 3 },
      { id: 'heavy-d', name: 'Heavy D!', moveCount: 6 },
      { id: 'joe-higashi', name: 'Joe Higashi', moveCount: 10 },
      { id: 'kim-kaphwan', name: 'Kim Kaphwan', moveCount: 5 },
      { id: 'king', name: 'King', moveCount: 8 },
      { id: 'kyo-kusanagi', name: 'Kyo Kusanagi', moveCount: 11 },
      { id: 'lucky-glauber', name: 'Lucky Glauber', moveCount: 9 },
      { id: 'mai-shiranui', name: 'Mai Shiranui', moveCount: 6 },
      { id: 'ralf-jones', name: 'Ralf Jones', moveCount: 4 },
      { id: 'robert-garcia', name: 'Robert Garcia', moveCount: 6 },
      { id: 'ryo-sakazaki', name: 'Ryo Sakazaki', moveCount: 4 },
      { id: 'rugal-bernstein', name: 'Rugal Bernstein', moveCount: 4 },
      { id: 'sie-kensou', name: 'Sie Kensou', moveCount: 4 },
      { id: 'takuma-sakazaki', name: 'Takuma Sakazaki', moveCount: 4 },
      { id: 'terry-bogard', name: 'Terry Bogard', moveCount: 8 },
      { id: 'yuri-sakazaki', name: 'Yuri Sakazaki', moveCount: 6 }
    ],
...
rosterCount: 33,
    ...
    characters: [
      { id: 'andy-bogard', name: 'Andy Bogard', moveCount: 8 },
      { id: 'athena-asamiya', name: 'Athena Asamiya', moveCount: 6 },
      { id: 'bao', name: 'Bao', moveCount: 2 },
      { id: 'benimaru-nikaido', name: 'Benimaru Nikaido', moveCount: 2 },
      { id: 'blue-mary', name: 'Blue Mary', moveCount: 8 },
      { id: 'chang-koehan', name: 'Chang Koehan', moveCount: 4 },
      { id: 'chin-gentsai', name: 'Chin Gentsai', moveCount: 10 },
      { id: 'choi-bounge', name: 'Choi Bounge', moveCount: 19 },
      { id: 'clark-still', name: 'Clark Still', moveCount: 2 },
      { id: 'hinako-shijou', name: 'Hinako Shijou', moveCount: 2 },
      { id: 'iori-yagami', name: 'Iori Yagami', moveCount: 6 },
      { id: 'jhun-hoon', name: 'Jhun Hoon', moveCount: 6 },
      { id: 'joe-higashi', name: 'Joe Higashi', moveCount: 7 },
      { id: 'k-dash', name: 'K\'', moveCount: 4 },
      { id: 'kasumi-todoh', name: 'Kasumi Todoh', moveCount: 4 },
      { id: 'kim-kaphwan', name: 'Kim Kaphwan', moveCount: 0 },
      { id: 'king', name: 'King', moveCount: 8 },
      { id: 'kula-diamond', name: 'Kula Diamond', moveCount: 6 },
      { id: 'kyo-kusanagi', name: 'Kyo Kusanagi', moveCount: 11 },
      { id: 'leona-heidern', name: 'Leona Heidern', moveCount: 6 },
      { id: 'lin', name: 'Lin', moveCount: 3 },
      { id: 'mai-shiranui', name: 'Mai Shiranui', moveCount: 6 },
      { id: 'maxima', name: 'Maxima', moveCount: 3 },
      { id: 'ralf-jones', name: 'Ralf Jones', moveCount: 5 },
      { id: 'ramon', name: 'Ramon', moveCount: 3 },
      { id: 'robert-garcia', name: 'Robert Garcia', moveCount: 6 },
      { id: 'ryo-sakazaki', name: 'Ryo Sakazaki', moveCount: 6 },
      { id: 'seth', name: 'Seth', moveCount: 5 },
      { id: 'shingo-yabuki', name: 'Shingo Yabuki', moveCount: 7 },
      { id: 'sie-kensou', name: 'Sie Kensou', moveCount: 7 },
      { id: 'terry-bogard', name: 'Terry Bogard', moveCount: 8 },
      { id: 'vanessa', name: 'Vanessa', moveCount: 4 },
      { id: 'whip', name: 'Whip', moveCount: 5 }
    ],
...
rosterCount: 34,
    ...
    characters: [
      { id: 'angel', name: 'Angel', moveCount: 24 },
      { id: 'andy-bogard', name: 'Andy Bogard', moveCount: 8 },
      { id: 'athena-asamiya', name: 'Athena Asamiya', moveCount: 6 },
      { id: 'bao', name: 'Bao', moveCount: 2 },
      { id: 'benimaru-nikaido', name: 'Benimaru Nikaido', moveCount: 2 },
      ...
      { id: 'chang-koehan', name: 'Chang Koehan', moveCount: 4 },
      { id: 'chin-gentsai', name: 'Chin Gentsai', moveCount: 4 },
      { id: 'choi-bounge', name: 'Choi Bounge', moveCount: 4 },
      { id: 'clark-still', name: 'Clark Still', moveCount: 2 },
      { id: 'foxy', name: 'Foxy', moveCount: 1 },
      { id: 'heidern', name: 'Heidern', moveCount: 6 },
      { id: 'hinako-shijou', name: 'Hinako Shijou', moveCount: 2 },
      { id: 'iori-yagami', name: 'Iori Yagami', moveCount: 6 },
      { id: 'joe-higashi', name: 'Joe Higashi', moveCount: 7 },
      { id: 'kula-diamond', name: 'Kula Diamond', moveCount: 13 },
      { id: 'kyo-kusanagi', name: 'Kyo Kusanagi', moveCount: 11 },
      { id: 'leona-heidern', name: 'Leona Heidern', moveCount: 6 },
      { id: 'li-xiangfei', name: 'Li Xiangfei', moveCount: 6 },
      { id: 'lin', name: 'Lin', moveCount: 3 },
      { id: 'mai-shiranui', name: 'Mai Shiranui', moveCount: 0 },
      { id: 'maxima', name: 'Maxima', moveCount: 3 },
      { id: 'may-lee', name: 'May Lee', moveCount: 2 },
      { id: 'ralf-jones', name: 'Ralf Jones', moveCount: 5 },
      { id: 'robert-garcia', name: 'Robert Garcia', moveCount: 6 },
      { id: 'ryo-sakazaki', name: 'Ryo Sakazaki', moveCount: 6 },
      { id: 'seth', name: 'Seth', moveCount: 5 },
...
rosterCount: 39,
    ...
    characters: [
      { id: 'andy-bogard', name: 'Andy Bogard', moveCount: 1 },
      { id: 'angel', name: 'Angel', moveCount: 3 },
      { id: 'athena-asamiya', name: 'Athena Asamiya', moveCount: 6 },
      { id: 'benimaru-nikaido', name: 'Benimaru Nikaido', moveCount: 4 },
      { id: 'billy-kane', name: 'Billy Kane', moveCount: 3 },
      { id: 'blue-mary', name: 'Blue Mary', moveCount: 3 },
      { id: 'chang-koehan', name: 'Chang Koehan', moveCount: 3 },
      { id: 'chin-gentsai', name: 'Chin Gentsai', moveCount: 2 },
      { id: 'choi-bounge', name: 'Choi Bounge', moveCount: 3 },
      { id: 'chris', name: 'Chris', moveCount: 7 },
      { id: 'clark-still', name: 'Clark Still', moveCount: 2 },
      { id: 'goro-daimon', name: 'Goro Daimon', moveCount: 3 },
      { id: 'iori-yagami', name: 'Iori Yagami', moveCount: 6 },
      { id: 'joe-higashi', name: 'Joe Higashi', moveCount: 3 },
      { id: 'k-dash', name: 'K\'', moveCount: 4 },
      { id: 'kim-kaphwan', name: 'Kim Kaphwan', moveCount: 14 },
      { id: 'kula-diamond', name: 'Kula Diamond', moveCount: 6 },
      { id: 'kyo-kusanagi', name: 'Kyo Kusanagi', moveCount: 11 },
      { id: 'leona-heidern', name: 'Leona Heidern', moveCount: 6 },
      { id: 'mai-shiranui', name: 'Mai Shiranui', moveCount: 6 },
      { id: 'mature', name: 'Mature', moveCount: 6 },
      { id: 'maxima', name: 'Maxima', moveCount: 3 },
      { id: 'may-lee', name: 'May Lee', moveCount: 3 },
      { id: 'ralf-jones', name: 'Ralf Jones', moveCount: 5 },
      { id: 'ramon', name: 'Ramon', moveCount: 3 },
      { id: 'robert-garcia', name: 'Robert Garcia', moveCount: 6 },
      { id: 'ryo-sakazaki', name: 'Ryo Sakazaki', moveCount: 6 },
      { id: 'ryuji-yamazaki', name: 'Ryuji Yamazaki', moveCount: 6 },
      { id: 'seth', name: 'Seth', moveCount: 5 },
      { id: 'shermie', name: 'Shermie', moveCount: 3 },
      { id: 'shingo-yabuki', name: 'Shingo Yabuki', moveCount: 7 },
      { id: 'sie-kensou', name: 'Sie Kensou', moveCount: 7 },
      { id: 'takuma-sakazaki', name: 'Takuma Sakazaki', moveCount: 3 },
      { id: 'terry-bogard', name: 'Terry Bogard', moveCount: 8 },
      { id: 'vanessa', name: 'Vanessa', moveCount: 4 },
      { id: 'vice', name: 'Vice', moveCount: 4 },
      { id: 'whip', name: 'Whip', moveCount: 5 },
      { id: 'yashiro-nanakase', name: 'Yashiro Nanakase', moveCount: 6 }
    ],
...
rosterCount: 30,
    ...
    characters: [
      { id: 'ash-crimson', name: 'Ash Crimson', moveCount: 5 },
      { id: 'athena-asamiya', name: 'Athena Asamiya', moveCount: 6 },
      { id: 'benimaru-nikaido', name: 'Benimaru Nikaido', moveCount: 2 },
      { id: 'billy-kane', name: 'Billy Kane', moveCount: 18 },
      { id: 'blue-mary', name: 'Blue Mary', moveCount: 8 },
      { id: 'chang-koehan', name: 'Chang Koehan', moveCount: 4 },
      { id: 'clark-still', name: 'Clark Still', moveCount: 4 },
      { id: 'duolon', name: 'Duolon', moveCount: 4 },
      { id: 'gato', name: 'Gato', moveCount: 6 },
      { id: 'goro-daimon', name: 'Goro Daimon', moveCount: 8 },
      { id: 'hinako-shijou', name: 'Hinako Shijou', moveCount: 2 },
      { id: 'iori-yagami', name: 'Iori Yagami', moveCount: 6 },
      { id: 'jhun-hoon', name: 'Jhun Hoon', moveCount: 6 },
      { id: 'joe-higashi', name: 'Joe Higashi', moveCount: 7 },
      { id: 'kim-kaphwan', name: 'Kim Kaphwan', moveCount: 10 },
      { id: 'kusanagi', name: 'Kusanagi', moveCount: 11 },
      { id: 'kyo-kusanagi', name: 'Kyo Kusanagi', moveCount: 11 },
      { id: 'leona-heidern', name: 'Leona Heidern', moveCount: 6 },
      { id: 'mai-shiranui', name: 'Mai Shiranui', moveCount: 6 },
      { id: 'malin', name: 'Malin', moveCount: 3 },
      { id: 'maxima', name: 'Maxima', moveCount: 3 },
      { id: 'ralf-jones', name: 'Ralf Jones', moveCount: 5 },
      { id: 'robert-garcia', name: 'Robert Garcia', moveCount: 6 },
      { id: 'ryo-sakazaki', name: 'Ryo Sakazaki', moveCount: 6 },
      { id: 'shen-woo', name: 'Shen Woo', moveCount: 6 },
      { id: 'shingo-yabuki', name: 'Shingo Yabuki', moveCount: 7 },
      { id: 'terry-bogard', name: 'Terry Bogard', moveCount: 8 },
      { id: 'tizoc', name: 'Tizoc', moveCount: 4 },
      { id: 'whip', name: 'Whip', moveCount: 5 }
    ],
...
rosterCount: 32,
    ...
    characters: [
      { id: 'andy-bogard', name: 'Andy Bogard', moveCount: 8 },
      { id: 'ash-crimson', name: 'Ash Crimson', moveCount: 5 },
      { id: 'athena-asamiya', name: 'Athena Asamiya', moveCount: 8 },
      { id: 'benimaru-nikaido', name: 'Benimaru Nikaido', moveCount: 4 },
      { id: 'billy-kane', name: 'Billy Kane', moveCount: 5 },
      { id: 'chin-gentsai', name: 'Chin Gentsai', moveCount: 4 },
      { id: 'clark-still', name: 'Clark Still', moveCount: 4 },
      { id: 'duo-lon', name: 'Duo Lon', moveCount: 4 },
      { id: 'elisabeth-blanctorche', name: 'Elisabeth Blanctorche', moveCount: 11 },
      { id: 'hwa-jai', name: 'Hwa Jai', moveCount: 2 },
      { id: 'iori-yagami', name: 'Iori Yagami', moveCount: 6 },
      { id: 'joe-higashi', name: 'Joe Higashi', moveCount: 7 },
      { id: 'k-dash', name: 'K\'', moveCount: 2 },
      { id: 'kim-kaphwan', name: 'Kim Kaphwan', moveCount: 5 },
      { id: 'king', name: 'King', moveCount: 8 },
      { id: 'kula-diamond', name: 'Kula Diamond', moveCount: 6 },
      { id: 'kyo-kusanagi', name: 'Kyo Kusanagi', moveCount: 11 },
      ...
      { id: 'maxima', name: 'Maxima', moveCount: 3 },
      { id: 'mr-karate', name: 'Mr. Karate', moveCount: 5 },
      { id: 'raiden', name: 'Raiden', moveCount: 6 },
      { id: 'ralf-jones', name: 'Ralf Jones', moveCount: 5 },
      { id: 'robert-garcia', name: 'Robert Garcia', moveCount: 6 },
      { id: 'ryo-sakazaki', name: 'Ryo Sakazaki', moveCount: 6 },
      { id: 'saiki', name: 'Saiki', moveCount: 2 },
      { id: 'shen-woo', name: 'Shen Woo', moveCount: 6 },
      { id: 'sie-kensou', name: 'Sie Kensou', moveCount: 7 },
      { id: 'terry-bogard', name: 'Terry Bogard', moveCount: 8 },
      { id: 'vice', name: 'Vice', moveCount: 4 },
...
rosterCount: 47,
    ...
    characters: [
      { id: 'alice', name: 'Alice', moveCount: 4 },
      { id: 'andy-bogard', name: 'Andy Bogard', moveCount: 8 },
      { id: 'angel', name: 'Angel', moveCount: 1 },
      { id: 'antonov', name: 'Antonov', moveCount: 2 },
      { id: 'athena-asamiya', name: 'Athena Asamiya', moveCount: 6 },
      { id: 'bandeiras-hattori', name: 'Bandeiras Hattori', moveCount: 8 },
      { id: 'benimaru-nikaido', name: 'Benimaru Nikaido', moveCount: 4 },
      { id: 'billy-kane', name: 'Billy Kane', moveCount: 5 },
      { id: 'chin-gentsai', name: 'Chin Gentsai', moveCount: 8 },
      { id: 'choi-bounge', name: 'Choi Bounge', moveCount: 4 },
      { id: 'clark-still', name: 'Clark Still', moveCount: 4 },
      { id: 'dinosaur', name: 'Dinosaur', moveCount: 7 },
      { id: 'gang-il', name: 'Gang-Il', moveCount: 3 },
      { id: 'geese-howard', name: 'Geese Howard', moveCount: 9 },
      { id: 'goro-daimon', name: 'Goro Daimon', moveCount: 6 },
      { id: 'hein', name: 'Hein', moveCount: 5 },
      { id: 'iori-yagami', name: 'Iori Yagami', moveCount: 6 },
      { id: 'joe-higashi', name: 'Joe Higashi', moveCount: 7 },
      { id: 'kim-kaphwan', name: 'Kim Kaphwan', moveCount: 5 },
      { id: 'king', name: 'King', moveCount: 8 },
      ...
      { id: 'mature', name: 'Mature', moveCount: 6 },
      { id: 'maxima', name: 'Maxima', moveCount: 3 },
      { id: 'meitenkun', name: 'Meitenkun', moveCount: 2 },
      { id: 'mian', name: 'Mian', moveCount: 3 },
      { id: 'mui-mui', name: 'Mui Mui', moveCount: 7 },
      { id: 'nakoruru', name: 'Nakoruru', moveCount: 2 },
      { id: 'nelson', name: 'Nelson', moveCount: 2 },
      { id: 'ralf-jones', name: 'Ralf Jones', moveCount: 5 },
      { id: 'ramon', name: 'Ramon', moveCount: 3 },
      { id: 'robert-garcia', name: 'Robert Garcia', moveCount: 6 },
      { id: 'ryo-sakazaki', name: 'Ryo Sakazaki', moveCount: 6 },
      { id: 'sie-kensou', name: 'Sie Kensou', moveCount: 7 },
      { id: 'sylvie-paula-paula', name: 'Sylvie Paula Paula', moveCount: 7 },
      { id: 'terry-bogard', name: 'Terry Bogard', moveCount: 8 },
      { id: 'tung-fu-rue', name: 'Tung Fu Rue', moveCount: 7 },
      { id: 'vice', name: 'Vice', moveCount: 4 },
      { id: 'xanadu', name: 'Xanadu', moveCount: 2 },
      { id: 'yuri-sakazaki', name: 'Yuri Sakazaki', moveCount: 6 },
      { id: 'zarina', name: 'Zarina', moveCount: 2 }
    ],
...
rosterCount: 48,
    ...
    characters: [
      { id: 'andy-bogard', name: 'Andy Bogard', moveCount: 30 },
      { id: 'angel', name: 'Angel', moveCount: 3 },
      { id: 'antonov', name: 'Antonov', moveCount: 3 },
      { id: 'ash-crimson', name: 'Ash Crimson', moveCount: 5 },
      { id: 'athena-asamiya', name: 'Athena Asamiya', moveCount: 6 },
      { id: 'b-jenet', name: 'B. Jenet', moveCount: 8 },
      { id: 'benimaru-nikaido', name: 'Benimaru Nikaido', moveCount: 4 },
      { id: 'billy-kane', name: 'Billy Kane', moveCount: 5 },
      { id: 'blue-mary', name: 'Blue Mary', moveCount: 4 },
      { id: 'chizuru-kagura', name: 'Chizuru Kagura', moveCount: 6 },
      { id: 'chris', name: 'Chris', moveCount: 6 },
      { id: 'clark-still', name: 'Clark Still', moveCount: 4 },
      { id: 'dolores', name: 'Dolores', moveCount: 4 },
      { id: 'elisabeth-blanctorche', name: 'Elisabeth Blanctorche', moveCount: 11 },
      { id: 'gato', name: 'Gato', moveCount: 6 },
      { id: 'geese-howard', name: 'Geese Howard', moveCount: 9 },
      { id: 'haohmaru', name: 'Haohmaru', moveCount: 6 },
      { id: 'heidern', name: 'Heidern', moveCount: 6 },
      { id: 'iori-yagami', name: 'Iori Yagami', moveCount: 6 },
      { id: 'isla', name: 'Isla', moveCount: 20 },
      { id: 'joe-higashi', name: 'Joe Higashi', moveCount: 7 },
      { id: 'k-dash', name: 'K\'', moveCount: 7 },
      { id: 'king', name: 'King', moveCount: 8 },
      { id: 'kof-xv', name: 'Kof XV', moveCount: 0 },
      { id: 'krohnen-mcdougall', name: 'Krohnen McDougall', moveCount: 6 },
      { id: 'kula-diamond', name: 'Kula Diamond', moveCount: 6 },
      { id: 'kyo-kusanagi', name: 'Kyo Kusanagi', moveCount: 11 },
      { id: 'leona-heidern', name: 'Leona Heidern', moveCount: 6 },
      { id: 'mai-shiranui', name: 'Mai Shiranui', moveCount: 6 },
      ...
      { id: 'meitenkun', name: 'Meitenkun', moveCount: 2 },
      { id: 'nakoruru', name: 'Nakoruru', moveCount: 2 },
      { id: 'orochi-chris', name: 'Orochi Chris', moveCount: 6 },
      { id: 'orochi-shermie', name: 'Orochi Shermie', moveCount: 6 },
      { id: 'orochi-yashiro', name: 'Orochi Yashiro', moveCount: 6 },
      { id: 'ralf-jones', name: 'Ralf Jones', moveCount: 5 },
      { id: 'ramon', name: 'Ramon', moveCount: 3 },
      { id: 'robert-garcia', name: 'Robert Garcia', moveCount: 6 },
      { id: 'rock-howard', name: 'Rock Howard', moveCount: 9 },
      { id: 'ryo-sakazaki', name: 'Ryo Sakazaki', moveCount: 6 },
      { id: 'ryuji-yamazaki', name: 'Ryuji Yamazaki', moveCount: 6 },
      { id: 'shermie', name: 'Shermie', moveCount: 3 },
      { id: 'shunei', name: 'Shun\'ei', moveCount: 7 },
      { id: 'terry-bogard', name: 'Terry Bogard', moveCount: 8 },
      { id: 'vanessa', name: 'Vanessa', moveCount: 4 },
      { id: 'whip', name: 'Whip', moveCount: 5 },
      { id: 'yashiro-nanakase', name: 'Yashiro Nanakase', moveCount: 6 },
...
rosterCount: 19,
    ...
    systemMechanics: [
        ...
        characters: [
      { id: 'alba-meira', name: 'Alba Meira', moveCount: 14 },
      { id: 'athena-asamiya', name: 'Athena Asamiya', moveCount: 6 },
      { id: 'chae-lim', name: 'Chae Lim', moveCount: 5 },
      { id: 'clark-still', name: 'Clark Still', moveCount: 4 },
      { id: 'duke', name: 'Duke', moveCount: 6 },
      { id: 'iori-yagami', name: 'Iori Yagami', moveCount: 6 },
      { id: 'leona-heidern', name: 'Leona Heidern', moveCount: 6 },
      { id: 'lien-neville', name: 'Lien Neville', moveCount: 6 },
      { id: 'mai-shiranui', name: 'Mai Shiranui', moveCount: 6 },
      { id: 'maxima', name: 'Maxima', moveCount: 3 },
      { id: 'mignon-beart', name: 'Mignon Beart', moveCount: 6 },
      { id: 'ralf-jones', name: 'Ralf Jones', moveCount: 5 },
      { id: 'rock-howard', name: 'Rock Howard', moveCount: 9 },
      { id: 'ryo-sakazaki', name: 'Ryo Sakazaki', moveCount: 6 },
      { id: 'seth', name: 'Seth', moveCount: 5 },
      { id: 'soiree-meira', name: 'Soiree Meira', moveCount: 11 },
      { id: 'terry-bogard', name: 'Terry Bogard', moveCount: 8 },
      { id: 'yuri-sakazaki', name: 'Yuri Sakazaki', moveCount: 6 }
    ],
...
rosterCount: 17,
    ...
    systemMechanics: [
      ...
      { id: 'alba-meira', name: 'Alba Meira', moveCount: 14 },
      { id: 'billy-kane', name: 'Billy Kane', moveCount: 6 },
      { id: 'chae-lim', name: 'Chae Lim', moveCount: 3 },
      { id: 'duke', name: 'Duke', moveCount: 6 },
      { id: 'fiolina-germi', name: 'Fiolina Germi', moveCount: 7 },
      { id: 'hanzo-hattori', name: 'Hanzo Hattori', moveCount: 6 },
      { id: 'kyo-kusanagi', name: 'Kyo Kusanagi', moveCount: 9 },
      { id: 'lien-neville', name: 'Lien Neville', moveCount: 4 },
      { id: 'luise-meyrink', name: 'Luise Meyrink', moveCount: 6 },
      { id: 'mai-shiranui', name: 'Mai Shiranui', moveCount: 4 },
      { id: 'mignon-beart', name: 'Mignon Beart', moveCount: 4 },
      { id: 'nagase', name: 'Nagase', moveCount: 6 },
      { id: 'ninon-beart', name: 'Ninon Beart', moveCount: 6 },
      { id: 'richard-meyer', name: 'Richard Meyer', moveCount: 6 },
      { id: 'rock-howard', name: 'Rock Howard', moveCount: 9 },
      { id: 'soiree-meira', name: 'Soiree Meira', moveCount: 6 },
      { id: 'terry-bogard', name: 'Terry Bogard', moveCount: 6 }
    ],
...

  {
    ...
    characters: [
      { id: 'ash-crimson', name: 'Ash Crimson', moveCount: 6 },
      { id: 'blue-mary', name: 'Blue Mary', moveCount: 5 },
      { id: 'makoto-mizoguchi', name: 'Makoto Mizoguchi', moveCount: 6 },
      { id: 'nightmare-geese', name: 'Nightmare Geese', moveCount: 9 },
      { id: 'xiao-lon', name: 'Xiao Lon', moveCount: 7 }
    ],
    tabs: ['Special Moves', 'Super Combos', 'Finishers', 'Unique Attacks', 'Normal Moves', 'Command Throws', 'Normal Throws', 'Common Moves']
  },
  {
...
rosterCount: 12,
    ...
    characters: [
      { id: 'akari-ichijou', name: 'Akari Ichijou', moveCount: 14 },
      { id: 'genbu-no-okina', name: 'Genbu no Okina', moveCount: 6 },
      { id: 'hyo-amano', name: 'Hyo Amano', moveCount: 11 },
      { id: 'juzoh-kanzaki', name: 'Juzoh Kanzaki', moveCount: 8 },
      { id: 'kaede', name: 'Kaede', moveCount: 4 },
      { id: 'keiichiro-washizuka', name: 'Keiichiro Washizuka', moveCount: 8 },
      { id: 'lee-recca', name: 'Lee Recca', moveCount: 11 },
      { id: 'moriya-minakata', name: 'Moriya Minakata', moveCount: 2 },
      { id: 'shigen-naoe', name: 'Shigen Naoe', moveCount: 6 },
      { id: 'shikyoh', name: 'Shikyoh', moveCount: 11 },
      { id: 'yuki', name: 'Yuki', moveCount: 7 },
      { id: 'zantetsu', name: 'Zantetsu', moveCount: 11 }
    ],
...
rosterCount: 19,
    ...
    characters: [
      { id: 'akari-ichijou', name: 'Akari Ichijou', moveCount: 19 },
      { id: 'awakened-kaede', name: 'Awakened Kaede', moveCount: 9 },
      { id: 'genbu-no-okina', name: 'Genbu no Okina', moveCount: 8 },
      { id: 'hagure-hitogata', name: 'Hagure Hitogata', moveCount: 8 },
      { id: 'hibiki-takane', name: 'Hibiki Takane', moveCount: 11 },
      { id: 'hyo-amano', name: 'Hyo Amano', moveCount: 14 },
      { id: 'juzoh-kanzaki', name: 'Juzoh Kanzaki', moveCount: 16 },
      { id: 'kaede', name: 'Kaede', moveCount: 8 },
      { id: 'kaori-sanada', name: 'Kaori Sanada', moveCount: 3 },
      { id: 'keiichiro-washizuka', name: 'Keiichiro Washizuka', moveCount: 19 },
      { id: 'kouryu', name: 'Kouryu', moveCount: 8 },
      { id: 'lee-recca', name: 'Lee Recca', moveCount: 19 },
      { id: 'moriya-minakata', name: 'Moriya Minakata', moveCount: 5 },
      { id: 'mukuro', name: 'Mukuro', moveCount: 11 },
      { id: 'setsuna', name: 'Setsuna', moveCount: 4 },
      { id: 'shigen-naoe', name: 'Shigen Naoe', moveCount: 6 },
      { id: 'shinnosuke-kagami', name: 'Shinnosuke Kagami', moveCount: 5 },
      { id: 'yuki', name: 'Yuki', moveCount: 4 },
      { id: 'zantetsu', name: 'Zantetsu', moveCount: 12 }
    ],
...
rosterCount: 50,
    ...
    characters: [
      { id: 'akuma', name: 'Akuma', moveCount: 19 },
      { id: 'amaterasu', name: 'Amaterasu', moveCount: 20 },
      { id: 'arthur', name: 'Arthur', moveCount: 30 },
      { id: 'c-viper', name: 'C. Viper', moveCount: 16 },
      { id: 'captain-america', name: 'Captain America', moveCount: 10 },
      { id: 'chris-redfield', name: 'Chris Redfield', moveCount: 15 },
      { id: 'chun-li', name: 'Chun-Li', moveCount: 10 },
      { id: 'dante', name: 'Dante', moveCount: 13 },
      { id: 'deadpool', name: 'Deadpool', moveCount: 15 },
      { id: 'doc-strange', name: 'Doc Strange', moveCount: 16 },
      { id: 'dormammu', name: 'Dormammu', moveCount: 15 },
      { id: 'dr-doom', name: 'Dr. Doom', moveCount: 13 },
      { id: 'felicia', name: 'Felicia', moveCount: 27 },
      { id: 'firebrand', name: 'Firebrand', moveCount: 15 },
      { id: 'ghost-rider', name: 'Ghost Rider', moveCount: 17 },
      { id: 'haggar', name: 'Haggar', moveCount: 15 },
      { id: 'hawkeye', name: 'Hawkeye', moveCount: 17 },
      { id: 'hsien-ko', name: 'Hsien-Ko', moveCount: 12 },
      { id: 'hulk', name: 'Hulk', moveCount: 10 },
      { id: 'iron-fist', name: 'Iron Fist', moveCount: 13 },
      { id: 'iron-man', name: 'Iron Man', moveCount: 13 },
      { id: 'jill-valentine', name: 'Jill Valentine', moveCount: 12 },
      { id: 'magneto', name: 'Magneto', moveCount: 13 },
      { id: 'modok', name: 'MODOK', moveCount: 11 },
      { id: 'morrigan', name: 'Morrigan', moveCount: 11 },
      { id: 'nemesis', name: 'Nemesis', moveCount: 10 },
      { id: 'nova', name: 'Nova', moveCount: 10 },
      { id: 'phoenix', name: 'Phoenix', moveCount: 11 },
      { id: 'phoenix-wright', name: 'Phoenix Wright', moveCount: 12 },
      { id: 'rocket-raccoon', name: 'Rocket Raccoon', moveCount: 10 },
      { id: 'ryu', name: 'Ryu', moveCount: 13 },
      { id: 'sentinel', name: 'Sentinel', moveCount: 15 },
      { id: 'she-hulk', name: 'She-Hulk', moveCount: 10 },
      { id: 'shuma-gorath', name: 'Shuma-Gorath', moveCount: 11 },
      { id: 'spencer', name: 'Spencer', moveCount: 11 },
      { id: 'spider-man', name: 'Spider-Man', moveCount: 13 },
      { id: 'storm', name: 'Storm', moveCount: 10 },
      { id: 'strider-hiryu', name: 'Strider Hiryu', moveCount: 10 },
      { id: 'super-skrull', name: 'Super-Skrull', moveCount: 11 },
      { id: 'taskmaster', name: 'Taskmaster', moveCount: 11 },
      { id: 'thor', name: 'Thor', moveCount: 10 },
      { id: 'trish', name: 'Trish', moveCount: 11 },
      { id: 'tron-bonne', name: 'Tron Bonne', moveCount: 11 },
      { id: 'vergil', name: 'Vergil', moveCount: 12 },
      { id: 'viewtiful-joe', name: 'Viewtiful Joe', moveCount: 11 },
      { id: 'war-machine', name: 'War Machine', moveCount: 12 },
      { id: 'wesker', name: 'Wesker', moveCount: 10 },
      { id: 'wolverine', name: 'Wolverine', moveCount: 12 },
      { id: 'x-23', name: 'X-23', moveCount: 11 },
      { id: 'zero', name: 'Zero', moveCount: 10 }
    ],
...
rosterCount: 25,
    ...
    systemMechanics: [
        ...
        characters: [
      { id: 'cyrax', name: 'Cyrax', moveCount: 11 },
      { id: 'ermac', name: 'Ermac', moveCount: 9 },
      { id: 'jade', name: 'Jade', moveCount: 12 },
      { id: 'jax', name: 'Jax', moveCount: 13 },
      { id: 'kabal', name: 'Kabal', moveCount: 9 },
      { id: 'kano', name: 'Kano', moveCount: 11 },
      { id: 'kitana', name: 'Kitana', moveCount: 9 },
      { id: 'kung-lao', name: 'Kung Lao', moveCount: 10 },
      { id: 'liu-kang', name: 'Liu Kang', moveCount: 10 },
      { id: 'mileena', name: 'Mileena', moveCount: 9 },
      { id: 'nightwolf', name: 'Nightwolf', moveCount: 10 },
      { id: 'rain', name: 'Rain', moveCount: 12 },
      { id: 'reptile', name: 'Reptile', moveCount: 12 },
      { id: 'scorpion', name: 'Scorpion', moveCount: 9 },
      { id: 'sektor', name: 'Sektor', moveCount: 9 },
      { id: 'shang-tsung', name: 'Shang Tsung', moveCount: 10 },
      { id: 'sheeva', name: 'Sheeva', moveCount: 9 },
      { id: 'sindel', name: 'Sindel', moveCount: 12 },
      { id: 'smoke', name: 'Smoke', moveCount: 10 },
      { id: 'sonya-blade', name: 'Sonya Blade', moveCount: 11 },
      { id: 'stryker', name: 'Stryker', moveCount: 10 },
      { id: 'sub-zero', name: 'Sub-Zero', moveCount: 12 }
    ],
...
rosterCount: 41,
    ...
    characters: [
      { id: 'abel', name: 'Abel', moveCount: 16 },
      { id: 'adon', name: 'Adon', moveCount: 12 },
      { id: 'akuma', name: 'Akuma', moveCount: 13 },
      { id: 'balrog', name: 'Balrog', moveCount: 12 },
      { id: 'blanka', name: 'Blanka', moveCount: 13 },
      { id: 'cammy', name: 'Cammy', moveCount: 13 },
      { id: 'chun-li', name: 'Chun-Li', moveCount: 14 },
      { id: 'cody', name: 'Cody', moveCount: 16 },
      { id: 'dan', name: 'Dan', moveCount: 12 },
      { id: 'decapre', name: 'Decapre', moveCount: 16 },
      { id: 'dee-jay', name: 'Dee Jay', moveCount: 12 },
      { id: 'dhalsim', name: 'Dhalsim', moveCount: 12 },
      { id: 'e-honda', name: 'E. Honda', moveCount: 13 },
      { id: 'el-fuerte', name: 'El Fuerte', moveCount: 15 },
      { id: 'elena', name: 'Elena', moveCount: 15 },
      { id: 'evil-ryu', name: 'Evil Ryu', moveCount: 17 },
      { id: 'fei-long', name: 'Fei Long', moveCount: 11 },
      { id: 'gen', name: 'Gen', moveCount: 14 },
      { id: 'gouken', name: 'Gouken', moveCount: 14 },
      { id: 'guile', name: 'Guile', moveCount: 12 },
      { id: 'guy', name: 'Guy', moveCount: 16 },
      { id: 'hugo', name: 'Hugo', moveCount: 16 },
      { id: 'ibuki', name: 'Ibuki', moveCount: 13 },
      { id: 'juri', name: 'Juri', moveCount: 14 },
      { id: 'ken', name: 'Ken', moveCount: 14 },
      { id: 'm-bison', name: 'M. Bison', moveCount: 15 },
      { id: 'makoto', name: 'Makoto', moveCount: 16 },
      { id: 'oni', name: 'Oni', moveCount: 16 },
      { id: 'poison', name: 'Poison', moveCount: 13 },
      { id: 'rolento', name: 'Rolento', moveCount: 16 },
      { id: 'rose', name: 'Rose', moveCount: 13 },
      { id: 'rufus', name: 'Rufus', moveCount: 14 },
      { id: 'ryu', name: 'Ryu', moveCount: 17 },
      { id: 'sagat', name: 'Sagat', moveCount: 13 },
      { id: 'sakura', name: 'Sakura', moveCount: 13 },
      { id: 'seth', name: 'Seth', moveCount: 13 },
      { id: 't-hawk', name: 'T. Hawk', moveCount: 12 },
      { id: 'vega', name: 'Vega', moveCount: 13 },
      { id: 'yang', name: 'Yang', moveCount: 16 },
      { id: 'yun', name: 'Yun', moveCount: 17 },
      { id: 'zangief', name: 'Zangief', moveCount: 12 }
    ],
...

  {
    ...
    characters: [
      { id: 'hyde', name: 'Hyde', moveCount: 14 },
      { id: 'linne', name: 'Linne', moveCount: 13 },
      { id: 'waldstein', name: 'Waldstein', moveCount: 13 },
      { id: 'carmine', name: 'Carmine', moveCount: 14 },
      { id: 'orie', name: 'Orie', moveCount: 13 },
      { id: 'gordeau', name: 'Gordeau', moveCount: 12 },
      { id: 'merkava', name: 'Merkava', moveCount: 13 },
      { id: 'vatista', name: 'Vatista', moveCount: 13 },
      { id: 'seth', name: 'Seth', moveCount: 13 },
      { id: 'yuzuriha', name: 'Yuzuriha', moveCount: 11 },
      { id: 'hilda', name: 'Hilda', moveCount: 13 },
      { id: 'eltnum', name: 'Eltnum', moveCount: 13 },
      { id: 'chaos', name: 'Chaos', moveCount: 12 },
      { id: 'nanase', name: 'Nanase', moveCount: 12 },
      { id: 'byakuya', name: 'Byakuya', moveCount: 12 },
      { id: 'phonon', name: 'Phonon', moveCount: 12 },
      { id: 'mika', name: 'Mika', moveCount: 12 },
      { id: 'enkidu', name: 'Enkidu', moveCount: 12 },
      { id: 'wagner', name: 'Wagner', moveCount: 12 },
      { id: 'londrekia', name: 'Londrekia', moveCount: 12 },
      { id: 'tsurugi', name: 'Tsurugi', moveCount: 12 },
      { id: 'kaguya', name: 'Kaguya', moveCount: 13 },
      { id: 'kuon', name: 'Kuon', moveCount: 12 },
      { id: 'uzuki', name: 'Uzuki', moveCount: 12 },
      { id: 'ogre', name: 'Ogre', moveCount: 12 },
      { id: 'izumi', name: 'Izumi', moveCount: 12 }
    ],
...

  {
    ...
    characters: [
      { id: 'demitri', name: 'Demitri', moveCount: 0 },
      { id: 'morrigan', name: 'Morrigan', moveCount: 0 },
      { id: 'jon-talbain', name: 'Jon Talbain', moveCount: 23 },
      { id: 'lord-raptor', name: 'Lord Raptor', moveCount: 0 },
      { id: 'victor', name: 'Victor', moveCount: 21 },
      { id: 'rikuo', name: 'Rikuo', moveCount: 21 },
      { id: 'sasquatch', name: 'Sasquatch', moveCount: 8 },
      { id: 'anakaris', name: 'Anakaris', moveCount: 0 },
      { id: 'bishamon', name: 'Bishamon', moveCount: 8 },
      ...
      { id: 'hutzil', name: 'Hutzil', moveCount: 0 },
      { id: 'pyron', name: 'Pyron', moveCount: 13 }
    ],
...

  {
    ...
    characters: [
      { id: 'demitri', name: 'Demitri', moveCount: 15 },
      { id: 'morrigan', name: 'Morrigan', moveCount: 15 },
      { id: 'jon-talbain', name: 'Jon Talbain', moveCount: 14 },
      { id: 'lord-raptor', name: 'Lord Raptor', moveCount: 14 },
      { id: 'victor', name: 'Victor', moveCount: 14 },
      { id: 'rikuo', name: 'Rikuo', moveCount: 23 },
      { id: 'sasquatch', name: 'Sasquatch', moveCount: 29 },
      { id: 'anakaris', name: 'Anakaris', moveCount: 31 },
      { id: 'bishamon', name: 'Bishamon', moveCount: 27 },
      { id: 'felicia', name: 'Felicia', moveCount: 15 },
      { id: 'jedah', name: 'Jedah', moveCount: 35 },
      { id: 'q-bee', name: 'Q Bee', moveCount: 28 },
      { id: 'bb-hood', name: 'Bb Hood', moveCount: 16 },
      { id: 'lilith', name: 'Lilith', moveCount: 28 },
...

  {
    ...
    characters: [
      { id: 'demitri', name: 'Demitri', moveCount: 15 },
      { id: 'morrigan', name: 'Morrigan', moveCount: 8 },
      { id: 'jon-talbain', name: 'Jon Talbain', moveCount: 13 },
      { id: 'lord-raptor', name: 'Lord Raptor', moveCount: 14 },
      { id: 'victor', name: 'Victor', moveCount: 14 },
      { id: 'rikuo', name: 'Rikuo', moveCount: 13 },
      { id: 'sasquatch', name: 'Sasquatch', moveCount: 8 },
      { id: 'anakaris', name: 'Anakaris', moveCount: 14 },
      { id: 'bishamon', name: 'Bishamon', moveCount: 14 },
      { id: 'felicia', name: 'Felicia', moveCount: 15 },
      { id: 'jedah', name: 'Jedah', moveCount: 2 },
      { id: 'q-bee', name: 'Q Bee', moveCount: 13 },
      { id: 'bb-hood', name: 'Bb Hood', moveCount: 16 },
      { id: 'lilith', name: 'Lilith', moveCount: 14 },
      { id: 'donovan', name: 'Donovan', moveCount: 0 },
      { id: 'hutzil', name: 'Hutzil', moveCount: 0 },
      { id: 'pyron', name: 'Pyron', moveCount: 0 }
    ],
...

  {
    ...
    systemMechanics: [
        ...
        characters: [
      { id: 'akira', name: 'Akira', moveCount: 16 },
      { id: 'jacky', name: 'Jacky', moveCount: 22 },
      { id: 'jeffry', name: 'Jeffry', moveCount: 21 },
      { id: 'kage', name: 'Kage', moveCount: 12 },
      { id: 'lau', name: 'Lau', moveCount: 19 },
      { id: 'pai', name: 'Pai', moveCount: 19 },
      { id: 'sarah', name: 'Sarah', moveCount: 20 },
      { id: 'wolf', name: 'Wolf', moveCount: 20 }
    ],
...
rosterCount: 10,
    ...
    systemMechanics: [
        ...
        characters: [
      { id: 'akira', name: 'Akira', moveCount: 17 },
      { id: 'jacky', name: 'Jacky', moveCount: 20 },
      { id: 'jeffry', name: 'Jeffry', moveCount: 17 },
      { id: 'kage', name: 'Kage', moveCount: 8 },
      { id: 'lau', name: 'Lau', moveCount: 15 },
      { id: 'lion', name: 'Lion', moveCount: 8 },
      { id: 'pai', name: 'Pai', moveCount: 16 },
      { id: 'sarah', name: 'Sarah', moveCount: 15 },
      { id: 'shun', name: 'Shun', moveCount: 7 },
      { id: 'wolf', name: 'Wolf', moveCount: 15 }
    ],
...
rosterCount: 12,
    ...
    systemMechanics: [
        ...
        characters: [
      { id: 'akira', name: 'Akira', moveCount: 18 },
      { id: 'aoi', name: 'Aoi', moveCount: 8 },
      { id: 'jacky', name: 'Jacky', moveCount: 15 },
      { id: 'jeffry', name: 'Jeffry', moveCount: 14 },
      { id: 'kage', name: 'Kage', moveCount: 14 },
      { id: 'lau', name: 'Lau', moveCount: 14 },
      { id: 'lion', name: 'Lion', moveCount: 6 },
      { id: 'pai', name: 'Pai', moveCount: 14 },
      { id: 'sarah', name: 'Sarah', moveCount: 14 },
      { id: 'shun', name: 'Shun', moveCount: 6 },
      { id: 'taka-arashi', name: 'Taka-Arashi', moveCount: 15 },
      { id: 'wolf', name: 'Wolf', moveCount: 14 }
    ],
...
rosterCount: 14,
    ...
    systemMechanics: [
        ...
        characters: [
      { id: 'akira', name: 'Akira', moveCount: 152 },
      { id: 'aoi', name: 'Aoi', moveCount: 8 },
      { id: 'brad', name: 'Brad', moveCount: 16 },
      { id: 'jacky', name: 'Jacky', moveCount: 14 },
      { id: 'jeffry', name: 'Jeffry', moveCount: 13 },
      { id: 'kage', name: 'Kage', moveCount: 13 },
      { id: 'lau', name: 'Lau', moveCount: 12 },
      { id: 'lei-fei', name: 'Lei-Fei', moveCount: 6 },
      { id: 'lion', name: 'Lion', moveCount: 4 },
      { id: 'pai', name: 'Pai', moveCount: 12 },
      { id: 'sarah', name: 'Sarah', moveCount: 5 },
      { id: 'shun', name: 'Shun', moveCount: 4 },
      { id: 'vanessa', name: 'Vanessa', moveCount: 14 },
      { id: 'wolf', name: 'Wolf', moveCount: 13 }
    ],
...
rosterCount: 12,
    ...
    systemMechanics: [
        ...
        characters: [
      { id: 'brider', name: 'Brider', moveCount: 23 },
      { id: 'captain-atlantis', name: 'Captain Atlantis', moveCount: 16 },
      { id: 'fudomaru', name: 'Fudomaru', moveCount: 13 },
      { id: 'gowcaizer', name: 'Gowcaizer', moveCount: 13 },
      { id: 'hellstinger', name: 'Hellstinger', moveCount: 17 },
      { id: 'karin-son', name: 'Karin Son', moveCount: 13 },
      { id: 'kyosuke-shigure', name: 'Kyosuke Shigure', moveCount: 14 },
      { id: 'marion', name: 'Marion', moveCount: 12 },
      { id: 'ohga', name: 'Ohga', moveCount: 12 },
      { id: 'ranryo', name: 'Ran/Ryo', moveCount: 12 },
      { id: 'shaia-hany', name: 'Shaia Hanyū', moveCount: 13 },
      { id: 'shen-long', name: 'Shen Long', moveCount: 12 }
    ],
...
rosterCount: 9,
    ...
    systemMechanics: [
        ...
        characters: [
      { id: 'arina', name: 'Arina', moveCount: 11 },
      { id: 'bonus-kun', name: 'Bonus-Kun', moveCount: 11 },
      { id: 'dandy-j', name: 'Dandy-J', moveCount: 21 },
      { id: 'fernandez', name: 'Fernandez', moveCount: 14 },
      { id: 'mauru', name: 'Mauru', moveCount: 6 },
      { id: 'politank-z', name: 'Politank-Z', moveCount: 21 },
      { id: 'rai', name: 'Rai', moveCount: 14 },
      { id: 'slash', name: 'Slash', moveCount: 15 },
      { id: 'tiptops', name: 'Tiptops', moveCount: 14 }
    ],
...
rosterCount: 8,
    ...
    systemMechanics: [
        ...
        characters: [
      { id: 'crimson-glory', name: 'Crimson Glory', moveCount: 21 },
      { id: 'dragon', name: 'Dragon', moveCount: 18 },
      { id: 'fox', name: 'Fox', moveCount: 11 },
      { id: 'high-five', name: 'High Five', moveCount: 15 },
      { id: 'major-benson', name: 'Major Benson', moveCount: 19 },
      { id: 'ninja', name: 'Ninja', moveCount: 21 },
      { id: 'nobunaga', name: 'Nobunaga', moveCount: 16 },
      { id: 'shogun', name: 'Shogun', moveCount: 20 }
    ],
...
rosterCount: 8,
    ...
    systemMechanics: [
        ...
        characters: [
      { id: 'brocken', name: 'Brocken', moveCount: 11 },
      { id: 'dragon', name: 'Dragon', moveCount: 11 },
      { id: 'fuuma', name: 'Fuuma', moveCount: 5 },
      { id: 'hanzo', name: 'Hanzo', moveCount: 5 },
      { id: 'j-carn', name: 'J. Carn', moveCount: 11 },
      { id: 'janne', name: 'Janne', moveCount: 11 },
      { id: 'muscle-power', name: 'Muscle Power', moveCount: 10 },
      { id: 'rasputin', name: 'Rasputin', moveCount: 11 }
    ],
...
rosterCount: 14,
    ...
    systemMechanics: [
        ...
        characters: [
      { id: 'brocken', name: 'Brocken', moveCount: 12 },
      { id: 'captain-kidd', name: 'Captain Kidd', moveCount: 12 },
      { id: 'dragon', name: 'Dragon', moveCount: 12 },
      { id: 'erik', name: 'Erik', moveCount: 12 },
      { id: 'fuuma', name: 'Fuuma', moveCount: 12 },
      { id: 'hanzo', name: 'Hanzo', moveCount: 12 },
      { id: 'j-carn', name: 'J. Carn', moveCount: 11 },
      { id: 'janne', name: 'Janne', moveCount: 11 },
      { id: 'johnny-maximum', name: 'Johnny Maximum', moveCount: 12 },
      { id: 'mudman', name: 'Mudman', moveCount: 12 },
      { id: 'muscle-power', name: 'Muscle Power', moveCount: 10 },
      { id: 'rasputin', name: 'Rasputin', moveCount: 12 },
      { id: 'ryoko', name: 'Ryoko', moveCount: 11 },
      { id: 'shura', name: 'Shura', moveCount: 12 }
    ],
...
rosterCount: 7,
    ...
    systemMechanics: [
      ...
      { id: 'hanzo', name: 'Hanzo', moveCount: 12 },
      { id: 'jack', name: 'Jack', moveCount: 12 },
      { id: 'ryofu', name: 'Ryofu', moveCount: 11 },
      { id: 'zeus', name: 'Zeus', moveCount: 10 }
    ],
...
rosterCount: 7,
    ...
    systemMechanics: [
        ...
        characters: [
      { id: 'dio', name: 'Dio', moveCount: 12 },
      { id: 'fuuma', name: 'Fuuma', moveCount: 15 },
      { id: 'hanzo', name: 'Hanzo', moveCount: 15 },
      { id: 'mudman', name: 'Mudman', moveCount: 12 },
      { id: 'ryoko', name: 'Ryoko', moveCount: 11 },
      { id: 'son-goku', name: 'Son Goku', moveCount: 12 },
      { id: 'zeus', name: 'Zeus', moveCount: 11 }
    ],
...
rosterCount: 18,
    ...
    characters: [
      { id: 'cyclops', name: 'Cyclops', moveCount: 14 },
      { id: 'wolverine', name: 'Wolverine', moveCount: 14 },
      { id: 'storm', name: 'Storm', moveCount: 19 },
      { id: 'rogue', name: 'Rogue', moveCount: 16 },
      { id: 'gambit', name: 'Gambit', moveCount: 14 },
      { id: 'sabretooth', name: 'Sabretooth', moveCount: 6 },
      { id: 'juggernaut', name: 'Juggernaut', moveCount: 18 },
      { id: 'magneto', name: 'Magneto', moveCount: 20 },
      { id: 'ryu', name: 'Ryu', moveCount: 14 },
      { id: 'ken', name: 'Ken', moveCount: 13 },
      { id: 'chun-li', name: 'Chun Li', moveCount: 15 },
      { id: 'dhalsim', name: 'Dhalsim', moveCount: 31 },
      { id: 'zangief', name: 'Zangief', moveCount: 12 },
      { id: 'mbison', name: 'Mbison', moveCount: 0 },
      { id: 'cammy', name: 'Cammy', moveCount: 17 },
      { id: 'charlie', name: 'Charlie', moveCount: 8 },
      { id: 'akuma', name: 'Akuma', moveCount: 13 }
    ],
...
rosterCount: 12,
    ...
    characters: [
      { id: 'wolverine', name: 'Wolverine', moveCount: 12 },
      { id: 'cyclops', name: 'Cyclops', moveCount: 13 },
      { id: 'storm', name: 'Storm', moveCount: 9 },
      { id: 'iceman', name: 'Iceman', moveCount: 7 },
      { id: 'colossus', name: 'Colossus', moveCount: 11 },
      { id: 'psylocke', name: 'Psylocke', moveCount: 18 },
      { id: 'omega-red', name: 'Omega Red', moveCount: 20 },
      { id: 'sentinel', name: 'Sentinel', moveCount: 18 },
      { id: 'silver-samurai', name: 'Silver Samurai', moveCount: 11 },
      { id: 'spiral', name: 'Spiral', moveCount: 17 },
      { id: 'juggernaut', name: 'Juggernaut', moveCount: 19 },
      { id: 'magneto', name: 'Magneto', moveCount: 12 },
...
rosterCount: 8,
    ...
    systemMechanics: [
        ...
        characters: [
      { id: 'cybershell', name: 'Cybershell', moveCount: 14 },
      { id: 'draco', name: 'Draco', moveCount: 14 },
      { id: 'eos', name: 'Eos', moveCount: 12 },
      { id: 'galdon', name: 'Galdon', moveCount: 14 },
      { id: 'nereid', name: 'Nereid', moveCount: 14 },
      { id: 'tau', name: 'Tau', moveCount: 16 },
      { id: 'wild-3', name: 'Wild 3', moveCount: 14 },
      { id: 'zero', name: 'Zero', moveCount: 20 }
    ],
...
rosterCount: 8,
  ...
  },
  {
    ...
    searchAliases: ['budokai 3'],
        systemMechanics: [
        { name: "Hyper Mode", description: "Transform into a powered-up state. Enables Ultimate moves and increases speed/damage." },
        { name: "Dragon Rush", description: "Rock-paper-scissors clash system. Win the exchange to deal damage or start combos." },
        { name: "Teleport Counter", description: "Spend Ki to teleport behind an attacking opponent and counter.", input: "Forward + Guard (on hit)" },
        { name: "Ki Charge", description: "Hold to charge Ki gauge. Powers supers, teleports, and transformations." },
        { name: "Ultimate Move", description: "Devastating finisher requiring Hyper Mode and full Ki. Cinematic sequence." },
    ],
    characters: [
      { id: 'adult', name: 'Adult)', moveCount: 3 },
      { id: 'android-16', name: 'Android 16', moveCount: 3 },
      { id: 'android-17', name: 'Android 17', moveCount: 3 },
      { id: 'android-18', name: 'Android 18', moveCount: 4 },
      { id: 'bardock', name: 'Bardock', moveCount: 4 },
      { id: 'broly', name: 'Broly', moveCount: 3 },
      { id: 'captain-ginyu', name: 'Captain Ginyu', moveCount: 3 },
      { id: 'cell', name: 'Cell', moveCount: 6 },
      { id: 'cooler', name: 'Cooler', moveCount: 3 },
      { id: 'dabura', name: 'Dabura', moveCount: 3 },
      { id: 'dr-gero', name: 'Dr. Gero', moveCount: 3 },
      { id: 'frieza', name: 'Frieza', moveCount: 3 },
      { id: 'gohan-kid', name: 'Gohan (Kid', moveCount: 3 },
      { id: 'goku', name: 'Goku', moveCount: 4 },
      { id: 'goten', name: 'Goten', moveCount: 3 },
      { id: 'gotenks', name: 'Gotenks', moveCount: 6 },
      { id: 'hercule', name: 'Hercule', moveCount: 3 },
      { id: 'kid-buu', name: 'Kid Buu', moveCount: 5 },
      { id: 'kid-trunks', name: 'Kid Trunks', moveCount: 3 },
      { id: 'krillin', name: 'Krillin', moveCount: 5 },
      { id: 'majin-buu', name: 'Majin Buu', moveCount: 5 },
      { id: 'nappa', name: 'Nappa', moveCount: 3 },
      { id: 'omega-shenron', name: 'Omega Shenron', moveCount: 3 },
      { id: 'piccolo', name: 'Piccolo', moveCount: 3 },
      { id: 'raditz', name: 'Raditz', moveCount: 3 },
      { id: 'recoome', name: 'Recoome', moveCount: 3 },
      { id: 'saibaman', name: 'Saibaman', moveCount: 2 },
      { id: 'super-buu', name: 'Super Buu', moveCount: 5 },
      { id: 'supreme-kai', name: 'Supreme Kai', moveCount: 3 },
      { id: 'teen', name: 'Teen', moveCount: 4 },
      { id: 'tien-shinhan', name: 'Tien Shinhan', moveCount: 4 },
      { id: 'trunks-future', name: 'Trunks (Future)', moveCount: 6 },
      { id: 'uub', name: 'Uub', moveCount: 3 },
      { id: 'vegeta', name: 'Vegeta', moveCount: 3 },
      { id: 'vegito', name: 'Vegito', moveCount: 3 },
      { id: 'videl', name: 'Videl', moveCount: 3 },
      { id: 'yamcha', name: 'Yamcha', moveCount: 3 }
    ],
    tabs: ['Special Moves', 'Super Combos', 'Finishers', 'Unique Attacks', 'Normal Moves', 'Command Throws', 'Normal Throws', 'Common Moves']
  },
  {
    ...
    characters: [
      { id: 'android-13', name: 'Android 13', moveCount: 1 },
      { id: 'android-16', name: 'Android 16', moveCount: 1 },
      { id: 'android-17', name: 'Android 17', moveCount: 1 },
      { id: 'android-18', name: 'Android 18', moveCount: 4 },
      { id: 'android-19', name: 'Android 19', moveCount: 4 },
      { id: 'appule', name: 'Appule', moveCount: 5 },
      { id: 'baby-vegeta', name: 'Baby Vegeta', moveCount: 1 },
      { id: 'babidi', name: 'Babidi', moveCount: 5 },
      { id: 'bardock', name: 'Bardock', moveCount: 1 },
      { id: 'bojack', name: 'Bojack', moveCount: 5 },
      { id: 'broly', name: 'Broly', moveCount: 1 },
      { id: 'burter', name: 'Burter', moveCount: 1 },
      { id: 'cell', name: 'Cell', moveCount: 1 },
      { id: 'cell-jr', name: 'Cell Jr', moveCount: 1 },
      { id: 'chiaotzu', name: 'Chiaotzu', moveCount: 5 },
      { id: 'cooler', name: 'Cooler', moveCount: 5 },
      { id: 'cui', name: 'Cui', moveCount: 5 },
      { id: 'dabura', name: 'Dabura', moveCount: 1 },
      { id: 'demon-king-piccolo', name: 'Demon King Piccolo', moveCount: 6 },
      { id: 'devilman', name: 'Devilman', moveCount: 5 },
      { id: 'dr-gero', name: 'Dr. Gero', moveCount: 5 },
      { id: 'dr-wheelo', name: 'Dr. Wheelo', moveCount: 5 },
      { id: 'dodoria', name: 'Dodoria', moveCount: 5 },
      { id: 'fasha', name: 'Fasha', moveCount: 5 },
      { id: 'frieza', name: 'Frieza', moveCount: 1 },
      { id: 'garlic-jr', name: 'Garlic Jr.', moveCount: 1 },
      { id: 'general-blue', name: 'General Blue', moveCount: 6 },
      { id: 'ginyu', name: 'Ginyu', moveCount: 5 },
      { id: 'gohan-kid', name: 'Gohan (Kid)', moveCount: 3 },
      { id: 'gohan-teen', name: 'Gohan (Teen)', moveCount: 5 },
      { id: 'gohan-adult', name: 'Gohan (Adult)', moveCount: 5 },
      { id: 'gohan-future', name: 'Gohan (Future)', moveCount: 5 },
      { id: 'goku-kid', name: 'Goku (Kid)', moveCount: 1 },
      { id: 'goku-early', name: 'Goku (Early)', moveCount: 5 },
      { id: 'goku-mid', name: 'Goku (Mid)', moveCount: 5 },
      { id: 'goku-end', name: 'Goku (End)', moveCount: 5 },
      { id: 'goku-gt', name: 'Goku (GT)', moveCount: 5 },
      { id: 'goten', name: 'Goten', moveCount: 5 },
      { id: 'gotenks', name: 'Gotenks', moveCount: 6 },
      { id: 'grandpa-gohan', name: 'Grandpa Gohan', moveCount: 4 },
      { id: 'great-ape', name: 'Great Ape', moveCount: 5 },
      { id: 'guldo', name: 'Guldo', moveCount: 5 },
      { id: 'hercule', name: 'Hercule', moveCount: 5 },
      { id: 'hirudegarn', name: 'Hirudegarn', moveCount: 5 },
      { id: 'janemba', name: 'Janemba', moveCount: 5 },
      { id: 'jeice', name: 'Jeice', moveCount: 5 },
      { id: 'kid-buu', name: 'Kid Buu', moveCount: 1 },
      { id: 'kid-chi-chi', name: 'Kid Chi-Chi', moveCount: 3 },
      { id: 'king-cold', name: 'King Cold', moveCount: 5 },
      { id: 'king-vegeta', name: 'King Vegeta', moveCount: 3 },
      { id: 'krillin', name: 'Krillin', moveCount: 5 },
      { id: 'lord-slug', name: 'Lord Slug', moveCount: 5 },
      { id: 'majin-buu', name: 'Majin Buu', moveCount: 5 },
      { id: 'master-roshi', name: 'Master Roshi', moveCount: 5 },
      { id: 'mecha-frieza', name: 'Mecha Frieza', moveCount: 5 },
      { id: 'meta-cooler', name: 'Meta-Cooler', moveCount: 3 },
      { id: 'monster-zarbon', name: 'Monster Zarbon', moveCount: 5 },
      { id: 'nappa', name: 'Nappa', moveCount: 5 },
      { id: 'nail', name: 'Nail', moveCount: 5 },
      { id: 'nuova-shenron', name: 'Nuova Shenron', moveCount: 5 },
      { id: 'omega-shenron', name: 'Omega Shenron', moveCount: 5 },
      { id: 'pan', name: 'Pan', moveCount: 5 },
      { id: 'piccolo', name: 'Piccolo', moveCount: 6 },
      { id: 'pikkon', name: 'Pikkon', moveCount: 5 },
      { id: 'pilaf-machine', name: 'Pilaf Machine', moveCount: 5 },
      { id: 'raditz', name: 'Raditz', moveCount: 5 },
      { id: 'recoome', name: 'Recoome', moveCount: 5 },
      { id: 'saibaman', name: 'Saibaman', moveCount: 5 },
      { id: 'salza', name: 'Salza', moveCount: 5 },
      { id: 'spopovitch', name: 'Spopovitch', moveCount: 5 },
      { id: 'super-17', name: 'Super 17', moveCount: 1 },
      { id: 'super-buu', name: 'Super Buu', moveCount: 5 },
      { id: 'supreme-kai', name: 'Supreme Kai', moveCount: 5 },
      { id: 'syn-shenron', name: 'Syn Shenron', moveCount: 5 },
      { id: 'tambourine', name: 'Tambourine', moveCount: 5 },
      { id: 'tao-pai-pai', name: 'Tao Pai Pai', moveCount: 5 },
      { id: 'tapion', name: 'Tapion', moveCount: 5 },
      { id: 'tenshinhan', name: 'Tenshinhan', moveCount: 4 },
      { id: 'trunks-sword', name: 'Trunks (Sword)', moveCount: 6 },
      { id: 'trunks-fighting', name: 'Trunks (Fighting)', moveCount: 5 },
      { id: 'trunks-future', name: 'Trunks (Future)', moveCount: 5 },
      { id: 'trunks-kid', name: 'Trunks (Kid)', moveCount: 5 },
      { id: 'turles', name: 'Turles', moveCount: 5 },
      { id: 'ultimate-gohan', name: 'Ultimate Gohan', moveCount: 4 },
      { id: 'uub', name: 'Uub', moveCount: 5 },
      { id: 'vegeta-scouter', name: 'Vegeta (Scouter)', moveCount: 1 },
      { id: 'vegeta-early', name: 'Vegeta (Early)', moveCount: 5 },
      { id: 'vegeta-mid', name: 'Vegeta (Mid)', moveCount: 5 },
      { id: 'vegeta-end', name: 'Vegeta (End)', moveCount: 5 },
      { id: 'vegeta-gt', name: 'Vegeta (GT)', moveCount: 5 },
      { id: 'vegito', name: 'Vegito', moveCount: 3 },
      { id: 'videl', name: 'Videl', moveCount: 5 },
      { id: 'yajirobe', name: 'Yajirobe', moveCount: 5 },
      { id: 'yamcha', name: 'Yamcha', moveCount: 3 },
      { id: 'zangya', name: 'Zangya', moveCount: 5 }
    ],
    tabs: ['Special Moves', 'Super Combos', 'Finishers', 'Unique Attacks', 'Normal Moves', 'Command Throws', 'Normal Throws', 'Common Moves']
  },
  {
    ...
    developer: 'Arc System Works',
        systemMechanics: [
        { name: "Real-Time Strategy", description: "Hybrid action/RTS. Command troops and capture objectives while fighting directly." },
        { name: "Organ System", description: "Capture Organs (control points) to generate Mana and summon units." },
        { name: "Servant Units", description: "Summon AI-controlled soldiers to attack enemy Organs and Masters." },
        { name: "Clash", description: "Direct 1v1 combat between Masters using melee combos and special abilities." },
    ],
    characters: [
      { id: 'dr-paradigm', name: 'Dr. Paradigm', moveCount: 8 },
      { id: 'izuna', name: 'Izuna', moveCount: 7 },
      { id: 'ky-kiske', name: 'Ky Kiske', moveCount: 9 },
      { id: 'raven', name: 'Raven', moveCount: 7 },
      { id: 'sin-kiske', name: 'Sin Kiske', moveCount: 9 },
      { id: 'sol-badguy', name: 'Sol Badguy', moveCount: 9 },
      { id: 'valentine', name: 'Valentine', moveCount: 5 }
    ],
    tabs: ['Special Moves', 'Super Combos', 'Finishers', 'Unique Attacks', 'Normal Moves', 'Command Throws', 'Normal Throws', 'Common Moves']
  },
  {
    ...
    characters: [
      { id: 'axl', name: 'Axl', moveCount: 0 },
      { id: 'bedman', name: 'Bedman', moveCount: 7 },
      { id: 'chipp', name: 'Chipp', moveCount: 0 },
      { id: 'elphelt', name: 'Elphelt', moveCount: 0 },
      { id: 'faust', name: 'Faust', moveCount: 4 },
      { id: 'i-no', name: 'I-No', moveCount: 6 },
      { id: 'ky', name: 'Ky', moveCount: 0 },
      { id: 'leo', name: 'Leo', moveCount: 0 },
      { id: 'may', name: 'May', moveCount: 6 },
      { id: 'millia', name: 'Millia', moveCount: 0 },
      { id: 'potemkin', name: 'Potemkin', moveCount: 10 },
      { id: 'ramlethal', name: 'Ramlethal', moveCount: 0 },
      { id: 'sin', name: 'Sin', moveCount: 0 },
      { id: 'slayer', name: 'Slayer', moveCount: 5 },
      { id: 'sol', name: 'Sol', moveCount: 0 },
      { id: 'venom', name: 'Venom', moveCount: 7 },
      { id: 'zato-1', name: 'Zato-1', moveCount: 7 }
    ],
    tabs: ['Special Moves', 'Super Combos', 'Finishers', 'Unique Attacks', 'Normal Moves', 'Command Throws', 'Normal Throws', 'Common Moves']
  },
  {
    ...
    links: [
      { title: 'SuperCombo Wiki', url: 'https://wiki.supercombo.gg/' },
        ...
        systemMechanics: [
        { name: "Character Power", description: "Unique ability per character activated with a dedicated button. Defines each hero's playstyle.", input: "Character Power button" },
        { name: "Super Move", description: "Cinematic super attack using full meter. Unblockable startup on some, massive damage." },
        { name: "Clash System", description: "Wager meter during a combo to either heal (defender) or deal bonus damage (attacker)." },
        { name: "Stage Interactions", description: "Use environmental objects as weapons or escape tools. Varies by stage and character class." },
        { name: "Meter Burn", description: "Spend one bar to enhance special moves with additional hits, armor, or properties.", input: "MB (during special)" },
        { name: "Bounce Cancel", description: "Spend meter to wall/ground bounce for combo extensions.", input: "MB (during specific moves)" },
    ],
    characters: [
      { id: 'aquaman', name: 'Aquaman', moveCount: 11 },
      { id: 'ares', name: 'Ares', moveCount: 10 },
      { id: 'bane', name: 'Bane', moveCount: 10 },
      { id: 'batgirl', name: 'Batgirl', moveCount: 10 },
      { id: 'batman', name: 'Batman', moveCount: 12 },
      { id: 'black-adam', name: 'Black Adam', moveCount: 10 },
      { id: 'catwoman', name: 'Catwoman', moveCount: 10 },
      { id: 'cyborg', name: 'Cyborg', moveCount: 10 },
      { id: 'deathstroke', name: 'Deathstroke', moveCount: 10 },
      { id: 'doomsday', name: 'Doomsday', moveCount: 10 },
      { id: 'flash', name: 'Flash', moveCount: 10 },
      { id: 'general-zod', name: 'General Zod', moveCount: 10 },
      { id: 'green-arrow', name: 'Green Arrow', moveCount: 11 },
      { id: 'green-lantern', name: 'Green Lantern', moveCount: 11 },
      { id: 'harley-quinn', name: 'Harley Quinn', moveCount: 11 },
      { id: 'hawkgirl', name: 'Hawkgirl', moveCount: 10 },
      { id: 'joker', name: 'Joker', moveCount: 10 },
      { id: 'killer-frost', name: 'Killer Frost', moveCount: 10 },
      { id: 'lex-luther', name: 'Lex Luther', moveCount: 10 },
      { id: 'lobo', name: 'Lobo', moveCount: 10 },
      { id: 'martian-manhunter', name: 'Martian Manhunter', moveCount: 10 },
      { id: 'nightwing', name: 'Nightwing', moveCount: 11 },
      { id: 'raven', name: 'Raven', moveCount: 10 },
      { id: 'scorpion', name: 'Scorpion', moveCount: 10 },
      { id: 'shazam', name: 'Shazam', moveCount: 10 },
      { id: 'sinestro', name: 'Sinestro', moveCount: 10 },
      { id: 'solomon-grundy', name: 'Solomon Grundy', moveCount: 10 },
      { id: 'superman', name: 'Superman', moveCount: 12 },
      { id: 'wonder-woman', name: 'Wonder Woman', moveCount: 11 },
      { id: 'zatanna', name: 'Zatanna', moveCount: 10 }
    ],
    tabs: ['Special Moves', 'Super Combos', 'Finishers', 'Unique Attacks', 'Normal Moves', 'Command Throws', 'Normal Throws', 'Common Moves']
  },
  {
    ...
    characters: [
      { id: 'aquaman', name: 'Aquaman', moveCount: 37 },
      { id: 'atrocitus', name: 'Atrocitus', moveCount: 47 },
      { id: 'bane', name: 'Bane', moveCount: 45 },
      { id: 'batman', name: 'Batman', moveCount: 48 },
      { id: 'black-adam', name: 'Black Adam', moveCount: 46 },
      { id: 'black-canary', name: 'Black Canary', moveCount: 52 },
      { id: 'black-manta', name: 'Black Manta', moveCount: 58 },
      { id: 'blue-beetle', name: 'Blue Beetle', moveCount: 44 },
      { id: 'brainiac', name: 'Brainiac', moveCount: 43 },
      { id: 'captain-cold', name: 'Captain Cold', moveCount: 38 },
      { id: 'catwoman', name: 'Catwoman', moveCount: 59 },
      { id: 'cheetah', name: 'Cheetah', moveCount: 49 },
      { id: 'cyborg', name: 'Cyborg', moveCount: 47 },
      { id: 'darkseid', name: 'Darkseid', moveCount: 50 },
      { id: 'deadshot', name: 'Deadshot', moveCount: 44 },
      { id: 'doctor-fate', name: 'Doctor Fate', moveCount: 50 },
      { id: 'donatello', name: 'Donatello', moveCount: 9 },
      { id: 'enchantress', name: 'Enchantress', moveCount: 46 },
      { id: 'firestorm', name: 'Firestorm', moveCount: 44 },
      { id: 'flash', name: 'Flash', moveCount: 10 },
      { id: 'gorilla-grodd', name: 'Gorilla Grodd', moveCount: 55 },
      { id: 'green-arrow', name: 'Green Arrow', moveCount: 49 },
      { id: 'green-lantern', name: 'Green Lantern', moveCount: 43 },
      { id: 'harley-quinn', name: 'Harley Quinn', moveCount: 54 },
      { id: 'hellboy', name: 'Hellboy', moveCount: 57 },
      { id: 'joker', name: 'Joker', moveCount: 44 },
      { id: 'leonardo', name: 'Leonardo', moveCount: 9 },
      { id: 'michelangelo', name: 'Michelangelo', moveCount: 9 },
      { id: 'poison-ivy', name: 'Poison Ivy', moveCount: 49 },
      { id: 'raiden', name: 'Raiden', moveCount: 51 },
      { id: 'raphael', name: 'Raphael', moveCount: 9 },
      { id: 'red-hood', name: 'Red Hood', moveCount: 67 },
      { id: 'robin', name: 'Robin', moveCount: 61 },
      { id: 'scarecrow', name: 'Scarecrow', moveCount: 47 },
      { id: 'starfire', name: 'Starfire', moveCount: 46 },
      { id: 'sub-zero', name: 'Sub-Zero', moveCount: 46 },
      { id: 'supergirl', name: 'Supergirl', moveCount: 48 },
      { id: 'superman', name: 'Superman', moveCount: 43 },
      { id: 'swamp-thing', name: 'Swamp Thing', moveCount: 51 },
      { id: 'wonder-woman', name: 'Wonder Woman', moveCount: 44 }
    ],
    tabs: ['Special Moves', 'Super Combos', 'Finishers', 'Unique Attacks', 'Normal Moves', 'Command Throws', 'Normal Throws', 'Common Moves']
  },
  {
    ...
    links: [
      { title: 'SuperCombo Wiki', url: 'https://wiki.supercombo.gg/' },
        ...
        systemMechanics: [
        { name: "Run", description: "Sprint toward the opponent for aggressive pressure. Uses Run meter.", input: "Forward, Forward, Block" },
        { name: "Dial-A-Combo", description: "Pre-programmed combo strings entered as button sequences. Core combo system of MK3." },
        { name: "Mercy", description: "Give your defeated opponent a small amount of health back. Required to perform Animalities." },
        { name: "Animality", description: "Transform into an animal to finish your opponent. Requires Mercy first." },
        { name: "Brutality", description: "Perform a long combo string to explode the opponent into pieces." },
        { name: "Fatality", description: "Signature finishing move performed after winning the final round." },
    ],
    characters: [
      { id: 'cyrax', name: 'Cyrax', moveCount: 13 },
      { id: 'jax', name: 'Jax', moveCount: 11 },
  ...
  },
  {
    ...
    characters: [
      { id: 'fujin', name: 'Fujin', moveCount: 11 },
      { id: 'goro', name: 'Goro', moveCount: 9 },
      { id: 'jarek', name: 'Jarek', moveCount: 11 },
      { id: 'jax', name: 'Jax', moveCount: 11 },
      { id: 'johnny-cage', name: 'Johnny Cage', moveCount: 11 },
      { id: 'kai', name: 'Kai', moveCount: 11 },
      { id: 'liu-kang', name: 'Liu Kang', moveCount: 11 },
      { id: 'meat', name: 'Meat', moveCount: 8 },
      { id: 'noob-saibot', name: 'Noob Saibot', moveCount: 12 },
      { id: 'quan-chi', name: 'Quan Chi', moveCount: 10 },
      { id: 'raiden', name: 'Raiden', moveCount: 12 },
      { id: 'reiko', name: 'Reiko', moveCount: 11 },
      { id: 'reptile', name: 'Reptile', moveCount: 12 },
      { id: 'scorpion', name: 'Scorpion', moveCount: 14 },
      { id: 'shinnok', name: 'Shinnok', moveCount: 11 },
      { id: 'sonya-blade', name: 'Sonya Blade', moveCount: 11 },
      { id: 'sub-zero', name: 'Sub-Zero', moveCount: 13 },
      { id: 'tanya', name: 'Tanya', moveCount: 12 }
    ],
  ...
  },
  {
    ...
    links: [
      { title: 'SuperCombo Wiki', url: 'https://wiki.supercombo.gg/' },
        ...
        systemMechanics: [
        { name: "Fighting Styles", description: "Each character has 3 fighting styles (2 martial arts + 1 weapon). Switch mid-combo for style-branching.", input: "L1/L2" },
        { name: "Style Branching", description: "Cancel a combo string from one style into another for extended combos and mixups." },
        { name: "Impale", description: "Weapon-specific move that leaves the weapon embedded in the opponent, disabling that style." },
        { name: "Power-Up Moves", description: "Enhanced special moves with added properties." },
        { name: "Fatality", description: "Finishing move performed after winning." },
    ],
    characters: [
      { id: 'blaze', name: 'Blaze', moveCount: 9 },
      { id: 'bo-rai-cho', name: 'Bo\' Rai Cho', moveCount: 10 },
      { id: 'cyrax', name: 'Cyrax', moveCount: 11 },
      { id: 'drahmin', name: 'Drahmin', moveCount: 12 },
      { id: 'frost', name: 'Frost', moveCount: 8 },
      { id: 'hsu-hao', name: 'Hsu Hao', moveCount: 8 },
      { id: 'jax', name: 'Jax', moveCount: 9 },
      { id: 'johnny-cage', name: 'Johnny Cage', moveCount: 9 },
      { id: 'kano', name: 'Kano', moveCount: 8 },
      { id: 'kenshi', name: 'Kenshi', moveCount: 9 },
      { id: 'kitana', name: 'Kitana', moveCount: 12 },
      { id: 'kung-lao', name: 'Kung Lao', moveCount: 8 },
      { id: 'li-mei', name: 'Li Mei', moveCount: 9 },
      { id: 'mavado', name: 'Mavado', moveCount: 8 },
      { id: 'mokap', name: 'Mokap', moveCount: 10 },
      { id: 'moloch', name: 'Moloch', moveCount: 8 },
      { id: 'nitara', name: 'Nitara', moveCount: 8 },
      { id: 'quan-chi', name: 'Quan Chi', moveCount: 8 },
      { id: 'raiden', name: 'Raiden', moveCount: 12 },
      { id: 'reptile', name: 'Reptile', moveCount: 8 },
      { id: 'scorpion', name: 'Scorpion', moveCount: 12 },
      { id: 'shang-tsung', name: 'Shang Tsung', moveCount: 8 },
      { id: 'sonya-blade', name: 'Sonya Blade', moveCount: 8 },
      { id: 'sub-zero', name: 'Sub-Zero', moveCount: 12 }
    ],
    tabs: ['Special Moves', 'Super Combos', 'Finishers', 'Unique Attacks', 'Normal Moves', 'Command Throws', 'Normal Throws', 'Common Moves']
  },
  {
    ...
    characters: [
      { id: 'ashrah', name: 'Ashrah', moveCount: 10 },
      { id: 'baraka', name: 'Baraka', moveCount: 9 },
      { id: 'blaze', name: 'Blaze', moveCount: 9 },
      { id: 'chameleon', name: 'Chameleon', moveCount: 11 },
      { id: 'cyrax', name: 'Cyrax', moveCount: 11 },
      { id: 'daegon', name: 'Daegon', moveCount: 10 },
      { id: 'dairou', name: 'Dairou', moveCount: 9 },
      { id: 'darrius', name: 'Darrius', moveCount: 10 },
      { id: 'drahmin', name: 'Drahmin', moveCount: 12 },
      { id: 'ermac', name: 'Ermac', moveCount: 11 },
      { id: 'frost', name: 'Frost', moveCount: 8 },
      { id: 'fujin', name: 'Fujin', moveCount: 11 },
      ...
      { id: 'jarek', name: 'Jarek', moveCount: 11 },
      { id: 'jax', name: 'Jax', moveCount: 9 },
      { id: 'johnny-cage', name: 'Johnny Cage', moveCount: 10 },
      { id: 'kabal', name: 'Kabal', moveCount: 9 },
      { id: 'kai', name: 'Kai', moveCount: 11 },
      { id: 'kano', name: 'Kano', moveCount: 10 },
      { id: 'kenshi', name: 'Kenshi', moveCount: 9 },
      { id: 'khameleon', name: 'Khameleon', moveCount: 9 },
      { id: 'kintaro', name: 'Kintaro', moveCount: 8 },
      { id: 'kira', name: 'Kira', moveCount: 8 },
      { id: 'kitana', name: 'Kitana', moveCount: 12 },
      { id: 'kobra', name: 'Kobra', moveCount: 9 },
      { id: 'kung-lao', name: 'Kung Lao', moveCount: 8 },
      ...
      { id: 'mokap', name: 'Mokap', moveCount: 10 },
      { id: 'moloch', name: 'Moloch', moveCount: 8 },
      { id: 'motaro', name: 'Motaro', moveCount: 9 },
      { id: 'nightwolf', name: 'Nightwolf', moveCount: 8 },
      { id: 'nitara', name: 'Nitara', moveCount: 8 },
      { id: 'noob-saibot', name: 'Noob Saibot', moveCount: 13 },
      { id: 'onaga', name: 'Onaga', moveCount: 8 },
      { id: 'quan-chi', name: 'Quan Chi', moveCount: 8 },
      { id: 'raiden', name: 'Raiden', moveCount: 12 },
      { id: 'rain', name: 'Rain', moveCount: 12 },
      { id: 'reiko', name: 'Reiko', moveCount: 11 },
      { id: 'reptile', name: 'Reptile', moveCount: 8 },
      { id: 'sareena', name: 'Sareena', moveCount: 8 },
      { id: 'scorpion', name: 'Scorpion', moveCount: 12 },
      { id: 'sektor', name: 'Sektor', moveCount: 8 },
      { id: 'shang-tsung', name: 'Shang Tsung', moveCount: 8 },
      { id: 'shao-kahn', name: 'Shao Kahn', moveCount: 8 },
      { id: 'sheeva', name: 'Sheeva', moveCount: 8 },
      { id: 'shinnok', name: 'Shinnok', moveCount: 11 },
      { id: 'shujinko', name: 'Shujinko', moveCount: 11 },
      { id: 'sindel', name: 'Sindel', moveCount: 8 },
      { id: 'smoke', name: 'Smoke', moveCount: 13 },
      { id: 'sonya-blade', name: 'Sonya Blade', moveCount: 8 },
      { id: 'stryker', name: 'Stryker', moveCount: 8 },
      { id: 'sub-zero', name: 'Sub-Zero', moveCount: 12 },
      { id: 'tanya', name: 'Tanya', moveCount: 12 },
      { id: 'taven', name: 'Taven', moveCount: 12 }
    ],
    tabs: ['Special Moves', 'Super Combos', 'Finishers', 'Unique Attacks', 'Normal Moves', 'Command Throws', 'Normal Throws', 'Common Moves']
  },
  {
    ...
    stores: [
      ...
      { platform: 'Nintendo', url: 'https://www.nintendo.com/us/store/products/mortal-kombat-11-switch/' }
        ...
        systemMechanics: [
        { name: "Custom Variations", description: "Build custom movesets from a pool of special moves per character. Defines your playstyle." },
        { name: "Fatal Blow", description: "Comeback super available once per match when health is below 30%. Cinematic and high damage." },
        { name: "Krushing Blow", description: "Specific conditions trigger enhanced versions of certain moves with cinematic X-ray damage. Once per match per move." },
        { name: "Flawless Block", description: "Frame-perfect block timing enables a counterattack. Rewards precise defense.", input: "Block (frame-perfect)" },
        { name: "Getup Attacks", description: "On knockdown, spend meter for invincible reversal or roll escape.", input: "U+2/U+3 (on wakeup)" },
        { name: "Breakaway", description: "Spend meter to break out of an opponent's combo while airborne.", input: "Down (while juggled)" },
    ],
    characters: [
      { id: 'ashrah', name: 'Ashrah', moveCount: 0 },
      { id: 'baraka', name: 'Baraka', moveCount: 6 },
      { id: 'geras', name: 'Geras', moveCount: 6 },
      { id: 'havik', name: 'Havik', moveCount: 0 },
      { id: 'johnny-cage', name: 'Johnny Cage', moveCount: 6 },
      { id: 'kenshi', name: 'Kenshi', moveCount: 0 },
      { id: 'kitana', name: 'Kitana', moveCount: 6 },
      { id: 'kung-lao', name: 'Kung Lao', moveCount: 6 },
      { id: 'li-mei', name: 'Li Mei', moveCount: 0 },
      { id: 'liu-kang', name: 'Liu Kang', moveCount: 10 },
      { id: 'mileena', name: 'Mileena', moveCount: 6 },
      ...
      { id: 'raiden', name: 'Raiden', moveCount: 6 },
      { id: 'rain', name: 'Rain', moveCount: 6 },
      { id: 'reiko', name: 'Reiko', moveCount: 0 },
      { id: 'reptile', name: 'Reptile', moveCount: 0 },
      { id: 'scorpion', name: 'Scorpion', moveCount: 10 },
      { id: 'shang-tsung', name: 'Shang Tsung', moveCount: 6 },
      { id: 'sindel', name: 'Sindel', moveCount: 6 },
      { id: 'smoke', name: 'Smoke', moveCount: 0 },
      { id: 'sub-zero', name: 'Sub Zero', moveCount: 10 },
      ...
      { id: 'noob-saibot', name: 'Noob Saibot', moveCount: 6 },
  ...
  },
  {
    ...
    links: [
      { title: 'SuperCombo Wiki', url: 'https://wiki.supercombo.gg/' },
        ...
        systemMechanics: [
        { name: "8-Way Run", description: "Move freely in 8 directions around the 3D arena. Core movement system for spacing and evasion." },
        { name: "Guard Impact", description: "Parry an incoming attack to create a large frame advantage for punishment.", input: "6+G or 4+G" },
        { name: "Ring Out", description: "Knock opponents out of the arena to win the round instantly." },
        { name: "Soul Charge", description: "Charge to gain a temporary damage boost and access to enhanced attacks.", input: "A+B+K" },
        { name: "Critical Edge", description: "Super move consuming Soul Gauge. High damage cinematic attack." },
    ],
    characters: [
      { id: 'astaroth', name: 'Astaroth', moveCount: 6 },
      { id: 'cervantes', name: 'Cervantes', moveCount: 9 },
      { id: 'edge-master', name: 'Edge Master', moveCount: 9 },
      { id: 'heihachi', name: 'Heihachi', moveCount: 14 },
      { id: 'ivy', name: 'Ivy', moveCount: 6 },
      { id: 'kilik', name: 'Kilik', moveCount: 8 },
      { id: 'lizardman', name: 'Lizardman', moveCount: 13 },
      { id: 'maxi', name: 'Maxi', moveCount: 5 },
      { id: 'mitsurugi', name: 'Mitsurugi', moveCount: 9 },
      { id: 'nightmare', name: 'Nightmare', moveCount: 6 },
      { id: 'seong-mi-na', name: 'Seong Mi Na', moveCount: 10 },
      { id: 'siegfried', name: 'Siegfried', moveCount: 14 },
      { id: 'sophitia', name: 'Sophitia', moveCount: 5 },
      { id: 'taki', name: 'Taki', moveCount: 6 },
      { id: 'voldo', name: 'Voldo', moveCount: 5 },
      { id: 'xianghua', name: 'Xianghua', moveCount: 6 },
      { id: 'yoshimitsu', name: 'Yoshimitsu', moveCount: 14 }
    ],
    tabs: ['Special Moves', 'Super Combos', 'Finishers', 'Unique Attacks', 'Normal Moves', 'Command Throws', 'Normal Throws', 'Common Moves']
  },
  {
    ...
    characters: [
      { id: 'astaroth', name: 'Astaroth', moveCount: 6 },
      { id: 'cassandra', name: 'Cassandra', moveCount: 13 },
      { id: 'cervantes', name: 'Cervantes', moveCount: 13 },
      { id: 'heihachi-mishima', name: 'Heihachi Mishima', moveCount: 13 },
      { id: 'ivy', name: 'Ivy', moveCount: 6 },
      { id: 'kilik', name: 'Kilik', moveCount: 8 },
      { id: 'link', name: 'Link', moveCount: 8 },
      { id: 'maxi', name: 'Maxi', moveCount: 5 },
      { id: 'mitsurugi', name: 'Mitsurugi', moveCount: 9 },
      { id: 'necrid', name: 'Necrid', moveCount: 12 },
      { id: 'nightmare', name: 'Nightmare', moveCount: 6 },
      { id: 'raphael', name: 'Raphael', moveCount: 12 },
      { id: 'seong-mi-na', name: 'Seong Mi-na', moveCount: 12 },
      { id: 'sophitia', name: 'Sophitia', moveCount: 5 },
      { id: 'spawn', name: 'Spawn', moveCount: 12 },
      { id: 'taki', name: 'Taki', moveCount: 6 },
      { id: 'talim', name: 'Talim', moveCount: 6 },
      { id: 'voldo', name: 'Voldo', moveCount: 5 },
      { id: 'xianghua', name: 'Xianghua', moveCount: 6 },
      { id: 'yoshimitsu', name: 'Yoshimitsu', moveCount: 12 },
      { id: 'yun-seong', name: 'Yun-seong', moveCount: 7 }
    ],
    tabs: ['Special Moves', 'Super Combos', 'Finishers', 'Unique Attacks', 'Normal Moves', 'Command Throws', 'Normal Throws', 'Common Moves']
  },
  {
    ...
    links: [
      { title: 'SuperCombo Wiki', url: 'https://wiki.supercombo.gg/' },
        ...
        systemMechanics: [
        { name: "8-Way Run", description: "Free 3D movement in 8 directions for positioning and evasion." },
        { name: "Soul Charge", description: "Charge to power up attacks. Three levels with increasing benefits.", input: "A+B+K" },
        { name: "Guard Impact", description: "Parry attacks for frame advantage. Forward for high/mid, back for mid/low.", input: "6+G or 4+G" },
        { name: "Just Impact", description: "Frame-perfect Guard Impact for maximum advantage." },
        { name: "Ring Out", description: "Stage-dependent instant win by knocking opponent off the arena." },
        { name: "Character Creation", description: "Create custom characters with unique fighting styles and equipment." },
    ],
    characters: [
      { id: 'abelia', name: 'Abelia', moveCount: 7 },
      { id: 'amy', name: 'Amy', moveCount: 13 },
      { id: 'arthur', name: 'Arthur', moveCount: 12 },
      { id: 'astaroth', name: 'Astaroth', moveCount: 133 },
      { id: 'aurelia', name: 'Aurelia', moveCount: 11 },
      { id: 'cassandra', name: 'Cassandra', moveCount: 125 },
      { id: 'cervantes', name: 'Cervantes', moveCount: 129 },
      { id: 'chester', name: 'Chester', moveCount: 11 },
      { id: 'demuth', name: 'Demuth', moveCount: 11 },
      { id: 'girardot', name: 'Girardot', moveCount: 11 },
      { id: 'greed', name: 'Greed', moveCount: 11 },
      { id: 'hualin', name: 'Hualin', moveCount: 11 },
      { id: 'hwang', name: 'Hwang', moveCount: 11 },
      { id: 'ivy', name: 'Ivy', moveCount: 219 },
      { id: 'kilik', name: 'Kilik', moveCount: 132 },
      { id: 'li-long', name: 'Li Long', moveCount: 11 },
      { id: 'luna', name: 'Luna', moveCount: 11 },
      { id: 'maxi', name: 'Maxi', moveCount: 168 },
      { id: 'miser', name: 'Miser', moveCount: 11 },
      { id: 'mitsurugi', name: 'Mitsurugi', moveCount: 156 },
      { id: 'night-terror', name: 'Night Terror', moveCount: 12 },
      { id: 'nightmare', name: 'Nightmare', moveCount: 118 },
      { id: 'olcadan', name: 'Olcadan', moveCount: 130 },
      { id: 'raphael', name: 'Raphael', moveCount: 107 },
      { id: 'revenant', name: 'Revenant', moveCount: 11 },
      { id: 'rock', name: 'Rock', moveCount: 102 },
      { id: 'seong-mi-na', name: 'Seong Mi-na', moveCount: 96 },
      { id: 'setsuka', name: 'Setsuka', moveCount: 98 },
      { id: 'siegfried', name: 'Siegfried', moveCount: 158 },
      { id: 'sophitia', name: 'Sophitia', moveCount: 132 },
      { id: 'strife', name: 'Strife', moveCount: 11 },
      { id: 'taki', name: 'Taki', moveCount: 213 },
      { id: 'talim', name: 'Talim', moveCount: 142 },
      { id: 'tira', name: 'Tira', moveCount: 111 },
      { id: 'valeria', name: 'Valeria', moveCount: 11 },
      { id: 'voldo', name: 'Voldo', moveCount: 226 },
      { id: 'xianghua', name: 'Xianghua', moveCount: 141 },
      { id: 'yoshimitsu', name: 'Yoshimitsu', moveCount: 227 },
      { id: 'yun-seong', name: 'Yun-seong', moveCount: 124 },
      { id: 'zasalamel', name: 'Zasalamel', moveCount: 91 }
    ],
    tabs: ['Special Moves', 'Super Combos', 'Finishers', 'Unique Attacks', 'Normal Moves', 'Command Throws', 'Normal Throws', 'Common Moves']
  },
  {
    ...
    characters: [
      { id: 'algol', name: 'Algol', moveCount: 66 },
      { id: 'amy', name: 'Amy', moveCount: 70 },
      { id: 'apprentice', name: 'Apprentice', moveCount: 11 },
      { id: 'astaroth', name: 'Astaroth', moveCount: 110 },
      { id: 'cassandra', name: 'Cassandra', moveCount: 112 },
      { id: 'cervantes', name: 'Cervantes', moveCount: 16 },
      { id: 'darth-vader', name: 'Darth Vader', moveCount: 11 },
      { id: 'hilde', name: 'Hilde', moveCount: 17 },
      { id: 'ivy', name: 'Ivy', moveCount: 18 },
      { id: 'kilik', name: 'Kilik', moveCount: 18 },
      { id: 'lizardman', name: 'Lizardman', moveCount: 9 },
      { id: 'maxi', name: 'Maxi', moveCount: 26 },
      { id: 'mitsurugi', name: 'Mitsurugi', moveCount: 9 },
      { id: 'nightmare', name: 'Nightmare', moveCount: 12 },
      { id: 'raphael', name: 'Raphael', moveCount: 16 },
      { id: 'rock', name: 'Rock', moveCount: 8 },
      { id: 'seong-mi-na', name: 'Seong Mi-na', moveCount: 8 },
      { id: 'siegfried', name: 'Siegfried', moveCount: 15 },
      { id: 'sophitia', name: 'Sophitia', moveCount: 24 },
      { id: 'taki', name: 'Taki', moveCount: 35 },
      { id: 'talim', name: 'Talim', moveCount: 18 },
      { id: 'tira', name: 'Tira', moveCount: 14 },
      { id: 'voldo', name: 'Voldo', moveCount: 19 },
      { id: 'xianghua', name: 'Xianghua', moveCount: 17 },
      { id: 'yoda', name: 'Yoda', moveCount: 9 },
      { id: 'yoshimitsu', name: 'Yoshimitsu', moveCount: 20 },
      { id: 'yun-seong', name: 'Yun-seong', moveCount: 17 },
      { id: 'zasalamel', name: 'Zasalamel', moveCount: 23 }
    ],
    tabs: ['Special Moves', 'Super Combos', 'Finishers', 'Unique Attacks', 'Normal Moves', 'Command Throws', 'Normal Throws', 'Common Moves']
  },
  {
    ...
    links: [
      { title: 'SuperCombo Wiki', url: 'https://wiki.supercombo.gg/' },
        ...
        systemMechanics: [
        { name: "Critical Edge", description: "Super move consuming one meter bar. Cinematic high-damage attack.", input: "A+B+K (with meter)" },
        { name: "Brave Edge", description: "Spend meter to enhance certain special moves with extra hits or properties." },
        { name: "Guard Impact", description: "Universal parry. Costs no meter. Deflects all attacks.", input: "4+A+B+K" },
        { name: "Just Guard", description: "Frame-perfect block for reduced blockstun and advantage." },
        { name: "8-Way Run", description: "Free 3D movement in 8 directions." },
        { name: "Ring Out", description: "Win instantly by knocking the opponent off the stage edge." },
    ],
    characters: [
      { id: 'aeon', name: 'Aeon', moveCount: 68 },
      { id: 'algol', name: 'Algol', moveCount: 89 },
      { id: 'astaroth', name: 'Astaroth', moveCount: 97 },
      { id: 'cervantes', name: 'Cervantes', moveCount: 91 },
      { id: 'edge-master', name: 'Edge Master', moveCount: 8 },
      { id: 'elysium', name: 'Elysium', moveCount: 8 },
      { id: 'ezio-auditore', name: 'Ezio Auditore', moveCount: 70 },
      { id: 'hilde', name: 'Hilde', moveCount: 72 },
      { id: 'ivy', name: 'Ivy', moveCount: 100 },
      { id: 'kilik', name: 'Kilik', moveCount: 8 },
      { id: 'leixia', name: 'Leixia', moveCount: 92 },
      { id: 'maxi', name: 'Maxi', moveCount: 95 },
      { id: 'mitsurugi', name: 'Mitsurugi', moveCount: 101 },
      { id: 'natsu', name: 'Natsu', moveCount: 134 },
      { id: 'nightmare', name: 'Nightmare', moveCount: 95 },
      { id: 'patroklos', name: 'Patroklos', moveCount: 73 },
      { id: 'pyrrha', name: 'Pyrrha', moveCount: 90 },
      { id: 'raphael', name: 'Raphael', moveCount: 91 },
      { id: 'siegfried', name: 'Siegfried', moveCount: 123 },
      { id: 'tira', name: 'Tira', moveCount: 94 },
      { id: 'viola', name: 'Viola', moveCount: 99 },
      { id: 'voldo', name: 'Voldo', moveCount: 136 },
      { id: 'xiba', name: 'Xiba', moveCount: 84 },
      { id: 'yoshimitsu', name: 'Yoshimitsu', moveCount: 162 },
      { id: 'zwei', name: 'Z.W.E.I.', moveCount: 28 }
    ],
    tabs: ['Special Moves', 'Super Combos', 'Finishers', 'Unique Attacks', 'Normal Moves', 'Command Throws', 'Normal Throws', 'Common Moves']
  },
  {
    ...
    characters: [
      { id: '2b', name: '2B', moveCount: 217 },
      { id: 'amy', name: 'Amy', moveCount: 245 },
      { id: 'astaroth', name: 'Astaroth', moveCount: 189 },
      { id: 'azwel', name: 'Azwel', moveCount: 167 },
      { id: 'cassandra', name: 'Cassandra', moveCount: 175 },
      { id: 'cervantes', name: 'Cervantes', moveCount: 163 },
      { id: 'geralt-of-rivia', name: 'Geralt of Rivia', moveCount: 0 },
      { id: 'grh', name: 'Grøh', moveCount: 0 },
      { id: 'haohmaru', name: 'Haohmaru', moveCount: 186 },
      { id: 'hilde', name: 'Hilde', moveCount: 147 },
      { id: 'hwang', name: 'Hwang', moveCount: 236 },
      { id: 'inferno', name: 'Inferno', moveCount: 136 },
      { id: 'ivy', name: 'Ivy', moveCount: 188 },
      { id: 'kilik', name: 'Kilik', moveCount: 176 },
      { id: 'maxi', name: 'Maxi', moveCount: 195 },
      { id: 'mitsurugi', name: 'Mitsurugi', moveCount: 174 },
      { id: 'nightmare', name: 'Nightmare', moveCount: 172 },
      { id: 'raphael', name: 'Raphael', moveCount: 182 },
      { id: 'seong-mi-na', name: 'Seong Mi-na', moveCount: 175 },
      { id: 'setsuka', name: 'Setsuka', moveCount: 172 },
      { id: 'siegfried', name: 'Siegfried', moveCount: 201 },
      { id: 'sophitia', name: 'Sophitia', moveCount: 176 },
      { id: 'taki', name: 'Taki', moveCount: 264 },
      { id: 'talim', name: 'Talim', moveCount: 211 },
      { id: 'tira', name: 'Tira', moveCount: 175 },
      { id: 'voldo', name: 'Voldo', moveCount: 241 },
      { id: 'xianghua', name: 'Xianghua', moveCount: 221 },
      { id: 'yoshimitsu', name: 'Yoshimitsu', moveCount: 204 },
      { id: 'zasalamel', name: 'Zasalamel', moveCount: 154 }
    ],
    tabs: ['Special Moves', 'Super Combos', 'Finishers', 'Unique Attacks', 'Normal Moves', 'Command Throws', 'Normal Throws', 'Common Moves']
  },
  {
  ...
  },
  {
    ...
    characters: [
      { id: 'akuma', name: 'Akuma', moveCount: 13 },
      { id: 'alex', name: 'Alex', moveCount: 12 },
      { id: 'chun-li', name: 'Chun-Li', moveCount: 0 },
      { id: 'dudley', name: 'Dudley', moveCount: 17 },
      { id: 'elena', name: 'Elena', moveCount: 15 },
      { id: 'hugo', name: 'Hugo', moveCount: 16 },
      { id: 'ibuki', name: 'Ibuki', moveCount: 13 },
      { id: 'ken', name: 'Ken', moveCount: 14 },
      { id: 'makoto', name: 'Makoto', moveCount: 16 },
      { id: 'necro', name: 'Necro', moveCount: 16 },
      { id: 'oro', name: 'Oro', moveCount: 13 },
      { id: 'q', name: 'Q', moveCount: 15 },
      { id: 'remy', name: 'Remy', moveCount: 15 },
      { id: 'ryu', name: 'Ryu', moveCount: 17 },
      { id: 'sean', name: 'Sean', moveCount: 15 },
      { id: 'twelve', name: 'Twelve', moveCount: 14 },
      { id: 'urien', name: 'Urien', moveCount: 14 },
      { id: 'yang', name: 'Yang', moveCount: 16 },
      { id: 'yun', name: 'Yun', moveCount: 17 }
    ],
  ...
  },
  {
    ...
    characters: [
      ...
      { id: 'cammy', name: 'Cammy', moveCount: 13 },
      { id: 'chun-li', name: 'Chun-Li', moveCount: 14 },
      { id: 'crimson-viper', name: 'Crimson Viper', moveCount: 14 },
      { id: 'dan', name: 'Dan', moveCount: 12 },
      { id: 'dhalsim', name: 'Dhalsim', moveCount: 12 },
      { id: 'e-honda', name: 'E. Honda', moveCount: 13 },
      { id: 'el-fuerte', name: 'El Fuerte', moveCount: 15 },
  ...
  },
  {
    ...
    characters: [
      ...
      { id: 'guile', name: 'Guile', moveCount: 12 },
      { id: 'guy', name: 'Guy', moveCount: 16 },
      { id: 'hakan', name: 'Hakan', moveCount: 13 },
      { id: 'ibuki', name: 'Ibuki', moveCount: 13 },
      { id: 'juri', name: 'Juri', moveCount: 14 },
      { id: 'ken', name: 'Ken', moveCount: 14 },
      { id: 'm-bison', name: 'M. Bison', moveCount: 15 },
  ...
  },
  {
    ...
    characters: [
      { id: 'anna-williams', name: 'Anna Williams', moveCount: 7 },
      { id: 'bryan-fury', name: 'Bryan Fury', moveCount: 19 },
      { id: 'dr-bosconovitch', name: 'Dr. Bosconovitch', moveCount: 13 },
      { id: 'eddy-gordo', name: 'Eddy Gordo', moveCount: 13 },
      { id: 'gon', name: 'Gon', moveCount: 12 },
      { id: 'gun-jack', name: 'Gun Jack', moveCount: 6 },
      { id: 'heihachi-mishima', name: 'Heihachi Mishima', moveCount: 10 },
      { id: 'hwoarang', name: 'Hwoarang', moveCount: 13 },
      { id: 'jin-kazama', name: 'Jin Kazama', moveCount: 4 },
      { id: 'julia-chang', name: 'Julia Chang', moveCount: 7 },
      { id: 'king-ii', name: 'King II', moveCount: 8 },
      { id: 'kuma-ii', name: 'Kuma II', moveCount: 3 },
      { id: 'lei-wulong', name: 'Lei Wulong', moveCount: 4 },
      { id: 'marshall-law', name: 'Marshall Law', moveCount: 8 },
      { id: 'mokujin', name: 'Mokujin', moveCount: 8 },
      { id: 'nina-williams', name: 'Nina Williams', moveCount: 7 },
      { id: 'ogre', name: 'Ogre', moveCount: 8 },
      { id: 'panda', name: 'Panda', moveCount: 9 },
      { id: 'paul-phoenix', name: 'Paul Phoenix', moveCount: 9 },
      { id: 'tiger-jackson', name: 'Tiger Jackson', moveCount: 6 },
      { id: 'true-ogre', name: 'True Ogre', moveCount: 13 },
      { id: 'yoshimitsu', name: 'Yoshimitsu', moveCount: 7 }
    ],
    tabs: ['Special Moves', 'Super Combos', 'Finishers', 'Unique Attacks', 'Normal Moves', 'Command Throws', 'Normal Throws', 'Common Moves']
  },
  {
    ...
    characters: [
      { id: 'bryan-fury', name: 'Bryan Fury', moveCount: 12 },
      { id: 'christie-monteiro', name: 'Christie Monteiro', moveCount: 11 },
      { id: 'combot', name: 'Combot', moveCount: 8 },
      { id: 'eddy-gordo', name: 'Eddy Gordo', moveCount: 10 },
      { id: 'heihachi-mishima', name: 'Heihachi Mishima', moveCount: 10 },
      { id: 'hwoarang', name: 'Hwoarang', moveCount: 11 },
      { id: 'jin-kazama', name: 'Jin Kazama', moveCount: 4 },
      { id: 'julia-chang', name: 'Julia Chang', moveCount: 7 },
      { id: 'kazuya-mishima', name: 'Kazuya Mishima', moveCount: 13 },
      { id: 'king-ii', name: 'King II', moveCount: 8 },
      { id: 'kuma-ii', name: 'Kuma II', moveCount: 3 },
      { id: 'lee-chaolan', name: 'Lee Chaolan', moveCount: 8 },
      { id: 'lei-wulong', name: 'Lei Wulong', moveCount: 4 },
      { id: 'ling-xiaoyu', name: 'Ling Xiaoyu', moveCount: 10 },
      { id: 'marshall-law', name: 'Marshall Law', moveCount: 8 },
      { id: 'miharu-hirano', name: 'Miharu Hirano', moveCount: 9 },
      { id: 'nina-williams', name: 'Nina Williams', moveCount: 7 },
      { id: 'panda', name: 'Panda', moveCount: 9 },
      { id: 'paul-phoenix', name: 'Paul Phoenix', moveCount: 9 },
      { id: 'steve-fox', name: 'Steve Fox', moveCount: 11 },
      { id: 'violet', name: 'Violet', moveCount: 10 },
      { id: 'yoshimitsu', name: 'Yoshimitsu', moveCount: 7 }
    ],
    tabs: ['Special Moves', 'Super Combos', 'Finishers', 'Unique Attacks', 'Normal Moves', 'Command Throws', 'Normal Throws', 'Common Moves']
  },
  {
    ...
    links: [
      { title: 'Wavu Wiki', url: 'https://wavu.wiki/t/Main_Page' },
        ...
        systemMechanics: [
        { name: "Crush System", description: "Certain moves have built-in evasion. High crush (ducking moves) avoid highs; low crush (jumping moves) avoid lows." },
        { name: "Wall Game", description: "Stages with walls enable wall splats, wall combos, and wall pressure for extra damage." },
        { name: "Juggle System", description: "Launchers lead to air combos. Gravity scaling limits combo length but rewards optimization." },
        { name: "Throw Break", description: "Break throws by pressing the correct punch button (1 or 2) during throw startup.", input: "1 or 2" },
        { name: "Okizeme", description: "Ground game after knockdowns. Tech rolls, getup kicks, and spring attacks create wakeup mixups." },
    ],
    characters: [
      { id: 'anna-williams', name: 'Anna Williams', moveCount: 7 },
      { id: 'asuka-kazama', name: 'Asuka Kazama', moveCount: 4 },
      { id: 'baek-doo-san', name: 'Baek Doo San', moveCount: 8 },
      { id: 'bruce-irvin', name: 'Bruce Irvin', moveCount: 8 },
      { id: 'bryan-fury', name: 'Bryan Fury', moveCount: 13 },
      { id: 'christie-monteiro', name: 'Christie Monteiro', moveCount: 10 },
      { id: 'craig-marduk', name: 'Craig Marduk', moveCount: 10 },
      { id: 'devil-jin', name: 'Devil Jin', moveCount: 11 },
      { id: 'eddy-gordo', name: 'Eddy Gordo', moveCount: 9 },
      { id: 'feng-wei', name: 'Feng Wei', moveCount: 10 },
      { id: 'ganryu', name: 'Ganryu', moveCount: 9 },
      { id: 'heihachi-mishima', name: 'Heihachi Mishima', moveCount: 10 },
      { id: 'hwoarang', name: 'Hwoarang', moveCount: 10 },
      { id: 'jack-5', name: 'Jack-5', moveCount: 6 },
      { id: 'jin-kazama', name: 'Jin Kazama', moveCount: 4 },
      { id: 'julia-chang', name: 'Julia Chang', moveCount: 7 },
      { id: 'kazuya-mishima', name: 'Kazuya Mishima', moveCount: 13 },
      { id: 'king-ii', name: 'King II', moveCount: 8 },
      ...
      { id: 'lee-chaolan', name: 'Lee Chaolan', moveCount: 8 },
      { id: 'lei-wulong', name: 'Lei Wulong', moveCount: 4 },
      { id: 'ling-xiaoyu', name: 'Ling Xiaoyu', moveCount: 9 },
      { id: 'marshall-law', name: 'Marshall Law', moveCount: 8 },
      { id: 'mokujin', name: 'Mokujin', moveCount: 7 },
      { id: 'nina-williams', name: 'Nina Williams', moveCount: 7 },
      { id: 'panda', name: 'Panda', moveCount: 9 },
      { id: 'paul-phoenix', name: 'Paul Phoenix', moveCount: 9 },
      { id: 'raven', name: 'Raven', moveCount: 10 },
      { id: 'roger-jr', name: 'Roger Jr.', moveCount: 8 },
      { id: 'steve-fox', name: 'Steve Fox', moveCount: 10 },
      { id: 'wang-jinrei', name: 'Wang Jinrei', moveCount: 2 },
      { id: 'yoshimitsu', name: 'Yoshimitsu', moveCount: 7 }
    ],
    tabs: ['Special Moves', 'Super Combos', 'Finishers', 'Unique Attacks', 'Normal Moves', 'Command Throws', 'Normal Throws', 'Common Moves']
  },
  {
    ...
    characters: [
      { id: 'alisa-bosconovitch', name: 'Alisa Bosconovitch', moveCount: 11 },
      { id: 'anna-williams', name: 'Anna Williams', moveCount: 7 },
      { id: 'armor-king-ii', name: 'Armor King II', moveCount: 2 },
      { id: 'asuka-kazama', name: 'Asuka Kazama', moveCount: 4 },
      { id: 'baek-doo-san', name: 'Baek Doo San', moveCount: 8 },
      { id: 'bob-richards', name: 'Bob Richards', moveCount: 13 },
      { id: 'bruce-irvin', name: 'Bruce Irvin', moveCount: 8 },
      { id: 'bryan-fury', name: 'Bryan Fury', moveCount: 13 },
      { id: 'christie-monteiro', name: 'Christie Monteiro', moveCount: 11 },
      { id: 'craig-marduk', name: 'Craig Marduk', moveCount: 11 },
      { id: 'devil-jin', name: 'Devil Jin', moveCount: 11 },
      { id: 'sergei-dragunov', name: 'Sergei Dragunov', moveCount: 11 },
      { id: 'eddy-gordo', name: 'Eddy Gordo', moveCount: 11 },
      { id: 'feng-wei', name: 'Feng Wei', moveCount: 11 },
      { id: 'ganryu', name: 'Ganryu', moveCount: 9 },
      { id: 'heihachi-mishima', name: 'Heihachi Mishima', moveCount: 10 },
      { id: 'hwoarang', name: 'Hwoarang', moveCount: 11 },
      { id: 'jack-6', name: 'Jack-6', moveCount: 6 },
      { id: 'jin-kazama', name: 'Jin Kazama', moveCount: 4 },
      { id: 'julia-chang', name: 'Julia Chang', moveCount: 7 },
      { id: 'kazuya-mishima', name: 'Kazuya Mishima', moveCount: 13 },
      { id: 'king-ii', name: 'King II', moveCount: 8 },
      { id: 'kuma-ii', name: 'Kuma II', moveCount: 3 },
      { id: 'lars-alexandersson', name: 'Lars Alexandersson', moveCount: 8 },
      { id: 'lee-chaolan', name: 'Lee Chaolan', moveCount: 8 },
      { id: 'lei-wulong', name: 'Lei Wulong', moveCount: 4 },
      { id: 'leo-kliesen', name: 'Leo Kliesen', moveCount: 12 },
      { id: 'lili-rochefort', name: 'Lili Rochefort', moveCount: 11 },
      { id: 'ling-xiaoyu', name: 'Ling Xiaoyu', moveCount: 11 },
      { id: 'marshall-law', name: 'Marshall Law', moveCount: 8 },
      { id: 'miguel-caballero-rojo', name: 'Miguel Caballero Rojo', moveCount: 11 },
      { id: 'mokujin', name: 'Mokujin', moveCount: 6 },
      { id: 'nina-williams', name: 'Nina Williams', moveCount: 7 },
      { id: 'panda', name: 'Panda', moveCount: 9 },
      { id: 'paul-phoenix', name: 'Paul Phoenix', moveCount: 9 },
      { id: 'raven', name: 'Raven', moveCount: 11 },
      { id: 'roger-jr', name: 'Roger Jr.', moveCount: 8 },
      { id: 'steve-fox', name: 'Steve Fox', moveCount: 11 },
      { id: 'wang-jinrei', name: 'Wang Jinrei', moveCount: 2 },
      { id: 'yoshimitsu', name: 'Yoshimitsu', moveCount: 7 },
      { id: 'zafina', name: 'Zafina', moveCount: 9 }
    ],
    tabs: ['Special Moves', 'Super Combos', 'Finishers', 'Unique Attacks', 'Normal Moves', 'Command Throws', 'Normal Throws', 'Common Moves']
  },
  {
    ...
    characters: [
      { id: 'akuma', name: 'Akuma', moveCount: 3 },
      { id: 'alisa-bosconovitch', name: 'Alisa Bosconovitch', moveCount: 12 },
      { id: 'anna-williams', name: 'Anna Williams', moveCount: 7 },
      { id: 'armor-king-ii', name: 'Armor King II', moveCount: 2 },
      { id: 'asuka-kazama', name: 'Asuka Kazama', moveCount: 4 },
      { id: 'bob-richards', name: 'Bob Richards', moveCount: 15 },
      { id: 'bryan-fury', name: 'Bryan Fury', moveCount: 15 },
      { id: 'claudio-serafino', name: 'Claudio Serafino', moveCount: 11 },
      { id: 'craig-marduk', name: 'Craig Marduk', moveCount: 12 },
      { id: 'devil-jin', name: 'Devil Jin', moveCount: 12 },
      { id: 'sergei-dragunov', name: 'Sergei Dragunov', moveCount: 7 },
      { id: 'eddy-gordo', name: 'Eddy Gordo', moveCount: 9 },
      { id: 'eliza', name: 'Eliza', moveCount: 9 },
      { id: 'fahkumram', name: 'Fahkumram', moveCount: 14 },
      { id: 'feng-wei', name: 'Feng Wei', moveCount: 8 },
      { id: 'ganryu', name: 'Ganryu', moveCount: 9 },
      { id: 'geese-howard', name: 'Geese Howard', moveCount: 14 },
      { id: 'gigas', name: 'Gigas', moveCount: 8 },
      { id: 'heihachi-mishima', name: 'Heihachi Mishima', moveCount: 10 },
      { id: 'hwoarang', name: 'Hwoarang', moveCount: 7 },
      { id: 'jack-7', name: 'Jack-7', moveCount: 6 },
      { id: 'jin-kazama', name: 'Jin Kazama', moveCount: 4 },
      { id: 'julia-chang', name: 'Julia Chang', moveCount: 7 },
      { id: 'katarina-alves', name: 'Katarina Alves', moveCount: 7 },
      { id: 'kazumi-mishima', name: 'Kazumi Mishima', moveCount: 13 },
      { id: 'kazuya-mishima', name: 'Kazuya Mishima', moveCount: 13 },
      { id: 'king-ii', name: 'King II', moveCount: 8 },
      { id: 'kuma-ii', name: 'Kuma II', moveCount: 3 },
      { id: 'kunimitsu-ii', name: 'Kunimitsu II', moveCount: 8 },
      { id: 'lars-alexandersson', name: 'Lars Alexandersson', moveCount: 8 },
      { id: 'lee-chaolan', name: 'Lee Chaolan', moveCount: 8 },
      { id: 'lei-wulong', name: 'Lei Wulong', moveCount: 4 },
      { id: 'leo-kliesen', name: 'Leo Kliesen', moveCount: 7 },
      { id: 'leroy-smith', name: 'Leroy Smith', moveCount: 7 },
      { id: 'lili-rochefort', name: 'Lili Rochefort', moveCount: 7 },
      { id: 'ling-xiaoyu', name: 'Ling Xiaoyu', moveCount: 7 },
      { id: 'lucky-chloe', name: 'Lucky Chloe', moveCount: 7 },
      { id: 'lidia-sobieska', name: 'Lidia Sobieska', moveCount: 7 },
      { id: 'marshall-law', name: 'Marshall Law', moveCount: 8 },
      { id: 'master-raven', name: 'Master Raven', moveCount: 7 },
      { id: 'miguel-caballero-rojo', name: 'Miguel Caballero Rojo', moveCount: 7 },
      { id: 'negan', name: 'Negan', moveCount: 8 },
      { id: 'nina-williams', name: 'Nina Williams', moveCount: 7 },
      { id: 'noctis-lucis-caelum', name: 'Noctis Lucis Caelum', moveCount: 10 },
      { id: 'panda', name: 'Panda', moveCount: 9 },
      { id: 'paul-phoenix', name: 'Paul Phoenix', moveCount: 9 },
      { id: 'shaheen', name: 'Shaheen', moveCount: 7 },
      { id: 'steve-fox', name: 'Steve Fox', moveCount: 7 },
      { id: 'ling-xiaoyu', name: 'Ling Xiaoyu', moveCount: 7 },
      { id: 'yoshimitsu', name: 'Yoshimitsu', moveCount: 7 },
      { id: 'zafina', name: 'Zafina', moveCount: 9 }
  ...
  },
  {
    ...
    characters: [
      ...
      { id: 'billy-kane', name: 'Billy Kane', moveCount: 5 },
      { id: 'chang-koehan', name: 'Chang Koehan', moveCount: 4 },
      { id: 'chin-gentsai', name: 'Chin Gentsai', moveCount: 3 },
      { id: 'choi-bounge', name: 'Choi Bounge', moveCount: 4 },
      { id: 'clark-still', name: 'Clark Still', moveCount: 4 },
      { id: 'eiji-kisaragi', name: 'Eiji Kisaragi', moveCount: 6 },
      { id: 'goro-daimon', name: 'Goro Daimon', moveCount: 6 },
      { id: 'heidern', name: 'Heidern', moveCount: 6 },
      { id: 'iori-yagami', name: 'Iori Yagami', moveCount: 6 },
      { id: 'joe-higashi', name: 'Joe Higashi', moveCount: 2 },
      { id: 'kim-kaphwan', name: 'Kim Kaphwan', moveCount: 5 },
      { id: 'king', name: 'King', moveCount: 8 },
      { id: 'kyo-kusanagi', name: 'Kyo Kusanagi', moveCount: 11 },
      { id: 'lucky-glauber', name: 'Lucky Glauber', moveCount: 6 },
      { id: 'mai-shiranui', name: 'Mai Shiranui', moveCount: 6 },
      { id: 'ralf-jones', name: 'Ralf Jones', moveCount: 5 },
      { id: 'robert-garcia', name: 'Robert Garcia', moveCount: 6 },
      { id: 'rugal-bernstein', name: 'Rugal Bernstein', moveCount: 6 },
      { id: 'ryo-sakazaki', name: 'Ryo Sakazaki', moveCount: 6 },
      { id: 'saisyu-kusanagi', name: 'Saisyu Kusanagi', moveCount: 11 },
      { id: 'sie-kensou', name: 'Sie Kensou', moveCount: 7 },
      { id: 'takuma-sakazaki', name: 'Takuma Sakazaki', moveCount: 6 },
      { id: 'terry-bogard', name: 'Terry Bogard', moveCount: 8 },
      { id: 'yuri-sakazaki', name: 'Yuri Sakazaki', moveCount: 6 }
    ],
    tabs: ['Special Moves', 'Super Combos', 'Finishers', 'Unique Attacks', 'Normal Moves', 'Command Throws', 'Normal Throws', 'Common Moves']
  },
  {
    ...
    characters: [
      { id: 'andy-bogard', name: 'Andy Bogard', moveCount: 6 },
      { id: 'athena-asamiya', name: 'Athena Asamiya', moveCount: 6 },
      { id: 'benimaru-nikaido', name: 'Benimaru Nikaido', moveCount: 4 },
      { id: 'chang-koehan', name: 'Chang Koehan', moveCount: 4 },
      { id: 'chin-gentsai', name: 'Chin Gentsai', moveCount: 4 },
      ...
      { id: 'clark-still', name: 'Clark Still', moveCount: 4 },
      { id: 'geese-howard', name: 'Geese Howard', moveCount: 9 },
      { id: 'goro-daimon', name: 'Goro Daimon', moveCount: 4 },
      { id: 'iori-yagami', name: 'Iori Yagami', moveCount: 6 },
      { id: 'joe-higashi', name: 'Joe Higashi', moveCount: 4 },
      { id: 'kasumi-todoh', name: 'Kasumi Todoh', moveCount: 4 },
      { id: 'kim-kaphwan', name: 'Kim Kaphwan', moveCount: 5 },
      { id: 'king', name: 'King', moveCount: 8 },
      { id: 'kyo-kusanagi', name: 'Kyo Kusanagi', moveCount: 11 },
      ...
      { id: 'mai-shiranui', name: 'Mai Shiranui', moveCount: 6 },
      { id: 'mature', name: 'Mature', moveCount: 6 },
      { id: 'mr-big', name: 'Mr. Big', moveCount: 3 },
      { id: 'ralf-jones', name: 'Ralf Jones', moveCount: 5 },
      { id: 'robert-garcia', name: 'Robert Garcia', moveCount: 6 },
      { id: 'ryo-sakazaki', name: 'Ryo Sakazaki', moveCount: 6 },
      { id: 'sie-kensou', name: 'Sie Kensou', moveCount: 7 },
      { id: 'terry-bogard', name: 'Terry Bogard', moveCount: 8 },
      { id: 'vice', name: 'Vice', moveCount: 4 },
      { id: 'wolfgang-krauser', name: 'Wolfgang Krauser', moveCount: 4 }
    ],
    tabs: ['Special Moves', 'Super Combos', 'Finishers', 'Unique Attacks', 'Normal Moves', 'Command Throws', 'Normal Throws', 'Common Moves']
  },
  {
    ...
    characters: [
      ...
      { id: 'athena-asamiya', name: 'Athena Asamiya', moveCount: 6 },
      { id: 'benimaru-nikaido', name: 'Benimaru Nikaido', moveCount: 4 },
      { id: 'billy-kane', name: 'Billy Kane', moveCount: 9 },
      { id: 'blue-mary', name: 'Blue Mary', moveCount: 3 },
      { id: 'chang-koehan', name: 'Chang Koehan', moveCount: 4 },
      { id: 'chin-gentsai', name: 'Chin Gentsai', moveCount: 4 },
      { id: 'choi-bounge', name: 'Choi Bounge', moveCount: 5 },
      { id: 'chris', name: 'Chris', moveCount: 7 },
      { id: 'clark-still', name: 'Clark Still', moveCount: 4 },
      { id: 'goro-daimon', name: 'Goro Daimon', moveCount: 4 },
      { id: 'iori-yagami', name: 'Iori Yagami', moveCount: 6 },
      ...
      { id: 'mai-shiranui', name: 'Mai Shiranui', moveCount: 6 },
      { id: 'orochi-chris', name: 'Orochi Chris', moveCount: 6 },
      { id: 'orochi-iori', name: 'Orochi Iori', moveCount: 6 },
      { id: 'orochi-leona', name: 'Orochi Leona', moveCount: 6 },
      { id: 'orochi-shermie', name: 'Orochi Shermie', moveCount: 6 },
      { id: 'orochi-yashiro', name: 'Orochi Yashiro', moveCount: 14 },
      { id: 'ralf-jones', name: 'Ralf Jones', moveCount: 5 },
      { id: 'robert-garcia', name: 'Robert Garcia', moveCount: 6 },
      { id: 'ryo-sakazaki', name: 'Ryo Sakazaki', moveCount: 6 },
      { id: 'ryuji-yamazaki', name: 'Ryuji Yamazaki', moveCount: 6 },
  ...
  },
  {
    ...
    characters: [
      ...
      { id: 'chin-gentsai', name: 'Chin Gentsai', moveCount: 4 },
      { id: 'choi-bounge', name: 'Choi Bounge', moveCount: 3 },
      { id: 'chris', name: 'Chris', moveCount: 3 },
      { id: 'clark-still', name: 'Clark Still', moveCount: 4 },
      { id: 'goro-daimon', name: 'Goro Daimon', moveCount: 3 },
      { id: 'heidern', name: 'Heidern', moveCount: 4 },
      { id: 'iori-yagami', name: 'Iori Yagami', moveCount: 6 },
      { id: 'joe-higashi', name: 'Joe Higashi', moveCount: 4 },
      { id: 'kim-kaphwan', name: 'Kim Kaphwan', moveCount: 4 },
      { id: 'king', name: 'King', moveCount: 8 },
      ...
      { id: 'ryo-sakazaki', name: 'Ryo Sakazaki', moveCount: 6 },
      { id: 'ryuji-yamazaki', name: 'Ryuji Yamazaki', moveCount: 6 },
      { id: 'saisyu-kusanagi', name: 'Saisyu Kusanagi', moveCount: 4 },
      { id: 'shermie', name: 'Shermie', moveCount: 3 },
      { id: 'shingo-yabuki', name: 'Shingo Yabuki', moveCount: 14 },
      { id: 'sie-kensou', name: 'Sie Kensou', moveCount: 7 },
      { id: 'takuma-sakazaki', name: 'Takuma Sakazaki', moveCount: 4 },
      { id: 'terry-bogard', name: 'Terry Bogard', moveCount: 8 },
      { id: 'vice', name: 'Vice', moveCount: 4 },
  ...
  },
  {
    ...
    characters: [
      { id: 'andy-bogard', name: 'Andy Bogard', moveCount: 6 },
      { id: 'athena-asamiya', name: 'Athena Asamiya', moveCount: 6 },
      { id: 'bao', name: 'Bao', moveCount: 4 },
      { id: 'benimaru-nikaido', name: 'Benimaru Nikaido', moveCount: 4 },
      { id: 'blue-mary', name: 'Blue Mary', moveCount: 10 },
      { id: 'chang-koehan', name: 'Chang Koehan', moveCount: 9 },
      { id: 'chin-gentsai', name: 'Chin Gentsai', moveCount: 4 },
      { id: 'choi-bounge', name: 'Choi Bounge', moveCount: 4 },
      { id: 'clark-still', name: 'Clark Still', moveCount: 3 },
      { id: 'iori-yagami', name: 'Iori Yagami', moveCount: 6 },
      { id: 'jhun-hoon', name: 'Jhun Hoon', moveCount: 6 },
      { id: 'joe-higashi', name: 'Joe Higashi', moveCount: 7 },
      { id: 'k-dash', name: 'K\'', moveCount: 5 },
      { id: 'kasumi-todoh', name: 'Kasumi Todoh', moveCount: 4 },
      { id: 'kim-kaphwan', name: 'Kim Kaphwan', moveCount: 2 },
      { id: 'king', name: 'King', moveCount: 8 },
      { id: 'kyo-kusanagi', name: 'Kyo Kusanagi', moveCount: 11 },
      { id: 'leona-heidern', name: 'Leona Heidern', moveCount: 6 },
      { id: 'li-xiangfei', name: 'Li Xiangfei', moveCount: 6 },
  ...
  },
  {
    ...
    characters: [
      { id: 'adelheid', name: 'Adelheid', moveCount: 5 },
      { id: 'ash', name: 'Ash', moveCount: 7 },
      { id: 'athena', name: 'Athena', moveCount: 6 },
      { id: 'b-jenet', name: 'B. Jenet', moveCount: 8 },
      { id: 'blue-mary', name: 'Blue Mary', moveCount: 8 },
      { id: 'clark', name: 'Clark', moveCount: 4 },
      { id: 'duo-lon', name: 'Duo Lon', moveCount: 4 },
      { id: 'duck-king', name: 'Duck King', moveCount: 8 },
      { id: 'eiji', name: 'Eiji', moveCount: 6 },
      { id: 'elisabeth', name: 'Elisabeth', moveCount: 5 },
      { id: 'gai', name: 'Gai', moveCount: 5 },
      { id: 'gato', name: 'Gato', moveCount: 6 },
      { id: 'geese', name: 'Geese', moveCount: 6 },
      { id: 'griffon', name: 'Griffon', moveCount: 4 },
      { id: 'hayate', name: 'Hayate', moveCount: 5 },
      { id: 'hotaru', name: 'Hotaru', moveCount: 6 },
      { id: 'iori', name: 'Iori', moveCount: 6 },
      { id: 'jyazu', name: 'Jyazu', moveCount: 6 },
      { id: 'kasumi', name: 'Kasumi', moveCount: 4 },
      { id: 'kensou', name: 'Kensou', moveCount: 7 },
      { id: 'kim', name: 'Kim', moveCount: 5 },
      { id: 'king', name: 'King', moveCount: 8 },
      { id: 'kula', name: 'Kula', moveCount: 6 },
      { id: 'kyo', name: 'Kyo', moveCount: 11 },
      { id: 'magaki', name: 'Magaki', moveCount: 5 },
      { id: 'mai', name: 'Mai', moveCount: 3 },
      { id: 'malin', name: 'Malin', moveCount: 3 },
      { id: 'maxima', name: 'Maxima', moveCount: 3 },
      { id: 'momoko', name: 'Momoko', moveCount: 4 },
      { id: 'mr-big', name: 'Mr. Big', moveCount: 5 },
      { id: 'oswald', name: 'Oswald', moveCount: 5 },
      { id: 'ralf', name: 'Ralf', moveCount: 5 },
      { id: 'ramon', name: 'Ramon', moveCount: 3 },
      { id: 'robert', name: 'Robert', moveCount: 6 },
      { id: 'ryo', name: 'Ryo', moveCount: 6 },
      { id: 'shen', name: 'Shen', moveCount: 6 },
      { id: 'shingo', name: 'Shingo', moveCount: 7 },
      { id: 'shion', name: 'Shion', moveCount: 5 },
      { id: 'silber', name: 'Silber', moveCount: 4 },
      { id: 'terry', name: 'Terry', moveCount: 8 },
      { id: 'tung', name: 'Tung', moveCount: 7 },
      { id: 'vanessa', name: 'Vanessa', moveCount: 4 },
      { id: 'whip', name: 'Whip', moveCount: 5 },
      { id: 'yuri', name: 'Yuri', moveCount: 6 }
    ],
    tabs: ['Special Moves', 'Super Combos', 'Finishers', 'Unique Attacks', 'Normal Moves', 'Command Throws', 'Normal Throws', 'Common Moves']
  },
  {
  ...
  },
  {
    ...
    characters: [
      { id: 'chin-wo', name: 'Chin Wo', moveCount: 14 },
      { id: 'crispy', name: 'Crispy', moveCount: 12 },
      { id: 'dawson-mcshane', name: 'Dawson McShane', moveCount: 12 },
      { id: 'eternal-champion', name: 'Eternal Champion', moveCount: 11 },
      { id: 'hooter', name: 'Hooter', moveCount: 12 },
      { id: 'jetta-maxx', name: 'Jetta Maxx', moveCount: 11 },
      { id: 'jonathan-blade', name: 'Jonathan Blade', moveCount: 13 },
      { id: 'larcen-tyler', name: 'Larcen Tyler', moveCount: 12 },
      { id: 'mitchell-middleton-knight-midknight', name: 'Mitchell Middleton Knight (MidKnight)', moveCount: 11 },
      { id: 'rax-coswell', name: 'R.A.X. Coswell', moveCount: 12 },
      { id: 'ramses-iii', name: 'Ramses III', moveCount: 12 },
      { id: 'raven-gindhar', name: 'Raven Gindhar', moveCount: 12 },
      { id: 'riptide', name: 'Riptide', moveCount: 12 },
      { id: 'senator', name: 'Senator', moveCount: 10 },
      { id: 'shadow-yamoto', name: 'Shadow Yamoto', moveCount: 12 },
      { id: 'slash', name: 'Slash', moveCount: 12 },
      { id: 'slither', name: 'Slither', moveCount: 13 },
      { id: 'thanatos', name: 'Thanatos', moveCount: 10 },
      { id: 'trident', name: 'Trident', moveCount: 12 },
      { id: 'xavier-pendragon', name: 'Xavier Pendragon', moveCount: 12 },
      { id: 'yappy', name: 'Yappy', moveCount: 12 },
      { id: 'zuni', name: 'Zuni', moveCount: 12 }
    ],
    tabs: ['Special Moves', 'Super Combos', 'Finishers', 'Unique Attacks', 'Normal Moves', 'Command Throws', 'Normal Throws', 'Common Moves']
  },
  {
    ...
    links: [
      { title: 'Dustloop Wiki (MBAACC)', url: 'https://dustloop.com/w/MBAACC' },
        ...
        systemMechanics: [
        { name: "Moon Styles", description: "Choose Crescent, Half, or Full Moon. Each changes your character's moveset, meter usage, and defensive options." },
        { name: "Reverse Beat", description: "Cancel stronger normals into weaker ones (heavy to light). Unique to Melty Blood — opens creative pressure and combos." },
        { name: "Magic Circuit", description: "Meter system. Powers EX moves, Arc Drives, and Last Arcs. Builds by attacking and taking damage." },
        { name: "Shield", description: "Active parry system. Hold or tap direction+Shield to deflect attacks and counter.", input: "D (with direction)" },
        { name: "Heat / Blood Heat", description: "Powered-up state. Heat: regen health, access Arc Drive. Blood Heat: access Last Arc (instant kill)." },
        { name: "Circuit Spark", description: "Burst out of combos using full meter. Universal combo breaker.", input: "A+B+C+D" },
    ],
    characters: [
      { id: 'akiha-tohno', name: 'Akiha Tohno', moveCount: 3 },
      { id: 'akiha-tohno-seifuku', name: 'Akiha Tohno (Seifuku)', moveCount: 5 },
      { id: 'akiha-vermilion', name: 'Akiha Vermilion', moveCount: 5 },
      { id: 'aoko-aozaki', name: 'Aoko Aozaki', moveCount: 7 },
      { id: 'archetypeearth', name: 'Archetype:Earth', moveCount: 4 },
      { id: 'arcueid-brunestud', name: 'Arcueid Brunestud', moveCount: 6 },
      { id: 'ciel', name: 'Ciel', moveCount: 5 },
      { id: 'hisui', name: 'Hisui', moveCount: 3 },
      { id: 'hisui-kohaku', name: 'Hisui & Kohaku', moveCount: 3 },
      { id: 'kohaku', name: 'Kohaku', moveCount: 3 },
      { id: 'kohaku-mech-hisui', name: 'Kohaku & Mech-Hisui', moveCount: 3 },
      { id: 'kouma-kishima', name: 'Kouma Kishima', moveCount: 3 },
      { id: 'mech-hisui', name: 'Mech-Hisui', moveCount: 3 },
      { id: 'michael-roa-valdamjong', name: 'Michael Roa Valdamjong', moveCount: 3 },
      { id: 'miyako-arima', name: 'Miyako Arima', moveCount: 3 },
      { id: 'neco-arc', name: 'Neco-Arc', moveCount: 3 },
      { id: 'neco-arc-chaos', name: 'Neco-Arc Chaos', moveCount: 3 },
      { id: 'night-of-wallachia', name: 'Night of Wallachia', moveCount: 3 },
      { id: 'nrvnqsr-chaos', name: 'Nrvnqsr Chaos', moveCount: 4 },
      { id: 'red-arcueid', name: 'Red Arcueid', moveCount: 3 },
      { id: 'riesbyfe-stridberg', name: 'Riesbyfe Stridberg', moveCount: 4 },
      { id: 'ryougi-shiki', name: 'Ryougi Shiki', moveCount: 8 },
      { id: 'satsuki-yumizuka', name: 'Satsuki Yumizuka', moveCount: 4 },
      { id: 'sion-eltnam-atlasia', name: 'Sion Eltnam Atlasia', moveCount: 7 },
      { id: 'sion-tatari', name: 'Sion TATARI', moveCount: 4 }
    ],
    tabs: ['Special Moves', 'Super Combos', 'Finishers', 'Unique Attacks', 'Normal Moves', 'Command Throws', 'Normal Throws', 'Common Moves']
  },
  {
    ...
    characters: [
      { id: 'akiha-tohno', name: 'Akiha Tohno', moveCount: 5 },
      { id: 'aoko-aozaki', name: 'Aoko Aozaki', moveCount: 3 },
      { id: 'arcueid-brunestud', name: 'Arcueid Brunestud', moveCount: 6 },
      { id: 'ciel', name: 'Ciel', moveCount: 5 },
      { id: 'count-of-monte-cristo', name: 'Count of Monte Cristo', moveCount: 3 },
      { id: 'dead-apostle-noel', name: 'Dead Apostle Noel', moveCount: 3 },
      { id: 'hisui', name: 'Hisui', moveCount: 3 },
      { id: 'kohaku', name: 'Kohaku', moveCount: 3 },
      { id: 'kouma-kishima', name: 'Kouma Kishima', moveCount: 3 },
      { id: 'mario-gallo-bestino', name: 'Mario Gallo Bestino', moveCount: 3 },
      { id: 'mash-kyrielight', name: 'Mash Kyrielight', moveCount: 3 },
      { id: 'miyako-arima', name: 'Miyako Arima', moveCount: 3 },
      { id: 'neco-arc', name: 'Neco-Arc', moveCount: 3 },
      { id: 'noel', name: 'Noel', moveCount: 3 },
      { id: 'powered-ciel', name: 'Powered Ciel', moveCount: 5 },
      { id: 'red-arcueid', name: 'Red Arcueid', moveCount: 3 },
      { id: 'roa', name: 'Roa', moveCount: 3 },
      { id: 'saber', name: 'Saber', moveCount: 3 },
      { id: 'shiki-tohno', name: 'Shiki Tohno', moveCount: 8 },
      { id: 'ushiwakamaru', name: 'Ushiwakamaru', moveCount: 3 },
      { id: 'vlov-arkhangel', name: 'Vlov Arkhangel', moveCount: 3 }
    ],
    tabs: ['Special Moves', 'Super Combos', 'Finishers', 'Unique Attacks', 'Normal Moves', 'Command Throws', 'Normal Throws', 'Common Moves']
  },
  {
    ...
    developer: 'Statera Studio',
        systemMechanics: [
        { name: "Super Moves", description: "Powered by the Super Gauge. Multiple levels for increasingly powerful attacks." },
        { name: "Chain Combos", description: "Link light into medium into heavy normals for accessible combo routes." },
        { name: "Dash Cancel", description: "Cancel certain normals into a forward dash for extended pressure and combos." },
        { name: "Guard Cancel", description: "Counterattack from blockstun using meter." },
    ],
    characters: [
      { id: 'aleksander', name: 'Aleksander', moveCount: 11 },
      { id: 'aris', name: 'Aris', moveCount: 11 },
      { id: 'daisuke', name: 'Daisuke', moveCount: 11 },
      { id: 'hadassa', name: 'Hadassa', moveCount: 14 },
      { id: 'jorge', name: 'Jorge', moveCount: 14 },
      { id: 'kimberly', name: 'Kimberly', moveCount: 11 },
      { id: 'malika', name: 'Malika', moveCount: 11 },
      { id: 'mingmei', name: 'Mingmei', moveCount: 14 },
      { id: 'ndidi', name: 'Ndidi', moveCount: 15 },
      { id: 'nuno', name: 'Nuno', moveCount: 14 },
      { id: 'sebastian', name: 'Sebastian', moveCount: 11 },
      { id: 'ximena', name: 'Ximena', moveCount: 11 }
    ],
    tabs: ['Special Moves', 'Super Combos', 'Finishers', 'Unique Attacks', 'Normal Moves', 'Command Throws', 'Normal Throws', 'Common Moves']
  },
  {
    ...
    characters: [
      { id: 'annie', name: 'Annie', moveCount: 14 },
      { id: 'beowulf', name: 'Beowulf', moveCount: 15 },
      { id: 'big-band', name: 'Big Band', moveCount: 15 },
      { id: 'black-dahlia', name: 'Black Dahlia', moveCount: 14 },
      { id: 'cerebella', name: 'Cerebella', moveCount: 15 },
      { id: 'double', name: 'Double', moveCount: 14 },
      { id: 'eliza', name: 'Eliza', moveCount: 15 },
      { id: 'filia', name: 'Filia', moveCount: 14 },
      { id: 'fukua', name: 'Fukua', moveCount: 13 },
      { id: 'marie', name: 'Marie', moveCount: 14 },
      { id: 'ms-fortune', name: 'Ms. Fortune', moveCount: 15 },
      { id: 'painwheel', name: 'Painwheel', moveCount: 15 },
      { id: 'parasoul', name: 'Parasoul', moveCount: 15 },
      { id: 'peacock', name: 'Peacock', moveCount: 16 },
      { id: 'robo-fortune', name: 'Robo-Fortune', moveCount: 13 },
      { id: 'squigly', name: 'Squigly', moveCount: 14 },
      { id: 'umbrella', name: 'Umbrella', moveCount: 13 },
      { id: 'valentine', name: 'Valentine', moveCount: 15 }
    ],
    tabs: ['Special Moves', 'Super Combos', 'Finishers', 'Unique Attacks', 'Normal Moves', 'Command Throws', 'Normal Throws', 'Common Moves']
  },
  {
    ...
    searchAliases: ['ssb', 'smash 64'],
        systemMechanics: [
        { name: "Percentage System", description: "No health bars. Damage increases knockback percentage. Higher % = launched farther. KO by launching off-stage." },
        { name: "Smash Attacks", description: "Chargeable powerful attacks for KOs. Forward, Up, and Down smashes.", input: "A + direction (tap stick)" },
        { name: "Special Moves", description: "B-button specials. Neutral B, Side B, Up B (recovery), Down B. Unique per character.", input: "B + direction" },
        { name: "Edge Guarding", description: "Intercept recovering opponents off-stage. Core KO strategy." },
        { name: "Shield / Grab", description: "Shield blocks all attacks but decays. Grab beats shield.", input: "Z / L+R" },
    ],
    characters: [
      { id: 'captain-falcon', name: 'Captain Falcon', moveCount: 26 },
      { id: 'donkey-kong', name: 'Donkey Kong', moveCount: 26 },
      { id: 'fox', name: 'Fox', moveCount: 26 },
      { id: 'jigglypuff', name: 'Jigglypuff', moveCount: 26 },
      { id: 'kirby', name: 'Kirby', moveCount: 26 },
      { id: 'link', name: 'Link', moveCount: 26 },
      { id: 'luigi', name: 'Luigi', moveCount: 26 },
      { id: 'mario', name: 'Mario', moveCount: 26 },
      { id: 'ness', name: 'Ness', moveCount: 26 },
      { id: 'pikachu', name: 'Pikachu', moveCount: 26 },
      { id: 'samus-aran', name: 'Samus Aran', moveCount: 26 },
      { id: 'yoshi', name: 'Yoshi', moveCount: 26 }
    ],
    tabs: ['Special Moves', 'Super Combos', 'Finishers', 'Unique Attacks', 'Normal Moves', 'Command Throws', 'Normal Throws', 'Common Moves']
  },
  {
    ...
    characters: [
      { id: 'bowser', name: 'Bowser', moveCount: 30 },
      { id: 'captain-falcon', name: 'Captain Falcon', moveCount: 31 },
      { id: 'donkey-kong', name: 'Donkey Kong', moveCount: 30 },
      { id: 'dr-mario', name: 'Dr. Mario', moveCount: 29 },
      { id: 'falco-lombardi', name: 'Falco Lombardi', moveCount: 30 },
      { id: 'fox-mccloud', name: 'Fox McCloud', moveCount: 31 },
      { id: 'ganondorf', name: 'Ganondorf', moveCount: 29 },
      { id: 'ice-climbers', name: 'Ice Climbers', moveCount: 29 },
      { id: 'jigglypuff', name: 'Jigglypuff', moveCount: 29 },
      { id: 'kirby', name: 'Kirby', moveCount: 31 },
      { id: 'link', name: 'Link', moveCount: 29 },
      { id: 'luigi', name: 'Luigi', moveCount: 29 },
      { id: 'mario', name: 'Mario', moveCount: 31 },
      { id: 'marth', name: 'Marth', moveCount: 29 },
      { id: 'mewtwo', name: 'Mewtwo', moveCount: 29 },
      { id: 'mr-game-watch', name: 'Mr. Game & Watch', moveCount: 29 },
      { id: 'ness', name: 'Ness', moveCount: 31 },
      { id: 'peach', name: 'Peach', moveCount: 30 },
      { id: 'pichu', name: 'Pichu', moveCount: 29 },
      { id: 'pikachu', name: 'Pikachu', moveCount: 29 },
      { id: 'roy', name: 'Roy', moveCount: 29 },
      { id: 'samus-aran', name: 'Samus Aran', moveCount: 29 },
      { id: 'sheik', name: 'Sheik', moveCount: 29 },
      { id: 'yoshi', name: 'Yoshi', moveCount: 29 },
      { id: 'young-link', name: 'Young Link', moveCount: 29 },
      { id: 'zelda', name: 'Zelda', moveCount: 29 }
    ],
    tabs: ['Special Moves', 'Super Combos', 'Finishers', 'Unique Attacks', 'Normal Moves', 'Command Throws', 'Normal Throws', 'Common Moves']
  },
  {
    ...
    searchAliases: ['brawl', 'ssbb'],
        systemMechanics: [
        { name: "Final Smash", description: "Break the Smash Ball item to unlock a devastating character-specific super attack.", input: "B (with Smash Ball)" },
        { name: "Percentage System", description: "Damage increases knockback. KO by launching off-stage at high %." },
        { name: "Tripping", description: "Random chance to trip when dashing. Controversial mechanic unique to Brawl." },
        { name: "Smash Attacks", description: "Chargeable KO moves.", input: "A + direction" },
        { name: "Edge Guarding", description: "Off-stage interception is a core KO strategy. Tether recoveries added." },
        { name: "Subspace Emissary", description: "Story mode with platforming, cutscenes, and boss fights." },
    ],
    characters: [
      { id: 'bowser', name: 'Bowser', moveCount: 12 },
      { id: 'captain-falcon', name: 'Captain Falcon', moveCount: 12 },
      { id: 'captain-olimar', name: 'Captain Olimar', moveCount: 12 },
      { id: 'diddy-kong', name: 'Diddy Kong', moveCount: 12 },
      { id: 'donkey-kong', name: 'Donkey Kong', moveCount: 29 },
      { id: 'falco-lombardi', name: 'Falco Lombardi', moveCount: 12 },
      { id: 'fox-mccloud', name: 'Fox McCloud', moveCount: 12 },
      { id: 'ganondorf', name: 'Ganondorf', moveCount: 12 },
      { id: 'ice-climbers', name: 'Ice Climbers', moveCount: 12 },
      { id: 'ike', name: 'Ike', moveCount: 12 },
      { id: 'jigglypuff', name: 'Jigglypuff', moveCount: 12 },
      { id: 'king-dedede', name: 'King Dedede', moveCount: 12 },
      { id: 'kirby', name: 'Kirby', moveCount: 12 },
      { id: 'link', name: 'Link', moveCount: 29 },
      { id: 'lucario', name: 'Lucario', moveCount: 12 },
      { id: 'lucas', name: 'Lucas', moveCount: 12 },
      { id: 'luigi', name: 'Luigi', moveCount: 12 },
      { id: 'mario', name: 'Mario', moveCount: 29 },
      { id: 'marth', name: 'Marth', moveCount: 12 },
      { id: 'meta-knight', name: 'Meta Knight', moveCount: 12 },
      { id: 'mr-game-watch', name: 'Mr. Game & Watch', moveCount: 12 },
      { id: 'ness', name: 'Ness', moveCount: 12 },
      { id: 'peach', name: 'Peach', moveCount: 12 },
      { id: 'pikachu', name: 'Pikachu', moveCount: 12 },
      { id: 'pit', name: 'Pit', moveCount: 12 },
      { id: 'pokemon-trainer-charizard', name: 'Pokemon Trainer (Charizard)', moveCount: 12 },
      { id: 'pokemon-trainer-ivysaur', name: 'Pokemon Trainer (Ivysaur)', moveCount: 12 },
      { id: 'pokemon-trainer-squirtle', name: 'Pokemon Trainer (Squirtle)', moveCount: 12 },
      { id: 'rob', name: 'R.O.B.', moveCount: 27 },
      { id: 'samus-aran', name: 'Samus Aran', moveCount: 12 },
      { id: 'sheik', name: 'Sheik', moveCount: 12 },
      { id: 'solid-snake', name: 'Solid Snake', moveCount: 12 },
      { id: 'sonic-the-hedgehog', name: 'Sonic the Hedgehog', moveCount: 12 },
      { id: 'toon-link', name: 'Toon Link', moveCount: 12 },
      { id: 'wario', name: 'Wario', moveCount: 12 },
      { id: 'wolf-odonnell', name: 'Wolf O-Donnell', moveCount: 27 },
      { id: 'yoshi', name: 'Yoshi', moveCount: 12 },
      { id: 'zelda', name: 'Zelda', moveCount: 12 },
      { id: 'zero-suit-samus', name: 'Zero Suit Samus', moveCount: 20 }
    ],
    tabs: ['Special Moves', 'Super Combos', 'Finishers', 'Unique Attacks', 'Normal Moves', 'Command Throws', 'Normal Throws', 'Common Moves']
  },

  {
    ...
    developer: 'Visual Concepts',
        systemMechanics: [
        { name: "Weapon Combat", description: "All combat is weapon-based. Swords, axes, hammers. No punches or kicks." },
        { name: "Thrust/Strike/Slash", description: "Six-button layout with three attack types and two angles each. Foreslash/Backslash, Forethrust/Backthrust, Forestrike/Backstrike." },
        { name: "Dual Life Bars", description: "Each round requires draining the opponent's life bar twice before winning." },
        { name: "Weapon Clash", description: "Simultaneous attacks create weapon clashes. Positioning and timing determine the winner." },
        { name: "Death Combos", description: "Devastating finishing sequences that can dismember or decapitate opponents mid-match." },
        { name: "Deflect", description: "Parry-style defensive technique. Deflect an incoming attack to create an opening for counterattack." },
    ],
    characters: [
      { id: 'bane', name: 'Bane', moveCount: 10 },
      { id: 'divada', name: 'Divada', moveCount: 8 },
      { id: 'jen-tai', name: 'Jen-Tai', moveCount: 9 },
      { id: 'korr', name: 'Korr', moveCount: 11 },
      { id: 'pyra', name: 'Pyra', moveCount: 12 },
      { id: 'talazia', name: 'Talazia', moveCount: 10 },
      { id: 'zarak', name: 'Zarak', moveCount: 9 },
      { id: 'zorn', name: 'Zorn', moveCount: 10 },
      { id: 'zyx', name: 'Zyx', moveCount: 12 }
    ],
    tabs: ['Special Moves', 'Super Combos', 'Finishers', 'Unique Attacks', 'Normal Moves', 'Command Throws', 'Normal Throws', 'Common Moves']
  },

  {
    ...
    characters: [
      { id: 'bullzeye', name: 'Bullzeye', moveCount: 20 },
      { id: 'delta', name: 'Delta', moveCount: 18 },
      { id: 'minatek', name: 'Minatek', moveCount: 20 },
      { id: 'psyclown', name: 'Psyclown', moveCount: 17 },
      { id: 'purge', name: 'Purge', moveCount: 15 },
      { id: 'sabotage', name: 'Sabotage', moveCount: 13 },
      { id: 'ssapo', name: 'Ssapo', moveCount: 17 },
      { id: 'zipperhead', name: 'Zipperhead', moveCount: 16 }
    ],
    tabs: ['Special Moves', 'Super Combos', 'Finishers', 'Unique Attacks', 'Normal Moves', 'Command Throws', 'Normal Throws', 'Common Moves']
  },

  {
    ...
    links: [
      { title: 'SuperCombo Wiki', url: 'https://wiki.supercombo.gg/' },
        ...
        systemMechanics: [
        { name: "Heat Gauge", description: "Builds by attacking and taking damage. Powers Overdrive Attacks and Heat Blows." },
        { name: "Overdrive Attack", description: "Super move consuming Heat Gauge. High damage cinematic finisher." },
        { name: "Line Sway", description: "3D line movement. Dodge into the background or foreground to avoid attacks.", input: "Sway buttons" },
        { name: "Just Defend", description: "Frame-perfect block that recovers health and enables counterattacks." },
        { name: "Guard Cancel", description: "Counterattack from block using Heat Gauge." },
    ],
    characters: [
      { id: 'terry-bogard', name: 'Terry Bogard', moveCount: 6 },
      { id: 'andy-bogard', name: 'Andy Bogard', moveCount: 5 },
      { id: 'joe-higashi', name: 'Joe Higashi', moveCount: 5 },
      { id: 'mai-shiranui', name: 'Mai Shiranui', moveCount: 5 },
      { id: 'kim-kaphwan', name: 'Kim Kaphwan', moveCount: 4 },
      { id: 'raiden', name: 'Raiden', moveCount: 4 },
      { id: 'ryuji-yamazaki', name: 'Ryuji Yamazaki', moveCount: 4 },
      { id: 'li-xiangfei', name: 'Li Xiangfei', moveCount: 4 },
      { id: 'tsugumi-sendo', name: 'Tsugumi Sendo', moveCount: 3 },
      { id: 'touji-sakata', name: 'Touji Sakata', moveCount: 4 },
      { id: 'geese-howard', name: 'Geese Howard', moveCount: 5 },
      { id: 'billy-kane', name: 'Billy Kane', moveCount: 4 },
      { id: 'duck-king', name: 'Duck King', moveCount: 4 },
      { id: 'mr-karate-ii', name: 'Mr. Karate II', moveCount: 6 }
    ],
    tabs: ['Special Moves', 'Super Combos', 'Finishers', 'Unique Attacks', 'Normal Moves', 'Command Throws', 'Normal Throws', 'Common Moves']
  },
...

  {
    ...
    characters: [
      { id: 'a-hau', name: 'A Hau', moveCount: 28 },
      { id: 'dybyd', name: 'Dybyd', moveCount: 21 },
      { id: 'geezer', name: 'Geezer', moveCount: 26 },
      { id: 'kurara', name: 'Kurara', moveCount: 21 },
      { id: 'kyoha', name: 'Kyoha', moveCount: 16 },
      { id: 'nanase', name: 'Nanase', moveCount: 20 },
      { id: 'sasa', name: 'Sasa', moveCount: 20 },
      { id: 'unknown', name: 'Unknown', moveCount: 24 },
      { id: 'verny', name: 'Verny', moveCount: 22 }
    ],
    tabs: ['Special Moves', 'Super Combos', 'Finishers', 'Unique Attacks', 'Normal Moves', 'Command Throws', 'Normal Throws', 'Common Moves']
  },
...

  {
    ...
    characters: [
      { id: 'ahau-kin', name: 'Ahau Kin', moveCount: 9 },
      { id: 'anubis', name: 'Anubis', moveCount: 8 },
      { id: 'cy-5', name: 'CY-5', moveCount: 7 },
      { id: 'kabuki-jo', name: 'Kabuki Jo', moveCount: 9 },
      { id: 'maximus', name: 'Maximus', moveCount: 8 },
      { id: 'pagan', name: 'Pagan', moveCount: 6 },
      { id: 'tak', name: 'Tak', moveCount: 7 },
      { id: 'vallah', name: 'Vallah', moveCount: 9 },
      { id: 'voodoo', name: 'Voodoo', moveCount: 8 },
      { id: 'warhead', name: 'Warhead', moveCount: 6 }
    ],
    tabs: ['Special Moves', 'Super Combos', 'Finishers', 'Unique Attacks', 'Normal Moves', 'Command Throws', 'Normal Throws', 'Common Moves']
  },
  {
    ...
    developer: 'ADK',
        systemMechanics: [
        { name: "Free Roam", description: "Move freely around the 2D plane. Walk up, down, left, and right in a beat-em-up style arena." },
        { name: "Grappling", description: "Close-range grapple system with multiple throw options and follow-ups." },
        { name: "Weapons", description: "Pick up and use weapons found in the environment for extra damage." },
        { name: "Crazy Attack", description: "Super move available at low health. Powered-up devastating finisher." },
    ],
    characters: [
      { id: 'joe-kusanagi', name: 'Joe Kusanagi', moveCount: 12 },
      { id: 'leonhard-domador', name: 'Leonhard Domador', moveCount: 11 },
      { id: 'kisarah-westfield', name: 'Kisarah Westfield', moveCount: 11 },
      { id: 'bobby-nelson', name: 'Bobby Nelson', moveCount: 12 },
      { id: 'sheen-genus', name: 'Sheen Genus', moveCount: 10 },
      { id: 'fuuma-kotaro', name: 'Fuuma Kotaro', moveCount: 10 },
      { id: 'lee-hae-gwon', name: 'Lee Hae Gwon', moveCount: 10 },
      { id: 'ganzagawa', name: 'Ganzagawa', moveCount: 10 }
    ],
    tabs: ['Special Moves', 'Super Combos', 'Finishers', 'Unique Attacks', 'Normal Moves', 'Command Throws', 'Normal Throws', 'Common Moves']
  },
  {
    ...
    characters: [
      { id: 'bravo', name: 'Bravo', moveCount: 9 },
      { id: 'cait-sith', name: 'Cait & Sith', moveCount: 38 },
      { id: 'catherine', name: 'Catherine', moveCount: 16 },
      { id: 'celia', name: 'Celia', moveCount: 10 },
      { id: 'celia-ii-kai', name: 'Celia II Kai', moveCount: 34 },
      { id: 'cerberus', name: 'Cerberus', moveCount: 37 },
      { id: 'cthylla', name: 'Cthylla', moveCount: 16 },
      { id: 'hermes', name: 'Hermes', moveCount: 10 },
      { id: 'hikaru', name: 'Hikaru', moveCount: 15 },
      { id: 'kagari', name: 'Kagari', moveCount: 11 },
      { id: 'kudlak-sin', name: 'Kudlak-Sin', moveCount: 36 },
      { id: 'lupinus', name: 'Lupinus', moveCount: 33 },
      { id: 'mg-hikaru', name: 'MG Hikaru', moveCount: 34 },
      { id: 'ray', name: 'Ray', moveCount: 10 },
      { id: 'rui', name: 'Rui', moveCount: 33 },
      { id: 'vein', name: 'Vein', moveCount: 34 }
    ],
  ...
  },
  {
    ...
    characters: [
      { id: 'batsu-ichimonji', name: 'Batsu Ichimonji', moveCount: 19 },
      { id: 'hinata-wakaba', name: 'Hinata Wakaba', moveCount: 18 },
      { id: 'kyosuke-kagami', name: 'Kyosuke Kagami', moveCount: 19 },
      { id: 'shoma-sawamura', name: 'Shoma Sawamura', moveCount: 18 },
      { id: 'natsu-ayuhara', name: 'Natsu Ayuhara', moveCount: 19 },
      { id: 'roberto-miura', name: 'Roberto Miura', moveCount: 18 },
      { id: 'roy-bromwell', name: 'Roy Bromwell', moveCount: 18 },
      { id: 'tiffany-lords', name: 'Tiffany Lords', moveCount: 18 },
      { id: 'akira-kazama', name: 'Akira Kazama', moveCount: 18 },
      { id: 'sakura-kasugano', name: 'Sakura Kasugano', moveCount: 18 }
    ],
    tabs: ['Special Moves', 'Super Arts', 'Command Throws', 'Normal Throws', 'Unique Attacks', 'Normal Moves', 'Common Moves']
  },
  {
    ...
    characters: [
      { id: 'blood', name: 'Blood', moveCount: 10 },
      { id: 'edward-bilstein', name: 'Edward Bilstein', moveCount: 10 },
      { id: 'gamof-gohone', name: 'Gamof Gohone', moveCount: 10 },
      { id: 'gerelt', name: 'Gerelt', moveCount: 11 },
      { id: 'gore-ghalahad', name: 'Gore Ghalahad', moveCount: 10 },
      { id: 'hayato-kanzaki', name: 'Hayato Kanzaki', moveCount: 13 },
      { id: 'june-lin-milliam', name: 'June Lin Milliam', moveCount: 11 },
      { id: 'kappah', name: 'Kappah', moveCount: 10 },
      { id: 'saturn', name: 'Saturn', moveCount: 11 },
      { id: 'vector', name: 'Vector', moveCount: 10 },
      { id: 'zelkin-fiskekrogen', name: 'Zelkin Fiskekrogen', moveCount: 11 }
    ],
    tabs: ['Special Moves', 'Super Combos', 'Finishers', 'Unique Attacks', 'Normal Moves', 'Command Throws', 'Normal Throws', 'Common Moves']
  },

  {
    ...
    notationSystem: 'numpad',
    tags: ["2D"],
    searchAliases: ['hnk', 'fist of the north star', 'fotns', 'hokuto'],
    systemMechanics: [
