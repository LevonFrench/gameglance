...
rosterCount: 31,
      ...
      { id: 'asuka', name: 'Asuka' },
      { id: 'azucena-ortiz', name: 'Azucena Ortiz' },
      { id: 'bryan', name: 'Bryan' },
      ...
      { id: 'king', name: 'King' },
      { id: 'kuma', name: 'Kuma' },
      { id: 'lars-alexandersson', name: 'Lars Alexandersson' },
      { id: 'law', name: 'Law' },
      { id: 'lee', name: 'Lee' },
      { id: 'leo-kliesen', name: 'Leo Kliesen' },
      { id: 'leroy', name: 'Leroy' },
      { id: 'lili', name: 'Lili' },
      { id: 'nina', name: 'Nina' },
      { id: 'panda', name: 'Panda' },
...

  {
    ...
    characters: [
      ...
      { id: 'lei-wulong', name: 'Lei Wulong' },
      { id: 'leo-kliesen', name: 'Leo Kliesen' },
      { id: 'lili-rochefort', name: 'Lili Rochefort' },
      { id: 'ling-xiaoyu', name: 'Ling Xiaoyu' },
      { id: 'marshall-law', name: 'Marshall Law' },
      { id: 'miguel-caballero-rojo', name: 'Miguel Caballero Rojo' },
      { id: 'mokujin', name: 'Mokujin' },
      { id: 'nina-williams', name: 'Nina Williams' },
      { id: 'ogre', name: 'Ogre' },
      { id: 'panda', name: 'Panda' },
      { id: 'paul-phoenix', name: 'Paul Phoenix' },
      { id: 'raven', name: 'Raven' },
      { id: 'roger-jr', name: 'Roger Jr.' },
      { id: 'sebastian', name: 'Sebastian' },
      { id: 'sergei-dragunov', name: 'Sergei Dragunov' },
      { id: 'steve-fox', name: 'Steve Fox' },
      { id: 'tiger-jackson', name: 'Tiger Jackson' },
      { id: 'true-ogre', name: 'True Ogre' },
      { id: 'unknown', name: 'Unknown' },
...
rosterCount: 999,
      ...
      { id: 'morrigan_arnsland', name: 'Morrigan Aensland' },
      { id: 'pyron', name: 'Pyron' },
      { id: 'rikuo', name: 'Rikuo' },
      { id: 'sasquatch', name: 'Sasquatch' },
      { id: 'victor', name: 'Victor' }
...
rosterCount: 8,
  ...
  },
  {
    ...
    characters: [
      ...
      { id: 'bardock', name: 'Bardock' },
      { id: 'broly', name: 'Broly' },
      { id: 'captain-ginyu', name: 'Captain Ginyu' },
      { id: 'cell', name: 'Cell' },
      { id: 'cooler', name: 'Cooler' },
      ...
      { id: 'tien-shinhan', name: 'Tien Shinhan' },
  ...
  },
  {
    ...
    characters: [
      ...
      { id: 'black-adam', name: 'Black Adam' },
      { id: 'catwoman', name: 'Catwoman' },
      { id: 'cyborg', name: 'Cyborg' },
      { id: 'deathstroke', name: 'Deathstroke' },
      { id: 'doomsday', name: 'Doomsday' },
      { id: 'flash', name: 'Flash' },
      { id: 'general-zod', name: 'General Zod' },
      { id: 'green-arrow', name: 'Green Arrow' },
      { id: 'green-lantern', name: 'Green Lantern' },
      { id: 'harley-quinn', name: 'Harley Quinn' },
      { id: 'hawkgirl', name: 'Hawkgirl' },
      { id: 'joker', name: 'Joker' },
      { id: 'killer-frost', name: 'Killer Frost' },
      { id: 'lex-luther', name: 'Lex Luther' },
      { id: 'lobo', name: 'Lobo' },
      { id: 'martian-manhunter', name: 'Martian Manhunter' },
      { id: 'nightwing', name: 'Nightwing' },
      { id: 'raven', name: 'Raven' },
      { id: 'scorpion', name: 'Scorpion' },
      { id: 'shazam', name: 'Shazam' },
      { id: 'sinestro', name: 'Sinestro' },
      { id: 'solomon-grundy', name: 'Solomon Grundy' },
      { id: 'superman', name: 'Superman' },
      { id: 'wonder-woman', name: 'Wonder Woman' },
      { id: 'zatanna', name: 'Zatanna' }
    ],
    tabs: ['Special Moves', 'Super Combos', 'Finishers', 'Unique Attacks', 'Normal Moves', 'Throws', 'Common Moves']
  },
  {
    ...
    characters: [
      ...
      { id: 'batman', name: 'Batman' },
      { id: 'black-adam', name: 'Black Adam' },
      { id: 'black-canary', name: 'Black Canary' },
      { id: 'black-manta', name: 'Black Manta' },
      { id: 'blue-beetle', name: 'Blue Beetle' },
      { id: 'brainiac', name: 'Brainiac' },
      { id: 'captain-cold', name: 'Captain Cold' },
      { id: 'catwoman', name: 'Catwoman' },
      { id: 'cheetah', name: 'Cheetah' },
      { id: 'cyborg', name: 'Cyborg' },
      { id: 'darkseid', name: 'Darkseid' },
      { id: 'deadshot', name: 'Deadshot' },
      { id: 'doctor-fate', name: 'Doctor Fate' },
      { id: 'donatello', name: 'Donatello' },
      { id: 'enchantress', name: 'Enchantress' },
      { id: 'firestorm', name: 'Firestorm' },
      { id: 'flash', name: 'Flash' },
      { id: 'gorilla-grodd', name: 'Gorilla Grodd' },
      { id: 'green-arrow', name: 'Green Arrow' },
      { id: 'green-lantern', name: 'Green Lantern' },
      { id: 'harley-quinn', name: 'Harley Quinn' },
      ...
      { id: 'poison-ivy', name: 'Poison Ivy' },
      { id: 'raiden', name: 'Raiden' },
      { id: 'raphael', name: 'Raphael' },
      { id: 'red-hood', name: 'Red Hood' },
      { id: 'robin', name: 'Robin' },
  ...
  },
  {
    ...
    characters: [
      ...
      { id: 'kung-lao', name: 'Kung Lao' },
      { id: 'li-mei', name: 'Li Mei' },
      { id: 'mavado', name: 'Mavado' },
      { id: 'mokap', name: 'Mokap' },
      { id: 'moloch', name: 'Moloch' },
      { id: 'nitara', name: 'Nitara' },
      { id: 'quan-chi', name: 'Quan Chi' },
      { id: 'raiden', name: 'Raiden' },
      { id: 'reptile', name: 'Reptile' },
  ...
  },
  {
    ...
    characters: [
      ...
      { id: 'cyrax', name: 'Cyrax' },
      { id: 'daegon', name: 'Daegon' },
      { id: 'dairou', name: 'Dairou' },
      { id: 'darrius', name: 'Darrius' },
      { id: 'drahmin', name: 'Drahmin' },
      { id: 'ermac', name: 'Ermac' },
      { id: 'frost', name: 'Frost' },
      { id: 'fujin', name: 'Fujin' },
  ...
  },
  {
    ...
    characters: [
      ...
      { id: 'demuth', name: 'Demuth' },
      { id: 'girardot', name: 'Girardot' },
      { id: 'greed', name: 'Greed' },
      { id: 'hualin', name: 'Hualin' },
      { id: 'hwang', name: 'Hwang' },
      { id: 'ivy', name: 'Ivy' },
      { id: 'kilik', name: 'Kilik' },
      { id: 'li-long', name: 'Li Long' },
      ...
      { id: 'miser', name: 'Miser' },
      { id: 'mitsurugi', name: 'Mitsurugi' },
      { id: 'night-terror', name: 'Night Terror' },
      { id: 'nightmare', name: 'Nightmare' },
      { id: 'olcadan', name: 'Olcadan' },
      { id: 'raphael', name: 'Raphael' },
  ...
  },
  {
    ...
    characters: [
      ...
      { id: 'ezio-auditore', name: 'Ezio Auditore' },
      { id: 'hilde', name: 'Hilde' },
      { id: 'ivy', name: 'Ivy' },
      { id: 'kilik', name: 'Kilik' },
      { id: 'leixia', name: 'Leixia' },
      { id: 'maxi', name: 'Maxi' },
      { id: 'mitsurugi', name: 'Mitsurugi' },
      { id: 'natsu', name: 'Natsu' },
      { id: 'nightmare', name: 'Nightmare' },
      { id: 'patroklos', name: 'Patroklos' },
      { id: 'pyrrha', name: 'Pyrrha' },
      { id: 'raphael', name: 'Raphael' },
      { id: 'siegfried', name: 'Siegfried' },
      { id: 'tira', name: 'Tira' },
      { id: 'viola', name: 'Viola' },
  ...
  },
  {
    ...
    characters: [
      ...
      { id: 'cassandra', name: 'Cassandra' },
      { id: 'cervantes', name: 'Cervantes' },
      { id: 'geralt-of-rivia', name: 'Geralt of Rivia' },
      { id: 'grh', name: 'Grøh' },
      { id: 'haohmaru', name: 'Haohmaru' },
      { id: 'hilde', name: 'Hilde' },
      { id: 'hwang', name: 'Hwang' },
  ...
  },
  {
    ...
    characters: [
      ...
      { id: 'ling-xiaoyu', name: 'Ling Xiaoyu' },
      { id: 'marshall-law', name: 'Marshall Law' },
      { id: 'miharu-hirano', name: 'Miharu Hirano' },
      { id: 'nina-williams', name: 'Nina Williams' },
      { id: 'panda', name: 'Panda' },
      { id: 'paul-phoenix', name: 'Paul Phoenix' },
      { id: 'steve-fox', name: 'Steve Fox' },
  ...
  },
  {
    ...
    characters: [
      ...
      { id: 'kazumi-mishima', name: 'Kazumi Mishima' },
      { id: 'kazuya-mishima', name: 'Kazuya Mishima' },
      { id: 'king-ii', name: 'King II' },
      { id: 'kuma-ii', name: 'Kuma II' },
      { id: 'kunimitsu-ii', name: 'Kunimitsu II' },
      { id: 'lars-alexandersson', name: 'Lars Alexandersson' },
      { id: 'lee-chaolan', name: 'Lee Chaolan' },
      { id: 'lei-wulong', name: 'Lei Wulong' },
      { id: 'leo-kliesen', name: 'Leo Kliesen' },
      ...
      { id: 'lili-rochefort', name: 'Lili Rochefort' },
      { id: 'ling-xiaoyu', name: 'Ling Xiaoyu' },
      { id: 'lucky-chloe', name: 'Lucky Chloe' },
      { id: 'lidia-sobieska', name: 'Lidia Sobieska' },
      { id: 'marshall-law', name: 'Marshall Law' },
      { id: 'master-raven', name: 'Master Raven' },
      { id: 'miguel-caballero-rojo', name: 'Miguel Caballero Rojo' },
      { id: 'negan', name: 'Negan' },
      { id: 'nina-williams', name: 'Nina Williams' },
      { id: 'noctis-lucis-caelum', name: 'Noctis Lucis Caelum' },
      { id: 'panda', name: 'Panda' },
      { id: 'paul-phoenix', name: 'Paul Phoenix' },
      { id: 'shaheen', name: 'Shaheen' },
      { id: 'steve-fox', name: 'Steve Fox' },
  ...
  },
  {
    ...
    characters: [
      ...
      { id: 'kula', name: 'Kula' },
      { id: 'kyo', name: 'Kyo' },
      { id: 'magaki', name: 'Magaki' },
      { id: 'mai', name: 'Mai' },
      { id: 'malin', name: 'Malin' },
      { id: 'maxima', name: 'Maxima' },
      { id: 'momoko', name: 'Momoko' },
      { id: 'mr-big', name: 'Mr. Big' },
  ...
  },
  {
    ...
    characters: [
      ...
      { id: 'helga', name: 'Helga' },
      { id: 'ickybod-clay', name: 'Ickybod Clay' },
      { id: 'taffy', name: 'Taffy' },
      { id: 'tiny', name: 'Tiny' }
    ],
    tabs: ['Special Moves', 'Super Combos', 'Finishers', 'Unique Attacks', 'Normal Moves', 'Throws', 'Common Moves']
  },
  {
    ...
    characters: [
      ...
      { id: 'hooter', name: 'Hooter' },
      { id: 'jetta-maxx', name: 'Jetta Maxx' },
      { id: 'jonathan-blade', name: 'Jonathan Blade' },
      { id: 'larcen-tyler', name: 'Larcen Tyler' },
      { id: 'mitchell-middleton-knight-midknight', name: 'Mitchell Middleton Knight (MidKnight)' },
      { id: 'rax-coswell', name: 'R.A.X. Coswell' },
      { id: 'ramses-iii', name: 'Ramses III' },
      { id: 'raven-gindhar', name: 'Raven Gindhar' },
      { id: 'riptide', name: 'Riptide' },
      { id: 'senator', name: 'Senator' },
      { id: 'shadow-yamoto', name: 'Shadow Yamoto' },
      { id: 'slash', name: 'Slash' },
      { id: 'slither', name: 'Slither' },
      { id: 'thanatos', name: 'Thanatos' },
      { id: 'thomas-blast-chavez', name: 'Thomas "Blast" Chavez' },
      { id: 'trident', name: 'Trident' },
      { id: 'xavier-pendragon', name: 'Xavier Pendragon' },
      { id: 'yappy', name: 'Yappy' },
      { id: 'zuni', name: 'Zuni' }
    ],
    tabs: ['Special Moves', 'Super Combos', 'Finishers', 'Unique Attacks', 'Normal Moves', 'Throws', 'Common Moves']
  },
  {
    ...
    characters: [
      ...
      { id: 'archetypeearth', name: 'Archetype:Earth' },
      ...
      { id: 'riesbyfe-stridberg', name: 'Riesbyfe Stridberg' },
      { id: 'ryougi-shiki', name: 'Ryougi Shiki' },
      { id: 'satsuki-yumizuka', name: 'Satsuki Yumizuka' },
      { id: 'sion-eltnam-atlasia', name: 'Sion Eltnam Atlasia' },
      { id: 'sion-tatari', name: 'Sion TATARI' }
    ],
    tabs: ['Special Moves', 'Super Combos', 'Finishers', 'Unique Attacks', 'Normal Moves', 'Throws', 'Common Moves']
  },
  {
    ...
    characters: [
      ...
      { id: 'arcueid-brunestud', name: 'Arcueid Brunestud' },
      { id: 'ciel', name: 'Ciel' },
      { id: 'count-of-monte-cristo', name: 'Count of Monte Cristo' },
      { id: 'dead-apostle-noel', name: 'Dead Apostle Noel' },
      { id: 'hisui', name: 'Hisui' },
      { id: 'kohaku', name: 'Kohaku' },
      { id: 'kouma-kishima', name: 'Kouma Kishima' },
      ...
      { id: 'roa', name: 'Roa' },
      { id: 'saber', name: 'Saber' },
      { id: 'shiki-tohno', name: 'Shiki Tohno' },
      { id: 'ushiwakamaru', name: 'Ushiwakamaru' },
      { id: 'vlov-arkhangel', name: 'Vlov Arkhangel' }
    ],
    tabs: ['Special Moves', 'Super Combos', 'Finishers', 'Unique Attacks', 'Normal Moves', 'Throws', 'Common Moves']
  },
  {
    ...
    characters: [
      ...
      { id: 'mingmei', name: 'Mingmei' },
      { id: 'ndidi', name: 'Ndidi' },
      { id: 'nuno', name: 'Nuno' },
      { id: 'sebastian', name: 'Sebastian' },
      { id: 'ximena', name: 'Ximena' }
    ],
    tabs: ['Special Moves', 'Super Combos', 'Finishers', 'Unique Attacks', 'Normal Moves', 'Throws', 'Common Moves']
  },
  {
    ...
    characters: [
      ...
      { id: 'cerebella', name: 'Cerebella' },
      { id: 'double', name: 'Double' },
      { id: 'eliza', name: 'Eliza' },
      { id: 'filia', name: 'Filia' },
      { id: 'fukua', name: 'Fukua' },
      { id: 'marie', name: 'Marie' },
      { id: 'ms-fortune', name: 'Ms. Fortune' },
  ...
  },
  {
    ...
    characters: [
      ...
      { id: 'falco-lombardi', name: 'Falco Lombardi' },
      { id: 'fox-mccloud', name: 'Fox McCloud' },
  ...
  },
  {
    ...
    characters: [
      ...
      { id: 'mr-game-watch', name: 'Mr. Game & Watch' },
      { id: 'ness', name: 'Ness' },
      { id: 'captain-olimar', name: 'Captain Olimar' },
      { id: 'peach', name: 'Peach' },
      { id: 'pikachu', name: 'Pikachu' },
      { id: 'pit', name: 'Pit' },
      { id: 'pokemon-trainer-charizard', name: 'Pokemon Trainer (Charizard)' },
      ...
      { id: 'wario', name: 'Wario' },
      { id: 'wolf-odonnell', name: 'Wolf O-Donnell' },
      { id: 'yoshi', name: 'Yoshi' },
      { id: 'zelda', name: 'Zelda' }
    ],
    tabs: ['Special Moves', 'Super Combos', 'Finishers', 'Unique Attacks', 'Normal Moves', 'Throws', 'Common Moves']
  ...
  ,
  {
    ...
    characters: [
      ...
      { id: 'saki-tsuzura', name: 'Saki Tsuzura' },
      { id: 'kamui-tokinomiya', name: 'Kamui Tokinomiya' },
      { id: 'fiona-mayfield', name: 'Fiona Mayfield' },
      { id: 'yoriko-yasuzumi', name: 'Yoriko Yasuzumi' },
      { id: 'kira-daidohji', name: 'Kira Daidohji' },
      { id: 'lieselotte-achenbach', name: 'Lieselotte Achenbach' },
      { id: 'petra-johanna-lagerkvist', name: 'Petra Johanna Lagerkvist' },
      { id: 'zenia-valov', name: 'Zenia Valov' },
      { id: 'elsa-la-conti', name: 'Elsa la Conti' },
      { id: 'clarice-di-lanza', name: 'Clarice di Lanza' },
      { id: 'catherine-kyoubashi', name: 'Catherine Kyoubashi' },
      { id: 'dorothy-albright', name: 'Dorothy Albright' },
      { id: 'akane-inuwaka', name: 'Akane Inuwaka' },
      { id: 'nazuna-inuwaka', name: 'Nazuna Inuwaka' },
      { id: 'scharlachrot', name: 'Scharlachrot' },
      { id: 'weiss', name: 'Weiss' },
      { id: 'eko', name: 'Eko' },
      { id: 'minori-amanohara', name: 'Minori Amanohara' },
      { id: 'mei-fang', name: 'Mei-Fang' },
      { id: 'lilica-felchenerow', name: 'Lilica Felchenerow' },
      { id: 'konoha', name: 'Konoha' },
      { id: 'angelia-avallone', name: 'Angelia Avallone' },
      { id: 'mildred-avallone', name: 'Mildred Avallone' },
      { id: 'dark-heart', name: 'Dark Heart' },
      { id: 'pistrix', name: 'Pistrix' },
      { id: 'parace-lsia', name: "Parace L'Sia" }
    ],
