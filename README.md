...
| Data | Static JSON move lists per character (lazy-loaded) + inline system mechanics in `games.ts` |
| Deploy | Vercel |
...
| File | Purpose |
|------|---------|
| `src/games.ts` | Full game registry (IDs, rosters, system mechanics, metadata) |
